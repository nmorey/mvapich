...
int main(int argc, char **argv)
{
    ...
    /* src/mpi/coll/mvapich/allgather/allgather_direct_osu.c */
    ...
    /* src/mpi/coll/mvapich/reduce/reduce_allreduce_osu.c */
    ...
    /* src/mpid/ch4/shm/ipc/cma/cma_post.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**cmawrite", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**cmawrite" );
    {
    /* src/mpid/ch4/shm/ipc/cma/cma_post.c */
    int i1 = 1;
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**cmawrite", "**cmawrite %d", i1 );
    ChkMsg( err, MPI_ERR_OTHER, "**cmawrite %d" );
    }
