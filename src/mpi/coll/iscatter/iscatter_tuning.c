...
int MV2_set_iscatter_tuning_table(int heterogeneity)
{
	...
	mv2_iscatter_thresholds_table = MPL_malloc(mv2_size_iscatter_tuning_table *
						  sizeof (mv2_iscatter_tuning_table), MPL_MEM_COLL);
	mv2_iscatter_tuning_table mv2_tmp_iscatter_thresholds_table[] = {
      ...
      MPIR_Memcpy(mv2_iscatter_thresholds_table, mv2_tmp_iscatter_thresholds_table,
...
void MV2_cleanup_iscatter_tuning_table()
{
	...
	MPL_free(mv2_iscatter_thresholds_table);
    }
...
int MV2_internode_Iscatter_is_define(char *mv2_user_iscatter_inter, char *mv2_user_iscatter_intra)
{
	...
	if (!(dup = MPL_strdup(mv2_user_iscatter_inter))) {
    ...
    MPIR_Memcpy(mv2_iscatter_thresholds_table, mv2_tmp_iscatter_thresholds_table, sizeof
