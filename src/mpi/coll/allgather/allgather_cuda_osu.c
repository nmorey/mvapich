...
extern void *mv2_device_allgather_store_buf;
extern int mv2_device_allgather_store_buf_size;

extern unsigned long long PVAR_COUNTER_mv2_coll_allgather_cuda_intra_bytes_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_allgather_cuda_intra_bytes_recv;
extern unsigned long long PVAR_COUNTER_mv2_coll_allgather_cuda_intra_count_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_allgather_cuda_intra_count_recv;
extern unsigned long long PVAR_COUNTER_mv2_coll_allgather_cuda_bytes_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_allgather_cuda_bytes_recv;
extern unsigned long long PVAR_COUNTER_mv2_coll_allgather_cuda_count_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_allgather_cuda_count_recv;
extern MPIR_T_pvar_timer_t PVAR_TIMER_mv2_coll_timer_allgather_cuda;
                             ...
                             MPIR_Comm * comm_ptr, MPIR_Errflag_t *errflag)
{
    ...
    max_size = mv2_device_allgather_store_buf_size < recvcount * comm_size * recvtype_extent ?
            recvcount * comm_size * recvtype_extent : mv2_device_allgather_store_buf_size;

    if (mv2_device_allgather_store_buf_size < max_size || !mv2_device_allgather_store_buf){
        ...
        mv2_device_allgather_store_buf = MPL_aligned_alloc(page_size, max_size,
                                                MPL_MEM_OTHER);
        if (NULL == mv2_device_allgather_store_buf) {
        ...
        ibv_device_register(mv2_device_allgather_store_buf, max_size);
        mv2_device_allgather_store_buf_size = max_size;
    }

    if (recvcount*recvtype_extent > mv2_device_allgather_rd_limit*comm_size ||
     ...
     * local copy to complete*/
        if (mv2_enable_device && mv2_device_initialized
            ...
            MV2_MPID_Device_EventRecord(cuda_nbstream_sync_event, 0);
            MV2_MPID_Device_StreamWaitEvent(stream_d2h, cuda_nbstream_sync_event, 0);
        }
        ...
        mpi_errno = MPIC_Irecv( ((char *)mv2_device_allgather_store_buf + jnext*recvcount*recvtype_extent),
        ...
        MV2_MPID_Memcpy_Device_Async((void *)((char *)recvbuf + jnext*recvcount*recvtype_extent),
                (void *)((char *)mv2_device_allgather_store_buf + jnext*recvcount*recvtype_extent),
                recvcount*recvtype_extent,
        ...
        for (i=2; i<comm_size-1; i++) {
            ...
            mpi_errno = MPIC_Isend(((char *)mv2_device_allgather_store_buf + j*recvcount*recvtype_extent),
                                    recvcount,
                                    recvtype,
                                    right,
                                    MPIR_ALLGATHER_TAG,
     ...
     * local copy to complete*/
        ...
        /* F: saving an MPI_Aint into an int */
            ...
            if (dst < comm_size) {
                MV2_MPID_Memcpy_Device((void*)((char *)mv2_device_allgather_store_buf + rank*recvcount*recvtype_extent),
                                        (void*)((char *)recvbuf + rank*recvcount*recvtype_extent), 
                                        recvcount * recvtype_extent, 
                                        deviceMemcpyDeviceToHost);

                MPIR_PVAR_INC(allgather_cuda, intra, recv, (mask)*recvcount, recvtype);
                mpi_errno = MPIC_Irecv( ((char *)mv2_device_allgather_store_buf + recv_offset),
                                        (mask)*recvcount, 
                                        recvtype, 
                                        dst, 
                                        MPIR_ALLGATHER_TAG,
                ...
                mpi_errno = MPIC_Isend(((char *)mv2_device_allgather_store_buf + send_offset),
                                        curr_cnt, 
                                        recvtype, 
                                        dst, 
                                        MPIR_ALLGATHER_TAG,
                ...
                MV2_MPID_Memcpy_Device_Async((void*)((char *)recvbuf + recv_offset),
                                    (void*)((char *)mv2_device_allgather_store_buf + recv_offset),
    ...
    MV2_MPID_Device_EventRecord(cuda_nbstream_sync_event, stream_h2d);
