...
int MV2_set_scatter_tuning_table(int heterogeneity, struct coll_info *colls_arch_hca)
{
	...
	if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
	  ...
	  mv2_scatter_indexed_thresholds_table
	    = MPL_malloc(sizeof(mv2_scatter_indexed_tuning_table *)
			  * mv2_scatter_indexed_num_ppn_conf, MPL_MEM_COLL);
	  table_ptrs = MPL_malloc(sizeof(mv2_scatter_indexed_tuning_table *)
				   * mv2_scatter_indexed_num_ppn_conf, MPL_MEM_COLL);
	  mv2_size_scatter_indexed_tuning_table = MPL_malloc(sizeof(int) *
							      mv2_scatter_indexed_num_ppn_conf, MPL_MEM_COLL);
	  mv2_scatter_indexed_table_ppn_conf = MPL_malloc(mv2_scatter_indexed_num_ppn_conf * sizeof(int), MPL_MEM_COLL);
	  ...
	  mv2_scatter_indexed_thresholds_table[0] =
	    MPL_malloc(agg_table_sum * sizeof (mv2_scatter_indexed_tuning_table), MPL_MEM_COLL);
	  MPIR_Memcpy(mv2_scatter_indexed_thresholds_table[0], table_ptrs[0],
	  ...
	  for (i = 1; i < mv2_scatter_indexed_num_ppn_conf; i++) {
	    ...
	    MPIR_Memcpy(mv2_scatter_indexed_thresholds_table[i], table_ptrs[i],
			(sizeof(mv2_scatter_indexed_tuning_table)
	...
	return 0;
      ...
      /* Spock @ORNL table */
      MV2_COLL_TUNING_START_TABLE  (scatter, 7)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 1,  4, GEN2_CMA__AMD_EPYC_7763_128__1PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 1,  4, GEN2_CMA__AMD_EPYC_7763_128__1PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 2,  5, GEN2_CMA__AMD_EPYC_7763_128__2PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 2,  5, GEN2_CMA__AMD_EPYC_7763_128__2PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 4,  5, GEN2_CMA__AMD_EPYC_7763_128__4PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 4,  5, GEN2_CMA__AMD_EPYC_7763_128__4PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 8,  5, GEN2_CMA__AMD_EPYC_7763_128__8PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 8,  5, GEN2_CMA__AMD_EPYC_7763_128__8PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 16, 5, GEN2_CMA__AMD_EPYC_7763_128__16PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 16, 5, GEN2_CMA__AMD_EPYC_7763_128__16PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 32, 5, GEN2_CMA__AMD_EPYC_7763_128__32PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 32, 5, GEN2_CMA__AMD_EPYC_7763_128__32PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 64, 5, GEN2_CMA__AMD_EPYC_7763_128__64PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 64, 5, GEN2_CMA__AMD_EPYC_7763_128__64PPN)
      MV2_COLL_TUNING_FINISH_TABLE (scatter)
    }
    else if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
      ...
      MV2_COLL_TUNING_ADD_CONF     (scatter, 64, 5, GEN2_CMA__AMD_EPYC_7763_128__64PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 64, 5, GEN2_CMA__AMD_EPYC_7763_128__64PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 128, 5, GEN2_CMA__AMD_EPYC_7763_128__128PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 128, 5, GEN2_CMA__AMD_EPYC_7763_128__128PPN)
      MV2_COLL_TUNING_FINISH_TABLE (scatter)
    }
    else if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
      ...
      MV2_COLL_TUNING_START_TABLE  (scatter, 8)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 1,  4, GEN2_CMA__AMD_EPYC_ROME__1PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 1,  4, GEN2_CMA__AMD_EPYC_ROME__1PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 2,  5, GEN2_CMA__AMD_EPYC_ROME__2PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 2,  5, GEN2_CMA__AMD_EPYC_ROME__2PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 4,  5, GEN2_CMA__AMD_EPYC_ROME__4PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 4,  5, GEN2_CMA__AMD_EPYC_ROME__4PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 8,  5, GEN2_CMA__AMD_EPYC_ROME__8PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 8,  5, GEN2_CMA__AMD_EPYC_ROME__8PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 16, 5, GEN2_CMA__AMD_EPYC_ROME__16PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 16, 5, GEN2_CMA__AMD_EPYC_ROME__16PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 32, 5, GEN2_CMA__AMD_EPYC_ROME__32PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 32, 5, GEN2_CMA__AMD_EPYC_ROME__32PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 60, 5, GEN2_CMA__AMD_EPYC_ROME__60PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 60, 5, GEN2_CMA__AMD_EPYC_ROME__60PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 64, 5, GEN2_CMA__AMD_EPYC_ROME__64PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 64, 5, GEN2_CMA__AMD_EPYC_ROME__64PPN)
      MV2_COLL_TUNING_FINISH_TABLE (scatter)
    }
    else if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
                MV2_ARCH_AMD_EPYC_7742_128, MV2_HCA_ANY) && !heterogeneity) {
      /* AMD EPYC rome table */
      MV2_COLL_TUNING_START_TABLE  (scatter, 10)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 1,  4, GEN2_CMA__AMD_EPYC_ROME__1PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 1,  4, GEN2_CMA__AMD_EPYC_ROME__1PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 2,  5, GEN2_CMA__AMD_EPYC_ROME__2PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 2,  5, GEN2_CMA__AMD_EPYC_ROME__2PPN)
      ...
      MV2_COLL_TUNING_ADD_CONF     (scatter, 64, 5, GEN2_CMA__AMD_EPYC_ROME__64PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 64, 5, GEN2_CMA__AMD_EPYC_ROME__64PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 120, 5, GEN2_CMA__AMD_EPYC_ROME__120PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 120, 5, GEN2_CMA__AMD_EPYC_ROME__120PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 128, 5, GEN2_CMA__AMD_EPYC_ROME__128PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 128, 5, GEN2_CMA__AMD_EPYC_ROME__128PPN)
      MV2_COLL_TUNING_FINISH_TABLE (scatter)
    }
    else if(MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
      ...
      /* LLNL Corona */
      MV2_COLL_TUNING_START_TABLE  (scatter, 7)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 1,  4, GEN2_CMA__AMD_EPYC_7401_24__1PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 1,  4, GEN2_CMA__AMD_EPYC_7401_24__1PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 2,  5, GEN2_CMA__AMD_EPYC_7401_24__2PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 2,  5, GEN2_CMA__AMD_EPYC_7401_24__2PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 4,  5, GEN2_CMA__AMD_EPYC_7401_24__4PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 4,  5, GEN2_CMA__AMD_EPYC_7401_24__4PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 8,  5, GEN2_CMA__AMD_EPYC_7401_24__8PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 8,  5, GEN2_CMA__AMD_EPYC_7401_24__8PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 16, 5, GEN2_CMA__AMD_EPYC_7401_24__16PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 16, 5, GEN2_CMA__AMD_EPYC_7401_24__16PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 32, 5, GEN2_CMA__AMD_EPYC_7401_24__32PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 32, 5, GEN2_CMA__AMD_EPYC_7401_24__32PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 48, 5, GEN2_CMA__AMD_EPYC_7401_24__48PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 48, 5, GEN2_CMA__AMD_EPYC_7401_24__48PPN)
      MV2_COLL_TUNING_FINISH_TABLE (scatter)
    }
    else if(MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
      ...
      MV2_COLL_TUNING_ADD_CONF     (scatter, 1,  4, GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__1PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 1,  4, GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__1PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 2,  5, GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__2PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 2,  5, GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__2PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 4,  5, GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__4PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 4,  5, GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__4PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 8,  5, GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__8PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 8,  5, GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__8PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 16, 5, GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__16PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 16, 5, GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__16PPN)
      MV2_COLL_TUNING_FINISH_TABLE (scatter)
    }
    else if(MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
      ...
      /* Catalyst & Ookami */
      MV2_COLL_TUNING_START_TABLE  (scatter, 7)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 1,  5, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__1PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 1,  5, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__1PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 2,  6, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__2PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 2,  6, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__2PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 4,  6, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__4PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 4,  6, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__4PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 8,  6, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__8PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 8,  6, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__8PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 16, 6, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__16PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 16, 6, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__16PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 32, 6, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__32PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 32, 6, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__32PPN)
      MV2_COLL_TUNING_ADD_CONF     (scatter, 64, 6, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__64PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (scatter, 64, 6, GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__64PPN)
      MV2_COLL_TUNING_FINISH_TABLE (scatter)
    }
    else if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
	...
	*/
	...
	return 0;
	  ...
	  = MPL_malloc(sizeof(mv2_scatter_tuning_table *)
			* mv2_scatter_num_ppn_conf, MPL_MEM_COLL);
        table_ptrs = MPL_malloc(sizeof(mv2_scatter_tuning_table *)
				 * mv2_scatter_num_ppn_conf, MPL_MEM_COLL);
        mv2_size_scatter_tuning_table = MPL_malloc(sizeof(int) *
						    mv2_scatter_num_ppn_conf, MPL_MEM_COLL);
        mv2_scatter_table_ppn_conf = MPL_malloc(mv2_scatter_num_ppn_conf * sizeof(int), MPL_MEM_COLL);
	  ...
	  MPL_malloc(agg_table_sum * sizeof (mv2_scatter_tuning_table), MPL_MEM_COLL);
        MPIR_Memcpy(mv2_scatter_thresholds_table[0], table_ptrs[0],
	  ...
	  MPIR_Memcpy(mv2_scatter_thresholds_table[i], table_ptrs[i],
                      (sizeof(mv2_scatter_tuning_table)
	...
	return 0;
	  ...
	  = MPL_malloc(mv2_scatter_num_ppn_conf * sizeof(int), MPL_MEM_COLL);
...
{
  if (mv2_use_indexed_tuning || mv2_use_indexed_scatter_tuning) {
    MPL_free(mv2_scatter_indexed_thresholds_table[0]);
    MPL_free(mv2_scatter_indexed_table_ppn_conf);
    MPL_free(mv2_size_scatter_indexed_tuning_table);
    if (mv2_scatter_indexed_thresholds_table != NULL) {
      MPL_free(mv2_scatter_indexed_thresholds_table);
    }
  }
  else {
    MPL_free(mv2_scatter_thresholds_table[0]);
    MPL_free(mv2_scatter_table_ppn_conf);
    MPL_free(mv2_size_scatter_tuning_table);
    if (mv2_scatter_thresholds_table != NULL) {
        MPL_free(mv2_scatter_thresholds_table);
    }
  }
}
                                    ...
                                    *mv2_user_scatter_intra)
{
  ...
  if (mv2_use_indexed_tuning || mv2_use_indexed_scatter_tuning) {
	...
	MPL_malloc(mv2_scatter_indexed_num_ppn_conf * sizeof(int), MPL_MEM_COLL);
    }
    ...
    mv2_scatter_indexed_thresholds_table =
      MPL_malloc(mv2_scatter_indexed_num_ppn_conf *
		  sizeof(mv2_scatter_indexed_tuning_table *), MPL_MEM_COLL);
    mv2_scatter_indexed_thresholds_table[0] =
      MPL_malloc(mv2_size_scatter_indexed_tuning_table[0] *
		  sizeof(mv2_scatter_indexed_tuning_table), MPL_MEM_COLL);
    ...
    MPIR_Memcpy(mv2_scatter_indexed_thresholds_table[0], mv2_tmp_scatter_indexed_thresholds_table, sizeof
	...
	MPL_free(mv2_scatter_thresholds_table);
      ...
      /* We realloc the space for the new scatter tuning table */
      mv2_scatter_thresholds_table =
	MPL_malloc(mv2_scatter_num_ppn_conf *
		    sizeof(mv2_scatter_tuning_table *), MPL_MEM_COLL);
      mv2_scatter_thresholds_table[0] =
	MPL_malloc(mv2_size_scatter_tuning_table[0] *
		    sizeof(mv2_scatter_tuning_table), MPL_MEM_COLL);
	...
	if (!(dup = MPL_strdup(mv2_user_scatter_inter))) {
	...
	if (nb_element == 1) {
	  ...
	  if (!(dup = MPL_strdup(mv2_user_scatter_intra))) {
	    fprintf(stderr, "failed to duplicate `%s'\n", mv2_user_scatter_intra);
	    return 1;
	  }
	...
	mv2_tmp_scatter_thresholds_table[0].intra_node[0].MV2_pt_Scatter_function =
      ...
      MPIR_Memcpy(mv2_scatter_thresholds_table[0], mv2_tmp_scatter_thresholds_table, sizeof
