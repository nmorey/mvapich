...
extern MPIR_T_pvar_timer_t PVAR_TIMER_mv2_coll_timer_allreduce_shm_rd;

extern unsigned long long PVAR_COUNTER_mv2_coll_allreduce_shm_rd;

extern unsigned long long PVAR_COUNTER_mv2_coll_allreduce_pt2pt_rd_bytes_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_allreduce_pt2pt_rd_bytes_recv;
extern unsigned long long PVAR_COUNTER_mv2_coll_allreduce_pt2pt_rd_count_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_allreduce_pt2pt_rd_count_recv;
                             ...
                             MPIR_Errflag_t *errflag)
{
    ...
    if ((comm_ptr->dev.ch.shmem_coll_ok == 1) &&
        ((count * (MPL_MAX(extent, true_extent)) <  mv2_coll_tmp_buf_size))) {
