...
extern unsigned long long PVAR_COUNTERR_mv2_coll_ibarrier_sharp;
extern MPIR_T_pvar_timer_t PVAR_COUNTER_mv2_coll_timer_ibarrier_sharp;

#if defined(CHANNEL_MRAIL) || defined(_MV2_CH4_OVERRIDE_)

int (*MV2_Ibarrier_function) (MPIR_Comm *comm_ptr, MPIR_Sched_t s) = NULL;

int (*MV2_Ibarrier_intra_node_function) (MPIR_Comm *comm_ptr, MPIR_Sched_t s) = NULL;

#if defined (_SHARP_SUPPORT_)
int MPIR_Sharp_Ibarrier_MV2(MPIR_Comm * comm_ptr, MPIR_Errflag_t *errflag,
                            MPID_Request **req)
{
...
static int MPIR_Ibarrier_tune_helper_MV2(MPIR_Comm *comm_ptr, MPIR_Sched_t s)
{
    int mpi_errno = MPI_SUCCESS;
...
int MPIR_Ibarrier_intra_MV2(MPIR_Comm *comm_ptr, MPIR_Sched_t s)
{
    int mpi_errno = MPI_SUCCESS;
