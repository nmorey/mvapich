...
int MV2_set_ialltoall_tuning_table(int heterogeneity)
{
	...
	mv2_ialltoall_thresholds_table = MPL_malloc(mv2_size_ialltoall_tuning_table *
						  sizeof (mv2_ialltoall_tuning_table), MPL_MEM_COLL);
	mv2_ialltoall_tuning_table mv2_tmp_ialltoall_thresholds_table[] = {
	    {8,
	     8192,
	     {0},
	     1, {{0, -1, &MPIR_Ialltoall_intra_sched_pairwise, -1}},
	     1, {{0, -1, NULL, -1}}
	    },
	    {16,
	     8192,
      ...
      MPIR_Memcpy(mv2_ialltoall_thresholds_table, mv2_tmp_ialltoall_thresholds_table,
	...
	mv2_ialltoall_tuning_table mv2_tmp_ialltoall_thresholds_table[] = {
	    {8,
	     8192,
	     {0},
	     1, {{0, -1, &MPIR_Ialltoall_intra_sched_permuted_sendrecv, -1}},
	     1, {{0, -1, NULL, -1}}
	    },
	    {16,
	     8192,
	...
	mv2_ialltoall_tuning_table mv2_tmp_ialltoall_thresholds_table[] = {
	    ...
	    {512,
	     8192,
	     {0},
	     1, {{0, -1, &MPIR_Ialltoall_intra_sched_brucks, -1}},
	     1, {{0, -1, NULL, -1}}
	    }
      };
...
void MV2_cleanup_ialltoall_tuning_table()
{
	...
	MPL_free(mv2_ialltoall_thresholds_table);
    }
...
int MV2_internode_Ialltoall_is_define(char *mv2_user_ialltoall_inter, char *mv2_user_ialltoall_intra)
{
	...
	if (!(dup = MPL_strdup(mv2_user_ialltoall_inter))) {
    ...
    MPIR_Memcpy(mv2_ialltoall_thresholds_table, mv2_tmp_ialltoall_thresholds_table, sizeof
