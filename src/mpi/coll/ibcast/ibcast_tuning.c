...
int MV2_set_ibcast_tuning_table(int heterogeneity)
{
	...
	mv2_ibcast_thresholds_table = MPL_malloc(mv2_size_ibcast_tuning_table *
						  sizeof (mv2_ibcast_tuning_table), MPL_MEM_COLL);
	mv2_ibcast_tuning_table mv2_tmp_ibcast_thresholds_table[] = {
	    {8,
	     8192, 4, 4,
	     {0},
	     1, {{0, -1, &MPIR_Ibcast_intra_sched_binomial, -1}},
	     1, {{0, -1, NULL, -1}}
	    },
	    {16,
	     8192, 4, 4,
      ...
      MPIR_Memcpy(mv2_ibcast_thresholds_table, mv2_tmp_ibcast_thresholds_table,
	...
	mv2_ibcast_tuning_table mv2_tmp_ibcast_thresholds_table[] = {
	    {8,
	     8192, 4, 4,
	     {0},
	     1, {{0, -1, &MPIR_Ibcast_intra_sched_scatter_ring_allgather, -1}},
	     1, {{0, -1, NULL, -1}}
	    },
	    {16,
	     8192, 4, 4,
	    ...
	    {32,
	     ...
	     {0},
	     2, {
	         {0, 512, &MPIR_Ibcast_intra_sched_scatter_recursive_doubling_allgather, -1},
	    ...
	    {64,
	     ...
	     {0},
	     3, {
	       {0, 8, &MPIR_Ibcast_intra_sched_scatter_recursive_doubling_allgather, -1},
	    ...
	    {256,
	     ...
	     {0},
	     2, {
	         {0, 1024, &MPIR_Ibcast_intra_sched_scatter_recursive_doubling_allgather, -1},
	    ...
	    {512,
	     ...
	     {0},
	     2, {
	         {0, 256, &MPIR_Ibcast_intra_sched_scatter_recursive_doubling_allgather, -1},
	    ...
	    {1024,
	     ...
	     {0},
	     2, {
	         {0, 4, &MPIR_Ibcast_intra_sched_scatter_recursive_doubling_allgather, -1},
	...
	mv2_ibcast_tuning_table mv2_tmp_ibcast_thresholds_table[] = {
	    ...
	    {16,
	     8192, 4, 4,
	     {0},
	     1, {{0, -1, &MPIR_Ibcast_intra_sched_scatter_recursive_doubling_allgather, -1}},
	     1, {{0, -1, NULL, -1}}
	    },
	    {32,
	     8192, 4, 4,
...
void MV2_cleanup_ibcast_tuning_table()
{
	...
	MPL_free(mv2_ibcast_thresholds_table);
    }
...
int MV2_internode_Ibcast_is_define(char *mv2_user_ibcast_inter, char *mv2_user_ibcast_intra)
{
	...
	if (!(dup = MPL_strdup(mv2_user_ibcast_inter))) {
    ...
    MPIR_Memcpy(mv2_ibcast_thresholds_table, mv2_tmp_ibcast_thresholds_table, sizeof
