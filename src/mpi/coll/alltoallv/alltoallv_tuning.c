...
{
    if (mv2_use_indexed_tuning || mv2_use_indexed_alltoallv_tuning) {
        MPL_free(mv2_alltoallv_indexed_thresholds_table[0]);
        MPL_free(mv2_alltoallv_indexed_table_ppn_conf);
        MPL_free(mv2_size_alltoallv_indexed_tuning_table);
        if (mv2_alltoallv_indexed_thresholds_table != NULL) {
            MPL_free(mv2_alltoallv_indexed_thresholds_table);
        }
    } else {
        MPL_free(mv2_alltoallv_thresholds_table[0]);
        MPL_free(mv2_alltoallv_table_ppn_conf);
        MPL_free(mv2_size_alltoallv_tuning_table);
        if (mv2_alltoallv_thresholds_table != NULL) {
            MPL_free(mv2_alltoallv_thresholds_table);
        }
    }
}
    ...
    if (mv2_use_indexed_tuning || mv2_use_indexed_alltoallv_tuning) {
        ...
        if (mv2_size_alltoallv_indexed_tuning_table == NULL) {
            mv2_size_alltoallv_indexed_tuning_table =
                MPL_malloc(mv2_alltoallv_indexed_num_ppn_conf * sizeof(int), MPL_MEM_COLL);
        }
        ...
        mv2_alltoallv_indexed_thresholds_table =
            MPL_malloc(mv2_alltoallv_indexed_num_ppn_conf *
                    sizeof(mv2_alltoallv_indexed_tuning_table *), MPL_MEM_COLL);
        mv2_alltoallv_indexed_thresholds_table[0] =
            MPL_malloc(mv2_size_alltoallv_indexed_tuning_table[0] *
                    sizeof(mv2_alltoallv_indexed_tuning_table), MPL_MEM_COLL);
        ...
        MPIR_Memcpy(mv2_alltoallv_indexed_thresholds_table[0], mv2_tmp_alltoallv_indexed_thresholds_table, sizeof
        ...
        if (mv2_size_alltoallv_tuning_table == NULL) {
            mv2_size_alltoallv_tuning_table =
                MPL_malloc(mv2_alltoallv_num_ppn_conf * sizeof(int), MPL_MEM_COLL);
        }
        ...
        mv2_alltoallv_thresholds_table =
            MPL_malloc(mv2_alltoallv_num_ppn_conf *
                    sizeof(mv2_alltoallv_tuning_table *), MPL_MEM_COLL);
        mv2_alltoallv_thresholds_table[0] =
            MPL_malloc(mv2_size_alltoallv_tuning_table[0] *
                    sizeof(mv2_alltoallv_tuning_table), MPL_MEM_COLL);
        ...
        if (nb_element == 1) {
            ...
            if (!(dup = MPL_strdup(mv2_user_alltoallv))) {
        ...
        MPIR_Memcpy(mv2_alltoallv_thresholds_table[0], mv2_tmp_alltoallv_thresholds_table, sizeof
