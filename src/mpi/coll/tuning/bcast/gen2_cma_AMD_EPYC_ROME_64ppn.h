    ...
    {                                                                          \
        {64,                                                                   \
         ...
         {                                                                     \
             ...
             {16, &MPIR_Pipelined_Bcast_MVP},                                  \
             {32, &MPIR_Pipelined_Bcast_MVP},                                  \
             {64, &MPIR_Pipelined_Bcast_MVP},                                  \
             {128, &MPIR_Pipelined_Bcast_MVP},                                 \
             {256, &MPIR_Pipelined_Bcast_MVP},                                 \
             {512, &MPIR_Pipelined_Bcast_Zcpy_MVP, 4},                         \
             {1024, &MPIR_Bcast_scatter_doubling_allgather_MVP},               \
