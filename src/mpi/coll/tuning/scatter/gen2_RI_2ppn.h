    ...
    {{2,                                                                       \
     ...
     {8,                                                                       \
      ...
      {{1, &MPIR_Scatter_MVP_two_level_Direct},                                \
       ...
       {1048576, &MPIR_Scatter_MVP_Direct}},                                   \
      20,                                                                      \
      {{1, &MPIR_Scatter_MVP_Binomial},    {2, &MPIR_Scatter_MVP_Direct},      \
       {4, &MPIR_Scatter_MVP_Direct},      {8, &MPIR_Scatter_MVP_Binomial},    \
       {16, &MPIR_Scatter_MVP_Direct},     {32, &MPIR_Scatter_MVP_Binomial},   \
       {64, &MPIR_Scatter_MVP_Direct},     {128, &MPIR_Scatter_MVP_Direct},    \
       {256, &MPIR_Scatter_MVP_Direct},    {512, &MPIR_Scatter_MVP_Direct},    \
       {1024, &MPIR_Scatter_MVP_Direct},   {2048, &MPIR_Scatter_MVP_Direct},   \
       {4096, &MPIR_Scatter_MVP_Direct},   {8192, &MPIR_Scatter_MVP_Direct},   \
     ...
     {16,                                                                      \
      ...
      20,                                                                      \
      {{1, &MPIR_Scatter_MVP_Binomial},    {2, &MPIR_Scatter_MVP_Direct},      \
       {4, &MPIR_Scatter_MVP_Binomial},    {8, &MPIR_Scatter_MVP_Direct},      \
       {16, &MPIR_Scatter_MVP_Direct},     {32, &MPIR_Scatter_MVP_Direct},     \
