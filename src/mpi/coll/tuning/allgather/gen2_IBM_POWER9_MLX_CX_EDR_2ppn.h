    ...
    {                                                                          \
        {2, 21, {{1, &MPIR_Allgather_Ring_MVP},                                \
            ...
            {8, 21, {{1, &MPIR_Allgather_RD_MVP},                              \
                     ...
                     {16384, &MPIR_Allgather_Bruck_MVP},                       \
                     {32768, &MPIR_Allgather_Bruck_MVP},                       \
                     {65536, &MPIR_Allgather_Bruck_MVP},                       \
                     {131072, &MPIR_Allgather_Bruck_MVP},                      \
                     {262144, &MPIR_Allgather_Bruck_MVP},                      \
                     {524288, &MPIR_Allgather_Bruck_MVP},                      \
                     {1048576, &MPIR_Allgather_Bruck_MVP}}},                   \
            {16, 21, {{1, &MPIR_Allgather_RD_MVP},                             \
                      {2, &MPIR_Allgather_RD_MVP},                             \
                      {4, &MPIR_Allgather_RD_MVP},                             \
                      {8, &MPIR_Allgather_RD_MVP},                             \
                      {16, &MPIR_Allgather_RD_MVP},                            \
