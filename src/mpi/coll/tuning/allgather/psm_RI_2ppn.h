...
#define PSM__RI__2PPN                                                          \
    {{2,                                                                       \
      ...
      {{1, &MPIR_Allgather_RD_MVP},        {2, &MPIR_Allgather_Bruck_MVP},     \
       ...
       {16, &MPIR_Allgather_Bruck_MVP},    {32, &MPIR_Allgather_RD_MVP},       \
       {64, &MPIR_Allgather_RD_MVP},       {128, &MPIR_Allgather_Bruck_MVP},   \
       {256, &MPIR_Allgather_Bruck_MVP},   {512, &MPIR_Allgather_RD_MVP},      \
