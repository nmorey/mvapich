...
#define NEMESIS__INTEL_XEON_E5_2680_16__MLX_CX_FDR__2PPN                       \
    {{2,                                                                       \
      ...
      {{1, &MPIR_Allgather_Ring_MVP},      {2, &MPIR_Allgather_Ring_MVP},      \
       {4, &MPIR_Allgather_Ring_MVP},      {8, &MPIR_Allgather_RD_MVP},        \
       ...
       {65536, &MPIR_Allgather_Ring_MVP},  {131072, &MPIR_Allgather_RD_MVP},   \
       {262144, &MPIR_Allgather_Ring_MVP}, {524288, &MPIR_Allgather_RD_MVP},   \
