...
#define GEN2__INTEL_XEON_E5_2680_16__MLX_CX_FDR__1PPN                          \
    {{2,                                                                       \
      ...
      {{1, &MPIR_Allgather_Ring_MVP},     {2, &MPIR_Allgather_Ring_MVP},       \
       ...
       {16, &MPIR_Allgather_Ring_MVP},    {32, &MPIR_Allgather_Ring_MVP},      \
       {64, &MPIR_Allgather_Ring_MVP},    {128, &MPIR_Allgather_RD_MVP},       \
       {256, &MPIR_Allgather_Ring_MVP},   {512, &MPIR_Allgather_Ring_MVP},     \
       ...
       {65536, &MPIR_Allgather_RD_MVP},   {131072, &MPIR_Allgather_Ring_MVP},  \
       {262144, &MPIR_Allgather_RD_MVP},  {524288, &MPIR_Allgather_Ring_MVP},  \
     ...
     {4,                                                                       \
      ...
      {{1, &MPIR_Allgather_RD_MVP},        {2, &MPIR_Allgather_RD_MVP},        \
       ...
       {16, &MPIR_Allgather_RD_MVP},       {32, &MPIR_Allgather_RD_MVP},       \
