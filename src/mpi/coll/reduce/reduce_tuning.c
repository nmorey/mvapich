...
int MV2_set_reduce_tuning_table(int heterogeneity, struct coll_info *colls_arch_hca)
{
    if (mv2_use_indexed_tuning || mv2_use_indexed_reduce_tuning) {
        ...
        if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
            ...
            mv2_reduce_indexed_thresholds_table = 
                    MPL_malloc(sizeof(mv2_reduce_indexed_tuning_table *) *
                                mv2_reduce_indexed_num_ppn_conf, MPL_MEM_COLL);
            table_ptrs = MPL_malloc(sizeof(mv2_reduce_indexed_tuning_table *) *
                                mv2_reduce_indexed_num_ppn_conf, MPL_MEM_COLL);
            mv2_size_reduce_indexed_tuning_table = MPL_malloc(sizeof(int) *
                                mv2_reduce_indexed_num_ppn_conf, MPL_MEM_COLL);
            mv2_reduce_indexed_table_ppn_conf = MPL_malloc(sizeof(int) * 
                                mv2_reduce_indexed_num_ppn_conf, MPL_MEM_COLL);
            ...
            mv2_reduce_indexed_thresholds_table[0] =
                        MPL_malloc(agg_table_sum * 
                                    sizeof(mv2_reduce_indexed_tuning_table), 
                                    MPL_MEM_COLL);
            MPIR_Memcpy(mv2_reduce_indexed_thresholds_table[0], table_ptrs[0],
                        (sizeof(mv2_reduce_indexed_tuning_table) *
            ...
            for (i = 1; i < mv2_reduce_indexed_num_ppn_conf; i++) {
                ...
                MPIR_Memcpy(mv2_reduce_indexed_thresholds_table[i], table_ptrs[i],
                            (sizeof(mv2_reduce_indexed_tuning_table) *
        ...
        if ((MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
            ...
            mv2_reduce_indexed_thresholds_table[0] =
                    MPL_malloc(agg_table_sum * sizeof(mv2_reduce_indexed_tuning_table),
                                MPL_MEM_COLL);
            MPIR_Memcpy(mv2_reduce_indexed_thresholds_table[0], table_ptrs[0],
                        (sizeof(mv2_reduce_indexed_tuning_table) *
                        mv2_size_reduce_indexed_tuning_table[0]));
        ...
        if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
            ...
            mv2_reduce_indexed_tuning_table 
                    mv2_tmp_cma_reduce_indexed_thresholds_table_32ppn[] =
                        GEN2_CMA__AMD_OPTERON_6136_32__MLX_CX_QDR__32PPN;
            mv2_reduce_indexed_tuning_table 
                    mv2_tmp_reduce_indexed_thresholds_table_32ppn[] =
            ...
            mv2_reduce_indexed_table_ppn_conf[0] = 1;
            mv2_reduce_indexed_tuning_table 
                    mv2_tmp_reduce_indexed_thresholds_table_1ppn[] =
                        GEN2__INTEL_XEON_E5_2670_16__MLX_CX_QDR__1PPN;
            mv2_reduce_indexed_tuning_table 
                    mv2_tmp_cma_reduce_indexed_thresholds_table_1ppn[] =
            ...
            mv2_reduce_indexed_table_ppn_conf[1] = 2;
            mv2_reduce_indexed_tuning_table 
                    mv2_tmp_reduce_indexed_thresholds_table_2ppn[] =
                        GEN2__INTEL_XEON_E5_2670_16__MLX_CX_QDR__2PPN;
            mv2_reduce_indexed_tuning_table 
                    mv2_tmp_cma_reduce_indexed_thresholds_table_2ppn[] =
            ...
            mv2_reduce_indexed_tuning_table 
                    mv2_tmp_cma_reduce_indexed_thresholds_table_16ppn[] =
                        GEN2_CMA__INTEL_XEON_E5_2670_16__MLX_CX_QDR__16PPN;
            mv2_reduce_indexed_tuning_table 
                    mv2_tmp_reduce_indexed_thresholds_table_16ppn[] =
            ...
            mv2_reduce_indexed_tuning_table 
                    mv2_tmp_reduce_indexed_thresholds_table_4ppn[] =
            ...
            return 0;
                    ...
                    MV2_ARCH_INTEL_XEON_E5_2680_V4_2S_28, MV2_HCA_MLX_CX_EDR) && 
                 !heterogeneity) {
            /*RI2 Table*/
    force_default_tables:
            ...
            MV2_COLL_TUNING_FINISH_TABLE (reduce)
                     ...
                     MV2_ARCH_AMD_EPYC_7551_64, MV2_HCA_MLX_CX_EDR) && 
                 !heterogeneity) {
            /* AMD EPYC table */
            ...
            MV2_COLL_TUNING_FINISH_TABLE (reduce)
                     ...
                     MV2_ARCH_AMD_EPYC_7551_64, MV2_HCA_MLX_CX_HDR) && 
                 !heterogeneity) {
            /* AMD EPYC table */
            MV2_COLL_TUNING_START_TABLE  (reduce, 7)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 1,  3, GEN2__AMD_EPYC__1PPN)
            ...
            MV2_COLL_TUNING_ADD_CONF     (reduce, 32, 4, GEN2__AMD_EPYC__32PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 32, 4, GEN2_CMA__AMD_EPYC__32PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 64, 4, GEN2_CMA__AMD_EPYC_VENUS__64PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 64, 4, GEN2_CMA__AMD_EPYC_VENUS__64PPN)
            MV2_COLL_TUNING_FINISH_TABLE (reduce)
        }
        else if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
            ...
            MV2_COLL_TUNING_ADD_CONF     (reduce, 1,  3, GEN2_CMA__AMD_EPYC_ROME__1PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 1,  3, GEN2_CMA__AMD_EPYC_ROME__1PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 2,  4, GEN2_CMA__AMD_EPYC_ROME__2PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 2,  4, GEN2_CMA__AMD_EPYC_ROME__2PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 4,  4, GEN2_CMA__AMD_EPYC_ROME__4PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 4,  4, GEN2_CMA__AMD_EPYC_ROME__4PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 8,  4, GEN2_CMA__AMD_EPYC_ROME__8PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 8,  4, GEN2_CMA__AMD_EPYC_ROME__8PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 16, 4, GEN2_CMA__AMD_EPYC_ROME__16PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 16, 4, GEN2_CMA__AMD_EPYC_ROME__16PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 32, 4, GEN2_CMA__AMD_EPYC_ROME__32PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 32, 4, GEN2_CMA__AMD_EPYC_ROME__32PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 60, 4, GEN2_CMA__AMD_EPYC_ROME__60PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 60, 4, GEN2_CMA__AMD_EPYC_ROME__60PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 64, 4, GEN2_CMA__AMD_EPYC_ROME__64PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 64, 4, GEN2_CMA__AMD_EPYC_ROME__64PPN)
            MV2_COLL_TUNING_FINISH_TABLE (reduce)
        }
        else if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
                    MV2_ARCH_AMD_EPYC_7742_128, MV2_HCA_ANY) && !heterogeneity) {
            /* AMD EPYC rome table */
            MV2_COLL_TUNING_START_TABLE  (reduce, 10)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 1,  3, GEN2_CMA__AMD_EPYC_ROME__1PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 1,  3, GEN2_CMA__AMD_EPYC_ROME__1PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 2,  4, GEN2_CMA__AMD_EPYC_ROME__2PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 2,  4, GEN2_CMA__AMD_EPYC_ROME__2PPN)
            ...
            MV2_COLL_TUNING_ADD_CONF     (reduce, 64, 4, GEN2_CMA__AMD_EPYC_ROME__64PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 64, 4, GEN2_CMA__AMD_EPYC_ROME__64PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 120, 4, GEN2_CMA__AMD_EPYC_ROME__120PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 120, 4, GEN2_CMA__AMD_EPYC_ROME__120PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 128, 4, GEN2_CMA__AMD_EPYC_ROME__128PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 128, 4, GEN2_CMA__AMD_EPYC_ROME__128PPN)
            MV2_COLL_TUNING_FINISH_TABLE (reduce)
        }
        else if(MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
                    MV2_ARCH_INTEL_XEON_E5_2687W_V3_2S_20, MV2_HCA_MLX_CX_HDR) && 
                !heterogeneity) {
            ...
            /* Frontera */
            MV2_COLL_TUNING_START_TABLE  (reduce, 8)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 1,  7, GEN2_CMA__FRONTERA__1PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 1,  7, GEN2_CMA__FRONTERA__1PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 2,  8, GEN2_CMA__FRONTERA__2PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 2,  8, GEN2_CMA__FRONTERA__2PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 4,  8, GEN2_CMA__FRONTERA__4PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 4,  8, GEN2_CMA__FRONTERA__4PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 8,  8, GEN2_CMA__FRONTERA__8PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 8,  8, GEN2_CMA__FRONTERA__8PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 16, 8, GEN2_CMA__FRONTERA__16PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 16, 8, GEN2_CMA__FRONTERA__16PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 28, 8, GEN2_CMA__FRONTERA__28PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 28, 8, GEN2_CMA__FRONTERA__28PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 32, 8, GEN2_CMA__FRONTERA__32PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 32, 8, GEN2_CMA__FRONTERA__32PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 56, 8, GEN2_CMA__FRONTERA__56PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 56, 8, GEN2_CMA__FRONTERA__56PPN)
            MV2_COLL_TUNING_FINISH_TABLE (reduce)
        }
        else if(MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
                    MV2_ARCH_AMD_EPYC_7401_48, MV2_HCA_MLX_CX_EDR) && 
                !heterogeneity) {
            /* LLNL Corona */
            MV2_COLL_TUNING_START_TABLE  (reduce, 7)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 1,  4, GEN2_CMA__AMD_EPYC_7401_24__1PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 1,  4, GEN2_CMA__AMD_EPYC_7401_24__1PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 2,  5, GEN2_CMA__AMD_EPYC_7401_24__2PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 2,  5, GEN2_CMA__AMD_EPYC_7401_24__2PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 4,  5, GEN2_CMA__AMD_EPYC_7401_24__4PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 4,  5, GEN2_CMA__AMD_EPYC_7401_24__4PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 8,  5, GEN2_CMA__AMD_EPYC_7401_24__8PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 8,  5, GEN2_CMA__AMD_EPYC_7401_24__8PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 16, 5, GEN2_CMA__AMD_EPYC_7401_24__16PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 16, 5, GEN2_CMA__AMD_EPYC_7401_24__16PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 32, 5, GEN2_CMA__AMD_EPYC_7401_24__32PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 32, 5, GEN2_CMA__AMD_EPYC_7401_24__32PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 48, 5, GEN2_CMA__AMD_EPYC_7401_24__48PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 48, 5, GEN2_CMA__AMD_EPYC_7401_24__48PPN)
            MV2_COLL_TUNING_FINISH_TABLE (reduce)
        }
        else if(MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
                    MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16, MV2_HCA_MLX_CX_FDR) && 
                !heterogeneity) {
            /* Frontera RTX */
            MV2_COLL_TUNING_START_TABLE  (reduce, 5)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 1,  4, 
                    GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__1PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 1,  4, 
                    GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__1PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 2,  5,
                    GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__2PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 2,  5,
                    GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__2PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 4,  5,
                    GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__4PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 4,  5,
                    GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__4PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 8,  5,
                    GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__8PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 8,  5,
                    GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__8PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 16, 5,
                    GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__16PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 16, 5,
                    GEN2_CMA__MV2_ARCH_INTEL_XEON_E5_2620_V4_2S_16__16PPN)
            MV2_COLL_TUNING_FINISH_TABLE (reduce)
        }
        else if(MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
                    MV2_ARCH_ARM_CAVIUM_V8_2S_28, MV2_HCA_MLX_CX_EDR) && 
                !heterogeneity) {
            /* Mayer */
            MV2_COLL_TUNING_START_TABLE  (reduce, 8)
            ...
            MV2_COLL_TUNING_FINISH_TABLE (reduce)
                ...
                MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
                    MV2_ARCH_ARM_FUJITSU_V0_4S_48, MV2_HCA_MLX_CX_EDR)) && 
                !heterogeneity) {
            /* Catalyst & Ookami */
            MV2_COLL_TUNING_START_TABLE  (reduce, 7)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 1,  5, 
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__1PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 1,  5,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__1PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 2,  6,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__2PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 2,  6,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__2PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 4,  6,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__4PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 4,  6,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__4PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 8,  6,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__8PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 8,  6,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__8PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 16, 6,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__16PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 16, 6,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__16PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 32, 6,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__32PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 32, 6,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__32PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 64, 6,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__64PPN)
            MV2_COLL_TUNING_ADD_CONF_CMA (reduce, 64, 6,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_32_MLX_CX_EDR__64PPN)
            MV2_COLL_TUNING_FINISH_TABLE (reduce)
        }
        else if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
                    MV2_ARCH_ARM_CAVIUM_V8_2S_28, MV2_HCA_MLX_CX_FDR) && 
                 !heterogeneity) {
            /* ARM system at Hartree Center */
            MV2_COLL_TUNING_START_TABLE  (reduce, 5)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 1,  2,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_28_MLX_CX_FDR__1PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 4,  3,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_28_MLX_CX_FDR__4PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 8,  3,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_28_MLX_CX_FDR__8PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 16,  3,
                          GEN2_CMA__ARM_CAVIUM_V8_2S_28_MLX_CX_FDR__16PPN)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 24,  3,
          ...
          MV2_COLL_TUNING_FINISH_TABLE (reduce)
            ...
            mv2_reduce_indexed_tuning_table 
                    mv2_tmp_reduce_indexed_thresholds_table_24ppn[] =
        ...
        if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
            ...
            mv2_reduce_indexed_tuning_table 
                    mv2_tmp_reduce_indexed_thresholds_table_8ppn[] =
                        NEMESIS__RI__8PPN
...
#endif
#else /* !_MV2_CH4_OVERRIDE_ */
        if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
                MV2_ARCH_INTEL_XEON_X5650_12, MV2_HCA_QLGIC_QIB) && 
            !heterogeneity) {
            /*Sierra Table*/
            ...
            return 0;
                     ...
                     MV2_ARCH_INTEL_XEON_E5_2695_V3_2S_28, MV2_HCA_INTEL_HFI1) && 
                 !heterogeneity) {
            /*Bridges Table*/
            MV2_COLL_TUNING_START_TABLE  (reduce, 6)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 1,  4,
            ...
            MV2_COLL_TUNING_ADD_CONF     (reduce, 28,  5,
                        PSM__INTEL_XEON_E5_2695_V3_2S_28_INTEL_HFI_100__28PPN)
            MV2_COLL_TUNING_FINISH_TABLE (reduce)
        }
        else if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
                     MV2_ARCH_INTEL_XEON_E5_2695_V4_2S_36, MV2_HCA_INTEL_HFI1) && 
                 !heterogeneity) {
            ...
            MV2_COLL_TUNING_ADD_CONF     (reduce, 36, 5,
                        PSM__INTEL_XEON_E5_2695_V4_2S_36_INTEL_HFI_100__36PPN)
            MV2_COLL_TUNING_FINISH_TABLE (reduce)
        }
        else if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
                     MV2_ARCH_INTEL_XEON_PHI_7250, MV2_HCA_INTEL_HFI1) && 
                 !heterogeneity) {
            /* TACC-KNL Table */
            MV2_COLL_TUNING_START_TABLE  (reduce, 6)
            MV2_COLL_TUNING_ADD_CONF     (reduce, 1,  5,
...
#endif /* !_MV2_CH4_OVERRIDE_ */
        {
            ...
            mv2_reduce_indexed_thresholds_table =
                        MPL_malloc(sizeof(mv2_reduce_indexed_tuning_table *) *
                                    mv2_reduce_indexed_num_ppn_conf, MPL_MEM_COMM);
            table_ptrs = MPL_malloc(sizeof(mv2_reduce_indexed_tuning_table *) * 
                                    mv2_reduce_indexed_num_ppn_conf, MPL_MEM_COMM);
            mv2_size_reduce_indexed_tuning_table = MPL_malloc(sizeof(int) *
                                    mv2_reduce_indexed_num_ppn_conf, MPL_MEM_COMM);
      ...
      if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
        ...
        mv2_reduce_thresholds_table = MPL_malloc(mv2_size_reduce_tuning_table *
                              sizeof(mv2_reduce_tuning_table), MPL_MEM_COLL);
      ...
      },
      {
        ...
        MPIR_Memcpy(mv2_reduce_thresholds_table, mv2_tmp_reduce_thresholds_table,
...
{
  if (mv2_use_indexed_tuning || mv2_use_indexed_reduce_tuning) {
    MPL_free(mv2_reduce_indexed_thresholds_table[0]);
    MPL_free(mv2_reduce_indexed_table_ppn_conf);
    MPL_free(mv2_size_reduce_indexed_tuning_table);
    if (mv2_reduce_indexed_thresholds_table != NULL) {
      MPL_free(mv2_reduce_indexed_thresholds_table);
    }
  }
  else {
    if (mv2_reduce_thresholds_table != NULL) {
        MPL_free(mv2_reduce_thresholds_table);
    }
  }
}
    ...
    if (mv2_use_indexed_tuning || mv2_use_indexed_reduce_tuning) {
      ...
      if (mv2_size_reduce_indexed_tuning_table == NULL) {
          mv2_size_reduce_indexed_tuning_table =
                  MPL_malloc(mv2_reduce_indexed_num_ppn_conf * sizeof(int), 
                                MPL_MEM_COLL);
      }
      ...
      mv2_reduce_indexed_thresholds_table =
        MPL_malloc(mv2_reduce_indexed_num_ppn_conf *
                    sizeof(mv2_reduce_indexed_tuning_table *), MPL_MEM_COLL);
      mv2_reduce_indexed_thresholds_table[0] =
        MPL_malloc(mv2_size_reduce_indexed_tuning_table[0] *
                    sizeof(mv2_reduce_indexed_tuning_table), MPL_MEM_COLL);
      ...
      if (nb_element == 1) {
          ...
          case REDUCE_BINOMIAL:
              mv2_tmp_reduce_indexed_thresholds_table[0].inter_leader[0].
                                        MV2_pt_Reduce_function =
                                          &MPIR_Reduce_binomial_MV2;
              break;
          case REDUCE_ALLREDUCE:
              mv2_tmp_reduce_indexed_thresholds_table[0].inter_leader[0].
                                        MV2_pt_Reduce_function =
                                          &MPIR_Reduce_allreduce_MV2;
               ...
               */
              int i, j;
              for (i = 0; i < mv2_size_red_scat_tuning_table; i++) {
                  mv2_red_scat_tuning_table *tbl =
                              &mv2_red_scat_thresholds_table[i];
                  int size = tbl->size_inter_table;
                  for (j = 0; j < size; j++) {
                      if (tbl->inter_leader[j].MV2_pt_Red_scat_function ==
                                             &MPIR_Reduce_Scatter_Basic_MV2) {
                          PRINT_DEBUG(DEBUG_SHM_verbose,
                                  "Invalid algorithm for reduce_scatter "
                                  "when forcing REDUCE_ALLREDUCE.\n"
                                  "Setting to "
                                  "MPIR_Reduce_scatter_Rec_Halving_MV2\n");
                          tbl->inter_leader[j].MV2_pt_Red_scat_function =
                                         &MPIR_Reduce_scatter_Rec_Halving_MV2;
                      }
                  }
              }
          ...
          if (nb_element == 1) {
            ...
            mv2_tmp_reduce_indexed_thresholds_table[0].is_two_level_reduce[0]=0;
              ...
              switch (atoi(mv2_user_reduce_intra)) {
                  case REDUCE_BINOMIAL:
                      mv2_tmp_reduce_indexed_thresholds_table[0].intra_node[0].
                                MV2_pt_Reduce_function =
                                        &MPIR_Reduce_binomial_MV2;
                      break;
      ...
      MPIR_Memcpy(mv2_reduce_indexed_thresholds_table[0], 
                  mv2_tmp_reduce_indexed_thresholds_table, 
                  sizeof(mv2_reduce_indexed_tuning_table));
    }
    else {
        /* If one reduce tuning table is already defined */
        ...
        if (nb_element == 1) {
          ...
          switch (atoi(mv2_user_reduce_inter)) {
              case REDUCE_BINOMIAL:
                  mv2_tmp_reduce_thresholds_table[0].inter_leader[0].
                            MV2_pt_Reduce_function =
                                  &MPIR_Reduce_binomial_MV2;
                  break;
              case REDUCE_INTER_KNOMIAL:
            ...
            if (!(dup = MPL_strdup(mv2_user_reduce_inter))) {
            ...
            for (p = strtok_r(dup, ",", &save_p); p; p = strtok_r(NULL, ",", &save_p)) {
                ...
                switch (atoi(p + match[1].rm_so)) {
                    case REDUCE_BINOMIAL:
                        mv2_tmp_reduce_thresholds_table[0].inter_leader[i].
                                MV2_pt_Reduce_function =
                                    &MPIR_Reduce_binomial_MV2;
                        break;
                    case REDUCE_INTER_KNOMIAL:
...
int MV2_intranode_Reduce_is_define(char *mv2_user_reduce_intra)
{
    ...
    if (nb_element == 1) {
        ...
        if (!(dup = MPL_strdup(mv2_user_reduce_intra))) {
            fprintf(stderr, "failed to duplicate `%s'\n", mv2_user_reduce_intra);
            return 1;
        }
