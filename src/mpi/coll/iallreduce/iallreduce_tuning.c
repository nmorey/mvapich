...
int MV2_set_iallreduce_tuning_table(int heterogeneity)
{
	...
	mv2_iallreduce_thresholds_table = MPL_malloc(mv2_size_iallreduce_tuning_table *
						  sizeof (mv2_iallreduce_tuning_table), MPL_MEM_COLL);
	mv2_iallreduce_tuning_table mv2_tmp_iallreduce_thresholds_table[] = {
	    {8,
	     8192, 4, 4,
	     {0},
	     1, {{0, -1, &MPIR_Iallreduce_intra_sched_naive, -1}},
	     1, {{0, -1, NULL, -1}}
	    },
	    {16,
	     8192, 4, 4,
      ...
      MPIR_Assert(sizeof(mv2_tmp_iallreduce_thresholds_table) ==
		  mv2_size_iallreduce_tuning_table * sizeof (mv2_iallreduce_tuning_table));
      MPIR_Memcpy(mv2_iallreduce_thresholds_table, mv2_tmp_iallreduce_thresholds_table,
		  mv2_size_iallreduce_tuning_table * sizeof (mv2_iallreduce_tuning_table));
	...
	mv2_iallreduce_tuning_table mv2_tmp_iallreduce_thresholds_table[] = {
	    {8,
	     8192, 4, 4,
	     {0},
	     1, {{0, -1, &MPIR_Iallreduce_intra_sched_recursive_doubling, -1}},
	     1, {{0, -1, NULL, -1}}
	    },
	    {16,
	     8192, 4, 4,
...
void MV2_cleanup_iallreduce_tuning_table()
{
	...
	MPL_free(mv2_iallreduce_thresholds_table);
    }
...
int MV2_internode_Iallreduce_is_define(char *mv2_user_iallreduce_inter, char *mv2_user_iallreduce_intra)
{
	...
	if (!(dup = MPL_strdup(mv2_user_iallreduce_inter))) {
    ...
    MPIR_Memcpy(mv2_iallreduce_thresholds_table, mv2_tmp_iallreduce_thresholds_table, sizeof
