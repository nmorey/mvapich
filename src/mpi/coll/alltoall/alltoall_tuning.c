...
int MV2_set_alltoall_tuning_table(int heterogeneity, struct coll_info *colls_arch_hca)
{
  ...
  int i;
	...
	mv2_alltoall_indexed_thresholds_table
	  = MPL_malloc(sizeof(mv2_alltoall_indexed_tuning_table *)
			* mv2_alltoall_indexed_num_ppn_conf, MPL_MEM_COLL);
	table_ptrs = MPL_malloc(sizeof(mv2_alltoall_indexed_tuning_table *)
				 * mv2_alltoall_indexed_num_ppn_conf, MPL_MEM_COLL);
	mv2_size_alltoall_indexed_tuning_table = MPL_malloc(sizeof(int) *
							  mv2_alltoall_indexed_num_ppn_conf, MPL_MEM_COLL);
	mv2_alltoall_indexed_table_ppn_conf = MPL_malloc(mv2_alltoall_indexed_num_ppn_conf * sizeof(int), MPL_MEM_COLL);
	...
	mv2_alltoall_indexed_thresholds_table[0] =
	  MPL_malloc(agg_table_sum * sizeof (mv2_alltoall_indexed_tuning_table), MPL_MEM_COLL);
	MPIR_Memcpy(mv2_alltoall_indexed_thresholds_table[0], table_ptrs[0],
	...
	for (i = 1; i < mv2_alltoall_indexed_num_ppn_conf; i++) {
	  ...
	  MPIR_Memcpy(mv2_alltoall_indexed_thresholds_table[i], table_ptrs[i],
		      (sizeof(mv2_alltoall_indexed_tuning_table)
    ...
    MV2_COLL_TUNING_FINISH_TABLE (alltoall)
      ...
      /* Spock @ORNL table */
      MV2_COLL_TUNING_START_TABLE  (alltoall, 7)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 1,  4, GEN2_CMA__AMD_EPYC_7763_128__1PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (alltoall, 1,  4, GEN2_CMA__AMD_EPYC_7763_128__1PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 2,  5, GEN2_CMA__AMD_EPYC_7763_128__2PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (alltoall, 2,  5, GEN2_CMA__AMD_EPYC_7763_128__2PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 4,  5, GEN2_CMA__AMD_EPYC_7763_128__4PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (alltoall, 4,  5, GEN2_CMA__AMD_EPYC_7763_128__4PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 8,  5, GEN2_CMA__AMD_EPYC_7763_128__8PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (alltoall, 8,  5, GEN2_CMA__AMD_EPYC_7763_128__8PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 16, 5, GEN2_CMA__AMD_EPYC_7763_128__16PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (alltoall, 16, 5, GEN2_CMA__AMD_EPYC_7763_128__16PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 32, 5, GEN2_CMA__AMD_EPYC_7763_128__32PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (alltoall, 32, 5, GEN2_CMA__AMD_EPYC_7763_128__32PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 64, 4, GEN2_CMA__AMD_EPYC_7763_128__64PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (alltoall, 64, 4, GEN2_CMA__AMD_EPYC_7763_128__64PPN)
      MV2_COLL_TUNING_FINISH_TABLE (alltoall)
    }
    else if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
      ...
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 64, 4, GEN2_CMA__AMD_EPYC_7763_128__64PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (alltoall, 64, 4, GEN2_CMA__AMD_EPYC_7763_128__64PPN)
      MV2_COLL_TUNING_ADD_CONF     (alltoall, 128, 3, GEN2_CMA__AMD_EPYC_7763_128__128PPN)
      MV2_COLL_TUNING_ADD_CONF_CMA (alltoall, 128, 3, GEN2_CMA__AMD_EPYC_7763_128__128PPN)
      MV2_COLL_TUNING_FINISH_TABLE (alltoall)
    }
    else if (MV2_IS_ARCH_HCA_TYPE(MV2_get_arch_hca_type(),
	...
	*/
	...
	return 0;
	  ...
	  = MPL_malloc(sizeof(mv2_alltoall_tuning_table *)
			* mv2_alltoall_num_ppn_conf, MPL_MEM_COLL);
        table_ptrs = MPL_malloc(sizeof(mv2_alltoall_tuning_table *)
				 * mv2_alltoall_num_ppn_conf, MPL_MEM_COLL);
        mv2_size_alltoall_tuning_table = MPL_malloc(sizeof(int) *
						     mv2_alltoall_num_ppn_conf, MPL_MEM_COLL);
        mv2_alltoall_table_ppn_conf = MPL_malloc(mv2_alltoall_num_ppn_conf * sizeof(int), MPL_MEM_COLL);
	  ...
	  MPL_malloc(agg_table_sum * sizeof (mv2_alltoall_tuning_table), MPL_MEM_COLL);
        MPIR_Memcpy(mv2_alltoall_thresholds_table[0], table_ptrs[0],
	  ...
	  MPIR_Memcpy(mv2_alltoall_thresholds_table[i], table_ptrs[i],
                      (sizeof(mv2_alltoall_tuning_table)
...
{
  if (mv2_use_indexed_tuning || mv2_use_indexed_alltoall_tuning) {
    MPL_free(mv2_alltoall_indexed_thresholds_table[0]);
    MPL_free(mv2_alltoall_indexed_table_ppn_conf);
    MPL_free(mv2_size_alltoall_indexed_tuning_table);
    if (mv2_alltoall_indexed_thresholds_table != NULL) {
      MPL_free(mv2_alltoall_indexed_thresholds_table);
    }
  }
  else {
    MPL_free(mv2_alltoall_thresholds_table[0]);
    MPL_free(mv2_alltoall_table_ppn_conf);
    MPL_free(mv2_size_alltoall_tuning_table);
    if (mv2_alltoall_thresholds_table != NULL) {
        MPL_free(mv2_alltoall_thresholds_table);
    }
  }
}
...
int MV2_Alltoall_is_define(char *mv2_user_alltoall)
{
    ...
    if (mv2_use_indexed_tuning || mv2_use_indexed_alltoall_tuning) {
	  ...
	  MPL_malloc(mv2_alltoall_indexed_num_ppn_conf * sizeof(int), MPL_MEM_COLL);
      }
      ...
      mv2_alltoall_indexed_thresholds_table =
	MPL_malloc(mv2_alltoall_indexed_num_ppn_conf *
		    sizeof(mv2_alltoall_indexed_tuning_table *), MPL_MEM_COLL);
      mv2_alltoall_indexed_thresholds_table[0] =
	MPL_malloc(mv2_size_alltoall_indexed_tuning_table[0] *
		    sizeof(mv2_alltoall_indexed_tuning_table), MPL_MEM_COLL);
      ...
      MPIR_Memcpy(mv2_alltoall_indexed_thresholds_table[0], mv2_tmp_alltoall_indexed_thresholds_table, sizeof
	  ...
	  MPL_malloc(mv2_alltoall_num_ppn_conf * sizeof(int), MPL_MEM_COLL);
      }
      ...
      mv2_alltoall_thresholds_table =
	MPL_malloc(mv2_alltoall_num_ppn_conf *
		    sizeof(mv2_alltoall_tuning_table *), MPL_MEM_COLL);
      mv2_alltoall_thresholds_table[0] =
	MPL_malloc(mv2_size_alltoall_tuning_table[0] *
		    sizeof(mv2_alltoall_tuning_table), MPL_MEM_COLL);
	  ...
	  mv2_tmp_alltoall_thresholds_table[0].algo_table[0].MV2_pt_Alltoall_function =
        ...
        if (!(dup = MPL_strdup(mv2_user_alltoall))) {
      ...
      MPIR_Memcpy(mv2_alltoall_thresholds_table[0], mv2_tmp_alltoall_thresholds_table, sizeof
