...
extern MPIR_T_pvar_timer_t PVAR_TIMER_mv2_coll_timer_gatherv_algo;

extern unsigned long long PVAR_COUNTER_mv2_coll_gatherv_algo;

extern unsigned long long PVAR_COUNTER_mv2_coll_gatherv_default_bytes_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_gatherv_default_bytes_recv;
extern unsigned long long PVAR_COUNTER_mv2_coll_gatherv_default_count_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_gatherv_default_count_recv;

extern unsigned long long PVAR_COUNTER_mv2_coll_gatherv_bytes_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_gatherv_bytes_recv;
extern unsigned long long PVAR_COUNTER_mv2_coll_gatherv_count_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_gatherv_count_recv;

/*Ditto MPICH code except for a few changes*/
int MPIR_Gatherv_MV2 (const void *sendbuf,
	              int sendcount,
        ...
        for (i = 0; i < comm_size; i++) {
            if (recvcounts[i]) {
                if ((comm_ptr->comm_kind == MPIR_COMM_KIND__INTRACOMM) 
                    ...
                    MPIR_PVAR_INC(gatherv, default, recv, 
