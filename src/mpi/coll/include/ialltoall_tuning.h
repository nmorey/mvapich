...
extern int MPIR_Ialltoall_intra_sched_brucks(const void *sendbuf, int sendcount,
				MPI_Datatype sendtype, void *recvbuf,
				int recvcount, MPI_Datatype recvtype,
				MPIR_Comm *comm_ptr, MPIR_Sched_t s);
extern int MPIR_Ialltoall_intra_sced_permuted_sendrecv(const void *sendbuf,
                  int sendcount, MPI_Datatype sendtype, void *recvbuf,
				  int recvcount, MPI_Datatype recvtype,
				  MPIR_Comm *comm_ptr, MPIR_Sched_t s);
extern int MPIR_Ialltoall_intra_sched_pairwise(const void *sendbuf,
                   int sendcount, MPI_Datatype sendtype, void *recvbuf,
