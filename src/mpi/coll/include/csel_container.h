...
typedef enum {
    ...
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Allgather_intra_osu_direct,
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Allgather_intra_osu_direct_spread,
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Allgather_intra_osu_gather_bcast,
    ...
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Barrier_intra_osu_pairwise,
    ...
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Bcast_intra_osu_knomial,
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Bcast_intra_osu_pairwise,
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Bcast_intra_osu_pipelined,
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Bcast_intra_osu_zcopy,
    ...
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Gather_intra_osu_direct,
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Gather_intra_osu_direct_block,
    ...
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Reduce_intra_osu_knomial,
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Reduce_intra_osu_allreduce,
    ...
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Reduce_scatter_intra_osu_basic,
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Reduce_scatter_intra_osu_ring,
    ...
    MPII_CSEL_CONTAINER_TYPE__ALGORITHM__MPIR_Scatter_intra_osu_direct,
