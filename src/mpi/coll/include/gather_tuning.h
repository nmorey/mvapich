...
extern MPIR_T_pvar_timer_t PVAR_TIMER_mv2_coll_timer_gather_pt2pt;
extern MPIR_T_pvar_timer_t PVAR_TIMER_mv2_coll_timer_gather_direct;
extern MPIR_T_pvar_timer_t PVAR_TIMER_mv2_coll_timer_gather_direct_blk;
extern MPIR_T_pvar_timer_t PVAR_TIMER_mv2_coll_timer_gather_two_level_direct;
extern MPIR_T_pvar_timer_t PVAR_TIMER_mv2_coll_timer_gather_limic_scheme_pt_pt;
extern MPIR_T_pvar_timer_t 
    PVAR_TIMER_mv2_coll_timer_gather_limic_scheme_pt_linear;
extern MPIR_T_pvar_timer_t 
    PVAR_TIMER_mv2_coll_timer_gather_limic_scheme_linear_pt;
extern MPIR_T_pvar_timer_t 
    PVAR_TIMER_mv2_coll_timer_gather_limic_scheme_linear_linear;
extern MPIR_T_pvar_timer_t 
    PVAR_TIMER_mv2_coll_timer_gather_limic_scheme_single_leader;
extern MPIR_T_pvar_timer_t PVAR_TIMER_mv2_coll_timer_gather_intra_node_limic;

extern unsigned long long PVAR_COUNTER_mv2_coll_gather_pt2pt;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_direct;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_direct_blk;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_two_level_direct;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_limic_scheme_pt_pt;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_limic_scheme_pt_linear;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_limic_scheme_linear_pt;
extern unsigned long long 
    PVAR_COUNTER_mv2_coll_gather_limic_scheme_linear_linear;
extern unsigned long long 
    PVAR_COUNTER_mv2_coll_gather_limic_scheme_single_leader;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_intra_node_limic;

extern unsigned long long PVAR_COUNTER_mv2_coll_gather_direct_bytes_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_direct_blk_bytes_send;
extern unsigned long long 
    PVAR_COUNTER_mv2_coll_gather_two_level_direct_bytes_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_direct_bytes_recv;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_direct_blk_bytes_recv;
extern unsigned long long 
    PVAR_COUNTER_mv2_coll_gather_two_level_direct_bytes_recv;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_direct_count_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_direct_blk_count_send;
extern unsigned long long 
    PVAR_COUNTER_mv2_coll_gather_two_level_direct_count_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_direct_count_recv;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_direct_blk_count_recv;
extern unsigned long long 
    PVAR_COUNTER_mv2_coll_gather_two_level_direct_count_recv;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_bytes_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_bytes_recv;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_count_send;
extern unsigned long long PVAR_COUNTER_mv2_coll_gather_count_recv;
...
#if defined(_SMP_LIMIC_)
extern int MPIR_Intra_node_LIMIC_Gather_MV2(const void *sendbuf,int sendcnt, 
                                        MPI_Datatype sendtype,
                                        void *recvbuf, int recvcnt,
                                        MPI_Datatype recvtype,
                                        int root, MPIR_Comm * comm_ptr, 
