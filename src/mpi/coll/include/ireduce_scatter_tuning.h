...
extern int MPIR_Ireduce_scatter_intra_sched_recursive_halving(
                    ...
                    MPIR_Sched_t s);
extern int MPIR_Ireduce_scatter_intra_sched_pairwise(const void *sendbuf, void *recvbuf,
					     const int *recvcount, MPI_Datatype datatype, MPI_Op op, 
					     MPIR_Comm *comm_ptr, MPIR_Sched_t s);
extern int MPIR_Ireduce_scatter_intra_sched_recursive_doubling(const void *sendbuf,
