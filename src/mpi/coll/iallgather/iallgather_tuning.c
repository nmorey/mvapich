...
int MV2_set_iallgather_tuning_table(int heterogeneity)
{
    ...
    mv2_iallgather_thresholds_table = MPL_malloc(mv2_size_iallgather_tuning_table *
                          sizeof (mv2_iallgather_tuning_table), MPL_MEM_COLL);
    mv2_iallgather_tuning_table mv2_tmp_iallgather_thresholds_table[] = {
        {8,
         8192,
         {0},
         1, {{0, -1, &MPIR_Iallgather_intra_sched_ring, -1}},
         1, {{0, -1, NULL, -1}}
        },
        {16,
         8192,
      ...
      MPIR_Memcpy(mv2_iallgather_thresholds_table, mv2_tmp_iallgather_thresholds_table,
    ...
    mv2_iallgather_tuning_table mv2_tmp_iallgather_thresholds_table[] = {
        {8,
         8192,
         {0},
         1, {{0, -1, &MPIR_Iallgather_intra_sched_brucks, -1}},
         1, {{0, -1, NULL, -1}}
        },
        {16,
         8192,
    ...
    mv2_iallgather_tuning_table mv2_tmp_iallgather_thresholds_table[] = {
        ...
        {256,
         8192,
         {0},
         1, {{0, -1, &MPIR_Iallgather_intra_sched_recursive_doubling, -1}},
         1, {{0, -1, NULL, -1}}
        },
        {512,
         8192,
...
void MV2_cleanup_iallgather_tuning_table()
{
    if (mv2_iallgather_thresholds_table != NULL) {
        MPL_free(mv2_iallgather_thresholds_table);
    }
...
int MV2_internode_Iallgather_is_define(char *mv2_user_iallgather_inter, char *mv2_user_iallgather_intra)
{
    ...
    if (nb_element == 1) {
        ...
        if (!(dup = MPL_strdup(mv2_user_iallgather_inter))) {
    ...
    MPIR_Memcpy(mv2_iallgather_thresholds_table, mv2_tmp_iallgather_thresholds_table, sizeof
