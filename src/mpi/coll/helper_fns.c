...
int MPIC_Ssend(const void *buf, MPI_Aint count, 
...
int MPIC_Sendrecv(const void *sendbuf, MPI_Aint sendcount, 
...
int MPIC_Isend(const void *buf, MPI_Aint count, 
                    MPI_Datatype datatype, int dest, int tag,
...
int MPIC_Issend(const void *buf, MPI_Aint count, 
                    MPI_Datatype datatype, int dest, int tag,
                    MPIR_Comm *comm_ptr, MPIR_Request **request_ptr, 
                    MPIR_Errflag_t *errflag)
{
...
int MPIC_Irecv(void *buf, MPI_Aint count, 
...
int MPIC_Waitall(int numreq, MPIR_Request *requests[], 
                  MPI_Status statuses[], MPIR_Errflag_t *errflag)
{
    int mpi_errno = MPI_SUCCESS;
    int i;
