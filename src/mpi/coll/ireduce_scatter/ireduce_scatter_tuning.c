...
int MV2_set_ireduce_scatter_tuning_table(int heterogeneity)
{
	...
	mv2_ireduce_scatter_thresholds_table = MPL_malloc(mv2_size_ireduce_scatter_tuning_table *
						  sizeof (mv2_ireduce_scatter_tuning_table), MPL_MEM_COLL);
	mv2_ireduce_scatter_tuning_table mv2_tmp_ireduce_scatter_thresholds_table[] = {
	    {8,
	     8192, 4, 4,
	     {0},
	     1, {{0, -1, &MPIR_Ireduce_scatter_intra_sched_pairwise, -1}},
	     1, {{0, -1, NULL, -1}}
	    },
	    {16,
	     8192, 4, 4,
      ...
      MPIR_Memcpy(mv2_ireduce_scatter_thresholds_table, mv2_tmp_ireduce_scatter_thresholds_table,
...
void MV2_cleanup_ireduce_scatter_tuning_table()
{
	...
	MPL_free(mv2_ireduce_scatter_thresholds_table);
    }
...
int MV2_internode_Ireduce_scatter_is_define(char *mv2_user_ireduce_scatter_inter, char *mv2_user_ireduce_scatter_intra)
{
	...
	if (!(dup = MPL_strdup(mv2_user_ireduce_scatter_inter))) {
    ...
    MPIR_Memcpy(mv2_ireduce_scatter_thresholds_table, mv2_tmp_ireduce_scatter_thresholds_table, sizeof
