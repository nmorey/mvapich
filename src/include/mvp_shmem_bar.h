...
#if defined(MAC_OSX) || defined(__powerpc__) || defined(__ppc__) ||            \
...
#else /* defined(MAC_OSX) || defined(__powerpc__) || defined(__ppc__) ||       \
         defined(__PPC__) || defined(__powerpc64__) || defined(__ppc64__) ||   \
         defined (__PPC64__) */
#define WRITEBAR()
#define READBAR()
#endif /* defined(MAC_OSX) || defined(__powerpc__) || defined(__ppc__) ||      \
          defined(__PPC__) || defined(__powerpc64__) || defined(__ppc64__) ||  \
          defined (__PPC64__) */
