 ...
 * (definitions in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/util/cvar/mpich_cvars.c) */

/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/debugger/dbginit.c */
extern int MPIR_CVAR_PROCTABLE_SIZE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/debugger/dbginit.c */
extern int MPIR_CVAR_PROCTABLE_PRINT;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/comm/comm_split.c */
extern int MPIR_CVAR_COMM_SPLIT_USE_QSORT;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/comm/contextid.c */
extern int MPIR_CVAR_CTXID_EAGER_SIZE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/errhan/errutil.c */
extern int MPIR_CVAR_PRINT_ERROR_STACK;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/errhan/errutil.c */
extern int MPIR_CVAR_CHOP_ERROR_STACK;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/barrier.c */
extern int MPIR_CVAR_ENABLE_SMP_BARRIER;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/allgather.c */
extern int MPIR_CVAR_ALLGATHER_SHORT_MSG_SIZE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/allgather.c */
extern int MPIR_CVAR_ALLGATHER_LONG_MSG_SIZE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/red_scat.c */
extern int MPIR_CVAR_REDSCAT_COMMUTATIVE_LONG_MSG_SIZE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/ch3_shmem_coll.c */
...
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/reduce.c */
...
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/gatherv.c */
extern int MPIR_CVAR_GATHERV_INTER_SSEND_MIN_PROCS;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/bcast.c */
...
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/scatter.c */
extern int MPIR_CVAR_SCATTER_INTER_SHORT_MSG_SIZE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/alltoall.c */
...
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/allgatherv.c */
extern int MPIR_CVAR_ALLGATHERV_PIPELINE_MSG_SIZE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/allreduce.c */
...
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/gather.c */
extern int MPIR_CVAR_GATHER_VSMALL_MSG_SIZE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/coll/gather.c */
extern int MPIR_CVAR_GATHER_INTER_SHORT_MSG_SIZE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/init/init.c */
extern int MPIR_CVAR_ASYNC_PROGRESS;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/init/init.c */
extern char * MPIR_CVAR_DEFAULT_THREAD_LEVEL;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/init/abort.c */
extern int MPIR_CVAR_SUPPRESS_ABORT_MESSAGE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/init/initthread.c */
extern int MPIR_CVAR_DEBUG_HOLD;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/init/initthread.c */
extern int MPIR_CVAR_ERROR_CHECKING;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpi/init/finalize.c */
extern int MPIR_CVAR_MEMDUMP;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/nameserv/file/file_nameserv.c */
extern char * MPIR_CVAR_NAMESERV_FILE_PUBDIR;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/util/mem/handlemem.c */
extern int MPIR_CVAR_ABORT_ON_LEAKED_HANDLES;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/include/mpierrs.h */
extern int MPIR_CVAR_COLL_ALIAS_CHECK;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/common/src/detect/arch/mv2_arch_detect.c */
extern int MPIR_CVAR_FORCE_ARCH_TYPE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/common/src/detect/hca/mv2_hca_detect.c */
extern int MPIR_CVAR_FORCE_HCA_TYPE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/nemesis/src/mpid_nem_init.c */
extern int MPIR_CVAR_NEMESIS_SHM_EAGER_MAX_SZ;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/nemesis/src/mpid_nem_init.c */
extern int MPIR_CVAR_NEMESIS_SHM_READY_EAGER_MAX_SZ;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/nemesis/src/mpid_nem_lmt_dma.c */
extern int MPIR_CVAR_NEMESIS_LMT_DMA_THRESHOLD;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/nemesis/src/mpid_nem_ckpt.c */
extern int MPIR_CVAR_NEMESIS_ENABLE_CKPOINT;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/nemesis/src/mpid_nem_lmt.c */
extern int MPIR_CVAR_ENABLE_FT;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/nemesis/src/mpid_nem_network.c */
extern char * MPIR_CVAR_NEMESIS_NETMOD;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/nemesis/include/mpid_nem_inline.h */
extern int MPIR_CVAR_POLLS_BEFORE_YIELD;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/nemesis/netmod/mxm/mxm_init.c */
...
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/nemesis/netmod/tcp/tcp_init.c */
...
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/nemesis/netmod/ofi/ofi_init.c */
extern char * MPIR_CVAR_OFI_USE_PROVIDER;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/nemesis/netmod/ofi/ofi_init.c */
extern int MPIR_CVAR_OFI_DUMP_PROVIDERS;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/channels/mrail/src/gen2/mv2_mpit_cvars.c */
...
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/src/ch3u_rma_sync.c */
extern int MPIR_CVAR_CH3_RMA_SCALABLE_FENCE_PROCESS_NUM;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/src/ch3u_rma_sync.c */
extern int MPIR_CVAR_CH3_RMA_DELAY_ISSUING_FOR_PIGGYBACKING;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/src/ch3u_comm.c */
extern int MPIR_CVAR_CH3_ENABLE_HCOLL;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/src/ch3u_rma_progress.c */
extern int MPIR_CVAR_CH3_RMA_ACTIVE_REQ_THRESHOLD;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/src/ch3u_rma_progress.c */
extern int MPIR_CVAR_CH3_RMA_POKE_PROGRESS_REQ_THRESHOLD;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/src/mpidi_rma.c */
...
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/src/ch3u_rma_ops.c */
extern int MPIR_CVAR_CH3_RMA_OP_PIGGYBACK_LOCK_DATA_SIZE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/src/mpid_vc.c */
extern int MPIR_CVAR_CH3_NOLOCAL;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/src/mpid_vc.c */
extern int MPIR_CVAR_CH3_ODD_EVEN_CLIQUES;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/src/mpid_vc.c */
extern int MPIR_CVAR_CH3_EAGER_MAX_MSG_SIZE;
/* declared in /tmp/HrRIGLnx4R/mvapich2-2.3.6/maint/../src/mpid/ch3/src/mpid_rma.c */
