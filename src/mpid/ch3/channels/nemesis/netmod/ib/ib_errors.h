...
#define NEM_IB_ERR(message, args...)                                           \
    {                                                                          \
        MVP_MPIDI_Internal_error_printf("[%s:%d] [%s:%d] ", me.hostname,       \
                                        me.rank, __FILE__, __LINE__);          \
        MVP_MPIDI_Internal_error_printf(message, ##args);                      \
        MVP_MPIDI_Internal_error_printf("\n");                                 \
    }

#ifdef DEBUG_NEM_IB
#define NEM_IB_DBG(message, args...)                                           \
    {                                                                          \
        MPL_msg_printf("[%s:%d] [%s:%d] ", me.hostname, me.rank, __FILE__,     \
                       __LINE__);                                              \
...
#define ibv_error_abort(code, message)                                         \
    ib_internal_error_abort(__LINE__, __FILE__, code, message)
