                                  ...
                                  int *val_max_sz_p)
{
    ...
    mpi_errno =
        MPL_str_add_int_arg(bc_val_p, val_max_sz_p, MPID_NEM_IB_UD_QPN_KEY,
    ...
    mpi_errno = MPL_str_add_int_arg(bc_val_p, val_max_sz_p, MPID_NEM_IB_LID_KEY,
    ...
    mpi_errno = MPL_str_add_binary_arg(
        bc_val_p, val_max_sz_p, MPID_NEM_IB_GUID_KEY,
        (char *)&MPID_nem_ib_cm_ctxt_ptr->guid, sizeof(uint64_t));
