...
#define MPIDI_CH3I_MRAILI_RNDV_INFO_DECL MPIDI_CH3I_MRAILI_Rndv_info_t rndv;

struct dreg_entry;
#ifdef _ENABLE_UD_
#define MPIDI_CH3I_MRAILI_ZCOPY_REQ_DECL                                       \
    mvp_rndv_qp_t *rndv_qp_entry;                                              \
...
#define MPIDI_CH3I_MRAILI_DEVICE_IPC_REQ_DECL                                  \
    ...
    uint64_t ipc_size;                                                         \
    uint64_t ipc_displ;                                                        \
    mvp_device_event_t *ipc_device_event;                                      \
...
#define MPIDI_CH3I_MRAILI_DEVICE_REQ_DECL                                      \
    mvp_device_transfer_mode_t device_transfer_mode;                           \
...
#define MPIDI_CH3I_MRAILI_UD_VC  mvp_ud_vc_info_t
#define MPIDI_CH3I_MRAILI_UD_REL mvp_ud_reliability_info_t
...
typedef struct MPIDI_CH3I_MRAIL_VC_t {
    ...
    int react_send_ready; // At resume: can we enqueu the REACT_DONE msg for
                          // send?
...
#ifdef _ENABLE_UD_
    mvp_ud_exch_info_t **remote_ud_info;
    struct ibv_ah **ud_ah;
    uint16_t *ud_lid;
...
#ifdef _ENABLE_CUDA_
typedef enum mvp_device_transfer_mode {
    NONE = 0, /* default: HOST_TO_HOST */
    DEVICE_TO_DEVICE,
    HOST_TO_DEVICE,
    DEVICE_TO_HOST
} mvp_device_transfer_mode_t;
