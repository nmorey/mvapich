...
#ifndef MVAPICH_GEN2_CM_H
#define MVAPICH_GEN2_CM_H
...
#define MVP_QP_NEW   0
#define MVP_QP_REUSE 1

#define MVP_QPT_RC  1
#define MVP_QPT_XRC 2

extern pthread_t cm_finalize_progress_thread;
extern int mvp_finalize_upmi_barrier_complete;
extern int mvp_pmi_max_keylen;
extern int mvp_pmi_max_vallen;
extern char *mvp_pmi_key;
extern char *mvp_pmi_val;
extern char *mvp_pmi_iallgather_buf;
