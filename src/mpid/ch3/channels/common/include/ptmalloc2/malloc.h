...
extern __malloc_ptr_t calloc __MALLOC_P((size_t __nmemb,
...
extern __malloc_ptr_t pvalloc __MALLOC_P((size_t __size)) __attribute_malloc__;
...
extern __malloc_ptr_t(*__realloc_hook)
    __MALLOC_PMT((__malloc_ptr_t __ptr, size_t __size, __const __malloc_ptr_t));
extern __malloc_ptr_t(*__memalign_hook)
...
extern __malloc_ptr_t _int_realloc __MALLOC_P((mstate __m, __malloc_ptr_t __ptr,
                                               size_t __size));
