...
cvars:
    ...
    - name        : MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL
      category    : CH4
      type        : enum
      default     : rget
      class       : none
    ...
    - name        : MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD
      category    : CH4
      type        : int
      default     : 16384
      class       : none
      ...
      description : >-
        ...
        COOP rndv protocol for intra-node communication. Messages below this 
        threshold will use either RPUT or RGET protocol as set by 
                                                    ...
                                                    MPIDI_IPCI_ipc_attr_t * ipc_attr)
{
    ...
    if (MPIR_CVAR_CH4_CMA_ENABLE) {
        ...
        if (data_sz * count < MPIR_CVAR_CH4_IPC_CMA_P2P_THRESHOLD) {
            goto fn_exit;
...
int MPIDI_CMA_copy_data_coop(MPIDI_IPC_hdr *ipc_hdr, MPIR_Request *sreq,
