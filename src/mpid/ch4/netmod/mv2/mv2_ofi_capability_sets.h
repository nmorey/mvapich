...
#define MPIDI_OFI_SOURCE_MASK_OPX               (0x0000000000000000ULL)     /* We require support for immediate data
...
#define MPIDI_OFI_ENABLE_SCALABLE_ENDPOINTS MPIDI_OFI_ENABLE_SCALABLE_ENDPOINTS_OPX
...
#define MPIDI_OFI_ENABLE_DATA_AUTO_PROGRESS MPIDI_OFI_ENABLE_DATA_AUTO_PROGRESS_OPX
#define MPIDI_OFI_ENABLE_CONTROL_AUTO_PROGRESS  MPIDI_OFI_ENABLE_CONTROL_AUTO_PROGRESS_OPX
...
#define MPIDI_OFI_SOURCE_MASK               (0x0000000000000000ULL)     /* OPX does support immediate data
                                                                         * so this field is zeroed */
