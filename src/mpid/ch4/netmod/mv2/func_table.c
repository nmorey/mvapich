...
/* 
 * Overrides the default function tables with some of our own functions. This is
 * not the most ideal way of doing this, as it requires a lot of repeat code for
 * the two netmods, but it does let us keep their function tables intact and
 * only replay the code we need to override
 */
...
/* OFI netmod functions */
MPIDI_NM_funcs_t MPIDI_NM_mv2_funcs = {
    .mpi_init = MPIDI_OFI_mpi_init_hook,
    .mpi_finalize = MPIDI_OFI_mpi_finalize_hook,
    .post_init = MPIDI_MV2_post_init,
    ...
    .mpi_comm_commit_post_hook = MPIDI_MV2_mpi_comm_commit_post_hook,
...
#endif /* HAVE_CH4_NETMOD_OFI */

#ifdef HAVE_CH4_NETMOD_UCX
/* UCX netmod functions */
MPIDI_NM_funcs_t MPIDI_NM_mv2_funcs = {
    .mpi_init = MPIDI_MV2_mpi_init_hook,
...
#endif /* HAVE_CH4_NETMOD_UCX */

#ifdef HAVE_CH4_NETMOD_OFI
/* OFI version of native functions */
MPIDI_NM_native_funcs_t MPIDI_NM_mv2_native_funcs = {
