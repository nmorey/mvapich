/* 
 * Comm overrides for the CH4 device in MV2. Has to be included separetely from
 ...
 */
#ifndef MV2_COMM_OVERRIDE_H
#define MV2_COMM_OVERRIDE_H
...
#define MPIDI_MV2_LEGACY_COMM_DECL MPIDI_MV2_comm_t ch;


#endif /* MV2_COMM_OVERRIDE_H */
