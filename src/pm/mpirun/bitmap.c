...
/*
Find first bit "1" in the bitmap, toggle it to "0", and return its position in
the map. LSB's pos=0, with MSB's pos = size-1 Return -1 if no bit "1" exists
*/
...
/*
Find first bit "0" in the bitmap, toggle it to "1", and return its position in
the map. LSB's pos=0, with MSB's pos = size-1 Return -1 if no bit "1" exists
*/
