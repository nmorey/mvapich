...
int MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR;
int MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR;
int MPIR_CVAR_BCAST_SEGMENT_SIZE;
int MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR;
int MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR;
...
int MPIR_CVAR_MALLOC_ENABLE_MMAP;
int MPIR_CVAR_MALLOC_HEAP_STEP;
...
int MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL;
int MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD;
...
int MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS;
int MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE;
...
const char * MPIR_CVAR_PT2PT_JSON_TUNING_FILE;
...
int MPIR_T_cvar_init(void)
{
    ...
    MPIR_T_cat_add_desc("MVAPICH",
        "CVARs that are added by MVAPICH specific functionality");
...
"osu_pairwise  - Force OSU mcast based design");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BARRIER_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_BARRIER_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BARRIER_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (tmp_str != NULL) {
        ...
        else if (0 == strcmp(tmp_str, "osu_pairwise"))
            MPIR_CVAR_BARRIER_INTRA_ALGORITHM = MPIR_CVAR_BARRIER_INTRA_ALGORITHM_osu_pairwise;
        else {
...
"nb    - Force nonblocking algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BARRIER_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_BARRIER_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BARRIER_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_DISSEM_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BARRIER_DISSEM_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_BARRIER_DISSEM_KVAL", &(MPIR_CVAR_BARRIER_DISSEM_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_DISSEM_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BARRIER_DISSEM_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BARRIER_RECEXCH_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_BARRIER_RECEXCH_KVAL", &(MPIR_CVAR_BARRIER_RECEXCH_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BARRIER_RECEXCH_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_RECEXCH_SINGLE_PHASE_RECV);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BARRIER_RECEXCH_SINGLE_PHASE_RECV");
    got_rc += rc;
    rc = MPL_env2bool("MVP_BARRIER_RECEXCH_SINGLE_PHASE_RECV", &(MPIR_CVAR_BARRIER_RECEXCH_SINGLE_PHASE_RECV));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_RECEXCH_SINGLE_PHASE_RECV);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BARRIER_RECEXCH_SINGLE_PHASE_RECV");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBARRIER_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBARRIER_RECEXCH_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IBARRIER_RECEXCH_KVAL", &(MPIR_CVAR_IBARRIER_RECEXCH_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBARRIER_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBARRIER_RECEXCH_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBARRIER_DISSEM_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBARRIER_DISSEM_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IBARRIER_DISSEM_KVAL", &(MPIR_CVAR_IBARRIER_DISSEM_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBARRIER_DISSEM_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBARRIER_DISSEM_KVAL");
    got_rc += rc;
...
"tsp_k_dissemination - Force generic transport based high-radix dissemination algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBARRIER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBARRIER_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IBARRIER_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBARRIER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBARRIER_INTRA_ALGORITHM");
    got_rc += rc;
...
"sched_bcast - Force bcast algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBARRIER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBARRIER_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IBARRIER_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBARRIER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBARRIER_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_MIN_PROCS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_MIN_PROCS");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_MIN_PROCS", &(MPIR_CVAR_BCAST_MIN_PROCS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_MIN_PROCS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_MIN_PROCS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_SHORT_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_SHORT_MSG_SIZE", &(MPIR_CVAR_BCAST_SHORT_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_SHORT_MSG_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_LONG_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_LONG_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_LONG_MSG_SIZE", &(MPIR_CVAR_BCAST_LONG_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_LONG_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_LONG_MSG_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MAX_SMP_BCAST_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_MAX_SMP_BCAST_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_MAX_SMP_BCAST_MSG_SIZE", &(MPIR_CVAR_MAX_SMP_BCAST_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MAX_SMP_BCAST_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_MAX_SMP_BCAST_MSG_SIZE");
    got_rc += rc;
...
"osu_pipelined                           - Force OSU pipelined algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_BCAST_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (tmp_str != NULL) {
        ...
        else if (0 == strcmp(tmp_str, "osu_knomial"))
            MPIR_CVAR_BCAST_INTRA_ALGORITHM = MPIR_CVAR_BCAST_INTRA_ALGORITHM_osu_knomial;
        else if (0 == strcmp(tmp_str, "osu_pairwise"))
            MPIR_CVAR_BCAST_INTRA_ALGORITHM = MPIR_CVAR_BCAST_INTRA_ALGORITHM_osu_pairwise;
        else if (0 == strcmp(tmp_str, "osu_pipelined"))
            MPIR_CVAR_BCAST_INTRA_ALGORITHM = MPIR_CVAR_BCAST_INTRA_ALGORITHM_osu_pipelined;
        else {
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_TREE_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_TREE_KVAL", &(MPIR_CVAR_BCAST_TREE_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_TREE_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_TREE_TYPE");
    got_rc += rc;
    rc = MPL_env2str("MVP_BCAST_TREE_TYPE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_TREE_TYPE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TOPO_REORDER_ENABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_TOPO_REORDER_ENABLE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_BCAST_TOPO_REORDER_ENABLE", &(MPIR_CVAR_BCAST_TOPO_REORDER_ENABLE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TOPO_REORDER_ENABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_TOPO_REORDER_ENABLE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TOPO_OVERHEAD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_TOPO_OVERHEAD");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_TOPO_OVERHEAD", &(MPIR_CVAR_BCAST_TOPO_OVERHEAD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TOPO_OVERHEAD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_TOPO_OVERHEAD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TOPO_DIFF_GROUPS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_TOPO_DIFF_GROUPS");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_TOPO_DIFF_GROUPS", &(MPIR_CVAR_BCAST_TOPO_DIFF_GROUPS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TOPO_DIFF_GROUPS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_TOPO_DIFF_GROUPS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TOPO_DIFF_SWITCHES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_TOPO_DIFF_SWITCHES");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_TOPO_DIFF_SWITCHES", &(MPIR_CVAR_BCAST_TOPO_DIFF_SWITCHES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TOPO_DIFF_SWITCHES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_TOPO_DIFF_SWITCHES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TOPO_SAME_SWITCHES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_TOPO_SAME_SWITCHES");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_TOPO_SAME_SWITCHES", &(MPIR_CVAR_BCAST_TOPO_SAME_SWITCHES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TOPO_SAME_SWITCHES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_TOPO_SAME_SWITCHES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_IS_NON_BLOCKING);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_IS_NON_BLOCKING");
    got_rc += rc;
    rc = MPL_env2bool("MVP_BCAST_IS_NON_BLOCKING", &(MPIR_CVAR_BCAST_IS_NON_BLOCKING));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_IS_NON_BLOCKING);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_IS_NON_BLOCKING");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TREE_PIPELINE_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_TREE_PIPELINE_CHUNK_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_TREE_PIPELINE_CHUNK_SIZE", &(MPIR_CVAR_BCAST_TREE_PIPELINE_CHUNK_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_TREE_PIPELINE_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_TREE_PIPELINE_CHUNK_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_RECV_PRE_POST);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_RECV_PRE_POST");
    got_rc += rc;
    rc = MPL_env2bool("MVP_BCAST_RECV_PRE_POST", &(MPIR_CVAR_BCAST_RECV_PRE_POST));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_RECV_PRE_POST);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_RECV_PRE_POST");
    got_rc += rc;
...
"remote_send_local_bcast - Force remote-send-local-bcast algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_BCAST_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBCAST_TREE_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IBCAST_TREE_KVAL", &(MPIR_CVAR_IBCAST_TREE_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBCAST_TREE_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBCAST_TREE_TYPE");
    got_rc += rc;
    rc = MPL_env2str("MVP_IBCAST_TREE_TYPE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBCAST_TREE_TYPE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_TREE_PIPELINE_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBCAST_TREE_PIPELINE_CHUNK_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_IBCAST_TREE_PIPELINE_CHUNK_SIZE", &(MPIR_CVAR_IBCAST_TREE_PIPELINE_CHUNK_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_TREE_PIPELINE_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBCAST_TREE_PIPELINE_CHUNK_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_RING_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBCAST_RING_CHUNK_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_IBCAST_RING_CHUNK_SIZE", &(MPIR_CVAR_IBCAST_RING_CHUNK_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_RING_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBCAST_RING_CHUNK_SIZE");
    got_rc += rc;
...
"tsp_ring                               - Force Generic Transport Ring algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBCAST_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IBCAST_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBCAST_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_SCATTERV_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBCAST_SCATTERV_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IBCAST_SCATTERV_KVAL", &(MPIR_CVAR_IBCAST_SCATTERV_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_SCATTERV_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBCAST_SCATTERV_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_ALLGATHERV_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBCAST_ALLGATHERV_RECEXCH_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IBCAST_ALLGATHERV_RECEXCH_KVAL", &(MPIR_CVAR_IBCAST_ALLGATHERV_RECEXCH_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_ALLGATHERV_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBCAST_ALLGATHERV_RECEXCH_KVAL");
    got_rc += rc;
...
"sched_flat - Force flat algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBCAST_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IBCAST_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBCAST_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHER_INTER_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GATHER_INTER_SHORT_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_GATHER_INTER_SHORT_MSG_SIZE", &(MPIR_CVAR_GATHER_INTER_SHORT_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHER_INTER_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GATHER_INTER_SHORT_MSG_SIZE");
    got_rc += rc;
...
"osu_direct_block - Force OSU direct block algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GATHER_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_GATHER_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GATHER_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (tmp_str != NULL) {
        ...
        else if (0 == strcmp(tmp_str, "osu_direct"))
            MPIR_CVAR_GATHER_INTRA_ALGORITHM = MPIR_CVAR_GATHER_INTRA_ALGORITHM_osu_direct;
        else if (0 == strcmp(tmp_str, "osu_direct_block"))
            MPIR_CVAR_GATHER_INTRA_ALGORITHM = MPIR_CVAR_GATHER_INTRA_ALGORITHM_osu_direct_block;
        else {
...
"nb                       - Force nonblocking algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GATHER_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_GATHER_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GATHER_INTER_ALGORITHM");
    got_rc += rc;
...
"tsp_tree       - Force genetric transport based tree algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IGATHER_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IGATHER_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IGATHER_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHER_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IGATHER_TREE_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IGATHER_TREE_KVAL", &(MPIR_CVAR_IGATHER_TREE_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHER_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IGATHER_TREE_KVAL");
    got_rc += rc;
...
"sched_short - Force short inter algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IGATHER_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IGATHER_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IGATHER_INTER_ALGORITHM");
    got_rc += rc;
...
"nb     - Force nonblocking algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GATHERV_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_GATHERV_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GATHERV_INTRA_ALGORITHM");
    got_rc += rc;
...
"nb     - Force nonblocking algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GATHERV_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_GATHERV_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GATHERV_INTER_ALGORITHM");
    got_rc += rc;
...
"tsp_linear       - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IGATHERV_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IGATHERV_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IGATHERV_INTRA_ALGORITHM");
    got_rc += rc;
...
"tsp_linear - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IGATHERV_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IGATHERV_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IGATHERV_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTER_INTER_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SCATTER_INTER_SHORT_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_SCATTER_INTER_SHORT_MSG_SIZE", &(MPIR_CVAR_SCATTER_INTER_SHORT_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTER_INTER_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SCATTER_INTER_SHORT_MSG_SIZE");
    got_rc += rc;
...
"osu_direct - Force OSU direct alogirthm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SCATTER_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_SCATTER_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SCATTER_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (tmp_str != NULL) {
        if (0 == strcmp(tmp_str, "auto"))
            ...
            MPIR_CVAR_SCATTER_INTRA_ALGORITHM = MPIR_CVAR_SCATTER_INTRA_ALGORITHM_osu_direct;
        else {
...
"remote_send_local_scatter - Force remote-send-local-scatter algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SCATTER_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_SCATTER_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SCATTER_INTER_ALGORITHM");
    got_rc += rc;
...
"tsp_tree       - Force genetric transport based tree algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ISCATTER_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ISCATTER_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ISCATTER_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTER_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ISCATTER_TREE_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_ISCATTER_TREE_KVAL", &(MPIR_CVAR_ISCATTER_TREE_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTER_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ISCATTER_TREE_KVAL");
    got_rc += rc;
...
"sched_remote_send_local_scatter - Force remote-send-local-scatter algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ISCATTER_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ISCATTER_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ISCATTER_INTER_ALGORITHM");
    got_rc += rc;
...
"nb     - Force nonblocking algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SCATTERV_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_SCATTERV_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SCATTERV_INTRA_ALGORITHM");
    got_rc += rc;
...
"nb     - Force nonblocking algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SCATTERV_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_SCATTERV_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SCATTERV_INTER_ALGORITHM");
    got_rc += rc;
...
"tsp_linear  - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ISCATTERV_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ISCATTERV_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ISCATTERV_INTRA_ALGORITHM");
    got_rc += rc;
...
"tsp_linear - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ISCATTERV_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ISCATTERV_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ISCATTERV_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_SHORT_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLGATHER_SHORT_MSG_SIZE", &(MPIR_CVAR_ALLGATHER_SHORT_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_SHORT_MSG_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_LONG_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_LONG_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLGATHER_LONG_MSG_SIZE", &(MPIR_CVAR_ALLGATHER_LONG_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_LONG_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_LONG_MSG_SIZE");
    got_rc += rc;
...
"osu_gather_bcast   - Force MVAPICH gather-bcast algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLGATHER_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (tmp_str != NULL) {
        if (0 == strcmp(tmp_str, "auto"))
            ...
            MPIR_CVAR_ALLGATHER_INTRA_ALGORITHM = MPIR_CVAR_ALLGATHER_INTRA_ALGORITHM_osu_direct;
        else if (0 == strcmp(tmp_str, "osu_direct_spread"))
            MPIR_CVAR_ALLGATHER_INTRA_ALGORITHM = MPIR_CVAR_ALLGATHER_INTRA_ALGORITHM_osu_direct_spread;
        else if (0 == strcmp(tmp_str, "osu_gather_bcast"))
            MPIR_CVAR_ALLGATHER_INTRA_ALGORITHM = MPIR_CVAR_ALLGATHER_INTRA_ALGORITHM_osu_gather_bcast;
        else {
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_BRUCKS_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_BRUCKS_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLGATHER_BRUCKS_KVAL", &(MPIR_CVAR_ALLGATHER_BRUCKS_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_BRUCKS_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_BRUCKS_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_RECEXCH_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLGATHER_RECEXCH_KVAL", &(MPIR_CVAR_ALLGATHER_RECEXCH_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_RECEXCH_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_RECEXCH_SINGLE_PHASE_RECV);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_RECEXCH_SINGLE_PHASE_RECV");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLGATHER_RECEXCH_SINGLE_PHASE_RECV", &(MPIR_CVAR_ALLGATHER_RECEXCH_SINGLE_PHASE_RECV));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_RECEXCH_SINGLE_PHASE_RECV);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_RECEXCH_SINGLE_PHASE_RECV");
    got_rc += rc;
...
"nb                        - Force nonblocking algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLGATHER_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHER_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLGATHER_RECEXCH_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IALLGATHER_RECEXCH_KVAL", &(MPIR_CVAR_IALLGATHER_RECEXCH_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHER_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLGATHER_RECEXCH_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHER_BRUCKS_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLGATHER_BRUCKS_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IALLGATHER_BRUCKS_KVAL", &(MPIR_CVAR_IALLGATHER_BRUCKS_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHER_BRUCKS_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLGATHER_BRUCKS_KVAL");
    got_rc += rc;
...
"tsp_recexch_halving  - Force generic transport recursive exchange with neighbours halving in distance in each phase");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLGATHER_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLGATHER_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLGATHER_INTRA_ALGORITHM");
    got_rc += rc;
...
"sched_local_gather_remote_bcast - Force local-gather-remote-bcast algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLGATHER_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLGATHER_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLGATHER_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_PIPELINE_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHERV_PIPELINE_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLGATHERV_PIPELINE_MSG_SIZE", &(MPIR_CVAR_ALLGATHERV_PIPELINE_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_PIPELINE_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHERV_PIPELINE_MSG_SIZE");
    got_rc += rc;
...
"ring               - Force ring algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHERV_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLGATHERV_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHERV_INTRA_ALGORITHM");
    got_rc += rc;
...
"remote_gather_local_bcast - Force remote-gather-local-bcast algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHERV_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLGATHERV_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHERV_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHERV_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLGATHERV_RECEXCH_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IALLGATHERV_RECEXCH_KVAL", &(MPIR_CVAR_IALLGATHERV_RECEXCH_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHERV_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLGATHERV_RECEXCH_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHERV_BRUCKS_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLGATHERV_BRUCKS_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IALLGATHERV_BRUCKS_KVAL", &(MPIR_CVAR_IALLGATHERV_BRUCKS_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHERV_BRUCKS_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLGATHERV_BRUCKS_KVAL");
    got_rc += rc;
...
"tsp_brucks           - Force generic transport based brucks algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLGATHERV_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLGATHERV_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLGATHERV_INTRA_ALGORITHM");
    got_rc += rc;
...
"sched_remote_gather_local_bcast - Force remote-gather-local-bcast algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLGATHERV_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLGATHERV_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLGATHERV_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALL_SHORT_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLTOALL_SHORT_MSG_SIZE", &(MPIR_CVAR_ALLTOALL_SHORT_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALL_SHORT_MSG_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_MEDIUM_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALL_MEDIUM_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLTOALL_MEDIUM_MSG_SIZE", &(MPIR_CVAR_ALLTOALL_MEDIUM_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_MEDIUM_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALL_MEDIUM_MSG_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_THROTTLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALL_THROTTLE");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLTOALL_THROTTLE", &(MPIR_CVAR_ALLTOALL_THROTTLE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_THROTTLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALL_THROTTLE");
    got_rc += rc;
...
"scattered                 - Force scattered algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALL_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLTOALL_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALL_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_BRUCKS_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALL_BRUCKS_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLTOALL_BRUCKS_KVAL", &(MPIR_CVAR_ALLTOALL_BRUCKS_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_BRUCKS_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALL_BRUCKS_KVAL");
    got_rc += rc;
...
"pairwise_exchange - Force pairwise exchange algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALL_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLTOALL_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALL_INTER_ALGORITHM");
    got_rc += rc;
...
"tsp_scattered       - Force generic transport based scattered algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALL_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLTOALL_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALL_INTRA_ALGORITHM");
    got_rc += rc;
...
"sched_pairwise_exchange - Force pairwise exchange algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALL_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLTOALL_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALL_INTER_ALGORITHM");
    got_rc += rc;
...
"scattered                 - Force scattered algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALLV_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLTOALLV_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALLV_INTRA_ALGORITHM");
    got_rc += rc;
...
"nb                - Force nonblocking algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALLV_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLTOALLV_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALLV_INTER_ALGORITHM");
    got_rc += rc;
...
"tsp_inplace         - Force generic transport inplace algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALLV_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLTOALLV_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALLV_INTRA_ALGORITHM");
    got_rc += rc;
...
"sched_pairwise_exchange - Force pairwise exchange algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALLV_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLTOALLV_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALLV_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLV_SCATTERED_OUTSTANDING_TASKS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALLV_SCATTERED_OUTSTANDING_TASKS");
    got_rc += rc;
    rc = MPL_env2int("MVP_IALLTOALLV_SCATTERED_OUTSTANDING_TASKS", &(MPIR_CVAR_IALLTOALLV_SCATTERED_OUTSTANDING_TASKS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLV_SCATTERED_OUTSTANDING_TASKS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALLV_SCATTERED_OUTSTANDING_TASKS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLV_SCATTERED_BATCH_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALLV_SCATTERED_BATCH_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_IALLTOALLV_SCATTERED_BATCH_SIZE", &(MPIR_CVAR_IALLTOALLV_SCATTERED_BATCH_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLV_SCATTERED_BATCH_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALLV_SCATTERED_BATCH_SIZE");
    got_rc += rc;
...
"scattered                 - Force scattered algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLW_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALLW_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLTOALLW_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLW_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALLW_INTRA_ALGORITHM");
    got_rc += rc;
...
"pairwise_exchange - Force pairwise exchange algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLW_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALLW_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLTOALLW_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLW_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALLW_INTER_ALGORITHM");
    got_rc += rc;
...
"tsp_inplace   - Force generic transport based inplace algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLW_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALLW_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLTOALLW_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLW_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALLW_INTRA_ALGORITHM");
    got_rc += rc;
...
"sched_pairwise_exchange - Force pairwise exchange algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLW_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALLW_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLTOALLW_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLW_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALLW_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_SHORT_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_REDUCE_SHORT_MSG_SIZE", &(MPIR_CVAR_REDUCE_SHORT_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_SHORT_MSG_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MAX_SMP_REDUCE_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_MAX_SMP_REDUCE_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_MAX_SMP_REDUCE_MSG_SIZE", &(MPIR_CVAR_MAX_SMP_REDUCE_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MAX_SMP_REDUCE_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_MAX_SMP_REDUCE_MSG_SIZE");
    got_rc += rc;
...
"osu_allreduce         - Force MVAPICH allreduce algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_REDUCE_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (tmp_str != NULL) {
        if (0 == strcmp(tmp_str, "auto"))
            ...
            MPIR_CVAR_REDUCE_INTRA_ALGORITHM = MPIR_CVAR_REDUCE_INTRA_ALGORITHM_osu_knomial;
        else if (0 == strcmp(tmp_str, "osu_allreduce"))
            MPIR_CVAR_REDUCE_INTRA_ALGORITHM = MPIR_CVAR_REDUCE_INTRA_ALGORITHM_osu_allreduce;
        else {
...
"nb                       - Force nonblocking algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_REDUCE_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_TREE_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IREDUCE_TREE_KVAL", &(MPIR_CVAR_IREDUCE_TREE_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_TREE_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_TREE_TYPE");
    got_rc += rc;
    rc = MPL_env2str("MVP_IREDUCE_TREE_TYPE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_TREE_TYPE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TOPO_REORDER_ENABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_TOPO_REORDER_ENABLE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IREDUCE_TOPO_REORDER_ENABLE", &(MPIR_CVAR_IREDUCE_TOPO_REORDER_ENABLE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TOPO_REORDER_ENABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_TOPO_REORDER_ENABLE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TOPO_OVERHEAD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_TOPO_OVERHEAD");
    got_rc += rc;
    rc = MPL_env2int("MVP_IREDUCE_TOPO_OVERHEAD", &(MPIR_CVAR_IREDUCE_TOPO_OVERHEAD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TOPO_OVERHEAD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_TOPO_OVERHEAD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TOPO_DIFF_GROUPS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_TOPO_DIFF_GROUPS");
    got_rc += rc;
    rc = MPL_env2int("MVP_IREDUCE_TOPO_DIFF_GROUPS", &(MPIR_CVAR_IREDUCE_TOPO_DIFF_GROUPS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TOPO_DIFF_GROUPS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_TOPO_DIFF_GROUPS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TOPO_DIFF_SWITCHES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_TOPO_DIFF_SWITCHES");
    got_rc += rc;
    rc = MPL_env2int("MVP_IREDUCE_TOPO_DIFF_SWITCHES", &(MPIR_CVAR_IREDUCE_TOPO_DIFF_SWITCHES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TOPO_DIFF_SWITCHES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_TOPO_DIFF_SWITCHES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TOPO_SAME_SWITCHES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_TOPO_SAME_SWITCHES");
    got_rc += rc;
    rc = MPL_env2int("MVP_IREDUCE_TOPO_SAME_SWITCHES", &(MPIR_CVAR_IREDUCE_TOPO_SAME_SWITCHES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TOPO_SAME_SWITCHES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_TOPO_SAME_SWITCHES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TREE_PIPELINE_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_TREE_PIPELINE_CHUNK_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_IREDUCE_TREE_PIPELINE_CHUNK_SIZE", &(MPIR_CVAR_IREDUCE_TREE_PIPELINE_CHUNK_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TREE_PIPELINE_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_TREE_PIPELINE_CHUNK_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_RING_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_RING_CHUNK_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_IREDUCE_RING_CHUNK_SIZE", &(MPIR_CVAR_IREDUCE_RING_CHUNK_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_RING_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_RING_CHUNK_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TREE_BUFFER_PER_CHILD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_TREE_BUFFER_PER_CHILD");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IREDUCE_TREE_BUFFER_PER_CHILD", &(MPIR_CVAR_IREDUCE_TREE_BUFFER_PER_CHILD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_TREE_BUFFER_PER_CHILD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_TREE_BUFFER_PER_CHILD");
    got_rc += rc;
...
"tsp_ring                - Force Generic Transport Ring");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IREDUCE_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_INTRA_ALGORITHM");
    got_rc += rc;
...
"sched_local_reduce_remote_send - Force local-reduce-remote-send algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IREDUCE_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_SHORT_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_SHORT_MSG_SIZE", &(MPIR_CVAR_ALLREDUCE_SHORT_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_SHORT_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_SHORT_MSG_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MAX_SMP_ALLREDUCE_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_MAX_SMP_ALLREDUCE_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_MAX_SMP_ALLREDUCE_MSG_SIZE", &(MPIR_CVAR_MAX_SMP_ALLREDUCE_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MAX_SMP_ALLREDUCE_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_MAX_SMP_ALLREDUCE_MSG_SIZE");
    got_rc += rc;
...
"osu_sharp                - Force osu sharp design");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLREDUCE_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (tmp_str != NULL) {
        ...
        else if (0 == strcmp(tmp_str, "mvapich_tuned"))
            MPIR_CVAR_ALLREDUCE_INTRA_ALGORITHM = MPIR_CVAR_ALLREDUCE_INTRA_ALGORITHM_mvapich_tuned;
        else if (0 == strcmp(tmp_str, "osu_mcast"))
            MPIR_CVAR_ALLREDUCE_INTRA_ALGORITHM = MPIR_CVAR_ALLREDUCE_INTRA_ALGORITHM_osu_mcast;
        else if (0 == strcmp(tmp_str, "osu_sharp"))
            MPIR_CVAR_ALLREDUCE_INTRA_ALGORITHM = MPIR_CVAR_ALLREDUCE_INTRA_ALGORITHM_osu_sharp;
        else {
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_RECURSIVE_MULTIPLYING_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_RECURSIVE_MULTIPLYING_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_RECURSIVE_MULTIPLYING_KVAL", &(MPIR_CVAR_ALLREDUCE_RECURSIVE_MULTIPLYING_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_RECURSIVE_MULTIPLYING_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_RECURSIVE_MULTIPLYING_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_TREE_TYPE");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLREDUCE_TREE_TYPE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_TREE_TYPE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_TREE_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_TREE_KVAL", &(MPIR_CVAR_ALLREDUCE_TREE_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_TREE_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TOPO_REORDER_ENABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_TOPO_REORDER_ENABLE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLREDUCE_TOPO_REORDER_ENABLE", &(MPIR_CVAR_ALLREDUCE_TOPO_REORDER_ENABLE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TOPO_REORDER_ENABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_TOPO_REORDER_ENABLE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TOPO_OVERHEAD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_TOPO_OVERHEAD");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_TOPO_OVERHEAD", &(MPIR_CVAR_ALLREDUCE_TOPO_OVERHEAD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TOPO_OVERHEAD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_TOPO_OVERHEAD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TOPO_DIFF_GROUPS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_TOPO_DIFF_GROUPS");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_TOPO_DIFF_GROUPS", &(MPIR_CVAR_ALLREDUCE_TOPO_DIFF_GROUPS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TOPO_DIFF_GROUPS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_TOPO_DIFF_GROUPS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TOPO_DIFF_SWITCHES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_TOPO_DIFF_SWITCHES");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_TOPO_DIFF_SWITCHES", &(MPIR_CVAR_ALLREDUCE_TOPO_DIFF_SWITCHES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TOPO_DIFF_SWITCHES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_TOPO_DIFF_SWITCHES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TOPO_SAME_SWITCHES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_TOPO_SAME_SWITCHES");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_TOPO_SAME_SWITCHES", &(MPIR_CVAR_ALLREDUCE_TOPO_SAME_SWITCHES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TOPO_SAME_SWITCHES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_TOPO_SAME_SWITCHES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TREE_PIPELINE_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_TREE_PIPELINE_CHUNK_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_TREE_PIPELINE_CHUNK_SIZE", &(MPIR_CVAR_ALLREDUCE_TREE_PIPELINE_CHUNK_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TREE_PIPELINE_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_TREE_PIPELINE_CHUNK_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TREE_BUFFER_PER_CHILD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_TREE_BUFFER_PER_CHILD");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLREDUCE_TREE_BUFFER_PER_CHILD", &(MPIR_CVAR_ALLREDUCE_TREE_BUFFER_PER_CHILD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_TREE_BUFFER_PER_CHILD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_TREE_BUFFER_PER_CHILD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_RECEXCH_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_RECEXCH_KVAL", &(MPIR_CVAR_ALLREDUCE_RECEXCH_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_RECEXCH_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_RECEXCH_SINGLE_PHASE_RECV);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_RECEXCH_SINGLE_PHASE_RECV");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLREDUCE_RECEXCH_SINGLE_PHASE_RECV", &(MPIR_CVAR_ALLREDUCE_RECEXCH_SINGLE_PHASE_RECV));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_RECEXCH_SINGLE_PHASE_RECV);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_RECEXCH_SINGLE_PHASE_RECV");
    got_rc += rc;
...
"reduce_exchange_bcast - Force reduce-exchange-bcast algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLREDUCE_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLREDUCE_TREE_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IALLREDUCE_TREE_KVAL", &(MPIR_CVAR_IALLREDUCE_TREE_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLREDUCE_TREE_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLREDUCE_TREE_TYPE");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLREDUCE_TREE_TYPE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLREDUCE_TREE_TYPE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_TREE_PIPELINE_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLREDUCE_TREE_PIPELINE_CHUNK_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_IALLREDUCE_TREE_PIPELINE_CHUNK_SIZE", &(MPIR_CVAR_IALLREDUCE_TREE_PIPELINE_CHUNK_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_TREE_PIPELINE_CHUNK_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLREDUCE_TREE_PIPELINE_CHUNK_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_TREE_BUFFER_PER_CHILD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLREDUCE_TREE_BUFFER_PER_CHILD");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IALLREDUCE_TREE_BUFFER_PER_CHILD", &(MPIR_CVAR_IALLREDUCE_TREE_BUFFER_PER_CHILD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_TREE_BUFFER_PER_CHILD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLREDUCE_TREE_BUFFER_PER_CHILD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLREDUCE_RECEXCH_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IALLREDUCE_RECEXCH_KVAL", &(MPIR_CVAR_IALLREDUCE_RECEXCH_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLREDUCE_RECEXCH_KVAL");
    got_rc += rc;
...
"tsp_recexch_reduce_scatter_recexch_allgatherv  - Force generic transport recursive exchange with reduce scatter and allgatherv");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLREDUCE_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLREDUCE_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLREDUCE_INTRA_ALGORITHM");
    got_rc += rc;
...
"sched_remote_reduce_local_bcast - Force remote-reduce-local-bcast algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLREDUCE_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IALLREDUCE_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLREDUCE_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_COMMUTATIVE_LONG_MSG_SIZE);}
    ...
    got_rc += rc;
    rc = MPL_env2int("MVP_REDUCE_SCATTER_COMMUTATIVE_LONG_MSG_SIZE", &(MPIR_CVAR_REDUCE_SCATTER_COMMUTATIVE_LONG_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_COMMUTATIVE_LONG_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_SCATTER_COMMUTATIVE_LONG_MSG_SIZE");
    got_rc += rc;
...
"osu_ring           - Force MVAPICH ring algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_SCATTER_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_REDUCE_SCATTER_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_SCATTER_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (tmp_str != NULL) {
        ...
        else if (0 == strcmp(tmp_str, "osu_basic"))
            MPIR_CVAR_REDUCE_SCATTER_INTRA_ALGORITHM = MPIR_CVAR_REDUCE_SCATTER_INTRA_ALGORITHM_osu_basic;
        else if (0 == strcmp(tmp_str, "osu_ring"))
            MPIR_CVAR_REDUCE_SCATTER_INTRA_ALGORITHM = MPIR_CVAR_REDUCE_SCATTER_INTRA_ALGORITHM_osu_ring;
        else {
...
"remote_reduce_local_scatter - Force remote-reduce-local-scatter algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_SCATTER_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_REDUCE_SCATTER_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_SCATTER_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_SCATTER_RECEXCH_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IREDUCE_SCATTER_RECEXCH_KVAL", &(MPIR_CVAR_IREDUCE_SCATTER_RECEXCH_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_SCATTER_RECEXCH_KVAL");
    got_rc += rc;
...
"tsp_recexch          - Force generic transport recursive exchange algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_SCATTER_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IREDUCE_SCATTER_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_SCATTER_INTRA_ALGORITHM");
    got_rc += rc;
...
"sched_remote_reduce_local_scatterv - Force remote-reduce-local-scatterv algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_SCATTER_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IREDUCE_SCATTER_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_SCATTER_INTER_ALGORITHM");
    got_rc += rc;
...
"nb                 - Force nonblocking algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_BLOCK_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_SCATTER_BLOCK_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_REDUCE_SCATTER_BLOCK_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_BLOCK_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_SCATTER_BLOCK_INTRA_ALGORITHM");
    got_rc += rc;
...
"remote_reduce_local_scatter - Force remote-reduce-local-scatter algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_BLOCK_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_SCATTER_BLOCK_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_REDUCE_SCATTER_BLOCK_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_BLOCK_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_SCATTER_BLOCK_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_BLOCK_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_SCATTER_BLOCK_RECEXCH_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IREDUCE_SCATTER_BLOCK_RECEXCH_KVAL", &(MPIR_CVAR_IREDUCE_SCATTER_BLOCK_RECEXCH_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_BLOCK_RECEXCH_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_SCATTER_BLOCK_RECEXCH_KVAL");
    got_rc += rc;
...
"tsp_recexch          - Force generic transport recursive exchange algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_BLOCK_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_SCATTER_BLOCK_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IREDUCE_SCATTER_BLOCK_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_BLOCK_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_SCATTER_BLOCK_INTRA_ALGORITHM");
    got_rc += rc;
...
"sched_remote_reduce_local_scatterv - Force remote-reduce-local-scatterv algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_BLOCK_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_SCATTER_BLOCK_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IREDUCE_SCATTER_BLOCK_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_BLOCK_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_SCATTER_BLOCK_INTER_ALGORITHM");
    got_rc += rc;
...
"recursive_doubling - Force recursive doubling algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCAN_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SCAN_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_SCAN_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCAN_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SCAN_INTRA_ALGORITHM");
    got_rc += rc;
...
"tsp_recursive_doubling - Force generic transport recursive doubling algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCAN_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ISCAN_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ISCAN_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCAN_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ISCAN_INTRA_ALGORITHM");
    got_rc += rc;
...
"recursive_doubling - Force recursive doubling algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_EXSCAN_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_EXSCAN_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_EXSCAN_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_EXSCAN_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_EXSCAN_INTRA_ALGORITHM");
    got_rc += rc;
...
"sched_recursive_doubling - Force recursive doubling algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IEXSCAN_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IEXSCAN_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IEXSCAN_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IEXSCAN_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IEXSCAN_INTRA_ALGORITHM");
    got_rc += rc;
...
"nb   - Force nonblocking algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLGATHER_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_NEIGHBOR_ALLGATHER_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLGATHER_INTRA_ALGORITHM");
    got_rc += rc;
...
"nb   - Force nonblocking algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLGATHER_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_NEIGHBOR_ALLGATHER_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLGATHER_INTER_ALGORITHM");
    got_rc += rc;
...
"tsp_linear  - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLGATHER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLGATHER_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_INEIGHBOR_ALLGATHER_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLGATHER_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLGATHER_INTRA_ALGORITHM");
    got_rc += rc;
...
"tsp_linear  - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLGATHER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLGATHER_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_INEIGHBOR_ALLGATHER_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLGATHER_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLGATHER_INTER_ALGORITHM");
    got_rc += rc;
...
"nb   - Force nb algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLGATHERV_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_NEIGHBOR_ALLGATHERV_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLGATHERV_INTRA_ALGORITHM");
    got_rc += rc;
...
"nb   - Force nb algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLGATHERV_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_NEIGHBOR_ALLGATHERV_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLGATHERV_INTER_ALGORITHM");
    got_rc += rc;
...
"tsp_linear        - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLGATHERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLGATHERV_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_INEIGHBOR_ALLGATHERV_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLGATHERV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLGATHERV_INTRA_ALGORITHM");
    got_rc += rc;
...
"tsp_linear        - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLGATHERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLGATHERV_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_INEIGHBOR_ALLGATHERV_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLGATHERV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLGATHERV_INTER_ALGORITHM");
    got_rc += rc;
...
"nb   - Force nb algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALL_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLTOALL_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_NEIGHBOR_ALLTOALL_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALL_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLTOALL_INTRA_ALGORITHM");
    got_rc += rc;
...
"nb   - Force nb algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALL_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLTOALL_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_NEIGHBOR_ALLTOALL_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALL_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLTOALL_INTER_ALGORITHM");
    got_rc += rc;
...
"tsp_linear        - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALL_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLTOALL_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_INEIGHBOR_ALLTOALL_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALL_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLTOALL_INTRA_ALGORITHM");
    got_rc += rc;
...
"tsp_linear        - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALL_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLTOALL_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_INEIGHBOR_ALLTOALL_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALL_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLTOALL_INTER_ALGORITHM");
    got_rc += rc;
...
"nb   - Force nb algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLTOALLV_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_NEIGHBOR_ALLTOALLV_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLTOALLV_INTRA_ALGORITHM");
    got_rc += rc;
...
"nb   - Force nb algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLTOALLV_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_NEIGHBOR_ALLTOALLV_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLTOALLV_INTER_ALGORITHM");
    got_rc += rc;
...
"tsp_linear  - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALLV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLTOALLV_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_INEIGHBOR_ALLTOALLV_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALLV_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLTOALLV_INTRA_ALGORITHM");
    got_rc += rc;
...
"tsp_linear  - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALLV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLTOALLV_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_INEIGHBOR_ALLTOALLV_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALLV_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLTOALLV_INTER_ALGORITHM");
    got_rc += rc;
...
"nb   - Force nb algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLW_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLTOALLW_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_NEIGHBOR_ALLTOALLW_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLW_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLTOALLW_INTRA_ALGORITHM");
    got_rc += rc;
...
"nb   - Force nb algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLW_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLTOALLW_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_NEIGHBOR_ALLTOALLW_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLW_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLTOALLW_INTER_ALGORITHM");
    got_rc += rc;
...
"tsp_linear        - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALLW_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLTOALLW_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_INEIGHBOR_ALLTOALLW_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALLW_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLTOALLW_INTRA_ALGORITHM");
    got_rc += rc;
...
"tsp_linear        - Force generic transport based linear algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALLW_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLTOALLW_INTER_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_INEIGHBOR_ALLTOALLW_INTER_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALLW_INTER_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLTOALLW_INTER_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BARRIER_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_BARRIER_DEVICE_COLLECTIVE", &(MPIR_CVAR_BARRIER_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BARRIER_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBARRIER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBARRIER_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IBARRIER_DEVICE_COLLECTIVE", &(MPIR_CVAR_IBARRIER_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBARRIER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBARRIER_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BARRIER_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_BARRIER_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_BARRIER_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BARRIER_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_BCAST_DEVICE_COLLECTIVE", &(MPIR_CVAR_BCAST_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBCAST_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IBCAST_DEVICE_COLLECTIVE", &(MPIR_CVAR_IBCAST_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBCAST_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_BCAST_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_BCAST_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GATHER_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_GATHER_DEVICE_COLLECTIVE", &(MPIR_CVAR_GATHER_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GATHER_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IGATHER_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IGATHER_DEVICE_COLLECTIVE", &(MPIR_CVAR_IGATHER_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IGATHER_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHER_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GATHER_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_GATHER_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_GATHER_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHER_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GATHER_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GATHERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_GATHERV_DEVICE_COLLECTIVE", &(MPIR_CVAR_GATHERV_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GATHERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IGATHERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IGATHERV_DEVICE_COLLECTIVE", &(MPIR_CVAR_IGATHERV_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IGATHERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IGATHERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHERV_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GATHERV_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_GATHERV_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_GATHERV_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHERV_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GATHERV_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SCATTER_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_SCATTER_DEVICE_COLLECTIVE", &(MPIR_CVAR_SCATTER_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SCATTER_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ISCATTER_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ISCATTER_DEVICE_COLLECTIVE", &(MPIR_CVAR_ISCATTER_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ISCATTER_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTER_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SCATTER_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_SCATTER_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_SCATTER_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTER_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SCATTER_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SCATTERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_SCATTERV_DEVICE_COLLECTIVE", &(MPIR_CVAR_SCATTERV_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SCATTERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ISCATTERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ISCATTERV_DEVICE_COLLECTIVE", &(MPIR_CVAR_ISCATTERV_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCATTERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ISCATTERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTERV_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SCATTERV_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_SCATTERV_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_SCATTERV_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCATTERV_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SCATTERV_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLGATHER_DEVICE_COLLECTIVE", &(MPIR_CVAR_ALLGATHER_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLGATHER_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IALLGATHER_DEVICE_COLLECTIVE", &(MPIR_CVAR_IALLGATHER_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLGATHER_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLGATHER_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_ALLGATHER_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLGATHERV_DEVICE_COLLECTIVE", &(MPIR_CVAR_ALLGATHERV_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLGATHERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IALLGATHERV_DEVICE_COLLECTIVE", &(MPIR_CVAR_IALLGATHERV_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLGATHERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLGATHERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHERV_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLGATHERV_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_ALLGATHERV_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHERV_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALL_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLTOALL_DEVICE_COLLECTIVE", &(MPIR_CVAR_ALLTOALL_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALL_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALL_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IALLTOALL_DEVICE_COLLECTIVE", &(MPIR_CVAR_IALLTOALL_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALL_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALL_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLTOALL_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_ALLTOALL_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALL_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALLV_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLTOALLV_DEVICE_COLLECTIVE", &(MPIR_CVAR_ALLTOALLV_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALLV_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALLV_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IALLTOALLV_DEVICE_COLLECTIVE", &(MPIR_CVAR_IALLTOALLV_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALLV_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLV_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALLV_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLTOALLV_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_ALLTOALLV_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLV_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALLV_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLW_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALLW_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLTOALLW_DEVICE_COLLECTIVE", &(MPIR_CVAR_ALLTOALLW_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLW_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALLW_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLW_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALLW_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IALLTOALLW_DEVICE_COLLECTIVE", &(MPIR_CVAR_IALLTOALLW_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALLW_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALLW_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLW_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALLW_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLTOALLW_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_ALLTOALLW_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALLW_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALLW_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_REDUCE_DEVICE_COLLECTIVE", &(MPIR_CVAR_REDUCE_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IREDUCE_DEVICE_COLLECTIVE", &(MPIR_CVAR_IREDUCE_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_REDUCE_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_REDUCE_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLREDUCE_DEVICE_COLLECTIVE", &(MPIR_CVAR_ALLREDUCE_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLREDUCE_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IALLREDUCE_DEVICE_COLLECTIVE", &(MPIR_CVAR_IALLREDUCE_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLREDUCE_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLREDUCE_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ALLREDUCE_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_ALLREDUCE_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_SCATTER_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_REDUCE_SCATTER_DEVICE_COLLECTIVE", &(MPIR_CVAR_REDUCE_SCATTER_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_SCATTER_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_SCATTER_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IREDUCE_SCATTER_DEVICE_COLLECTIVE", &(MPIR_CVAR_IREDUCE_SCATTER_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_SCATTER_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_SCATTER_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_REDUCE_SCATTER_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_REDUCE_SCATTER_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_SCATTER_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_BLOCK_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_SCATTER_BLOCK_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_REDUCE_SCATTER_BLOCK_DEVICE_COLLECTIVE", &(MPIR_CVAR_REDUCE_SCATTER_BLOCK_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_BLOCK_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_SCATTER_BLOCK_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_BLOCK_DEVICE_COLLECTIVE);}
    ...
    got_rc += rc;
    rc = MPL_env2bool("MVP_IREDUCE_SCATTER_BLOCK_DEVICE_COLLECTIVE", &(MPIR_CVAR_IREDUCE_SCATTER_BLOCK_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_SCATTER_BLOCK_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_SCATTER_BLOCK_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_BLOCK_INIT_DEVICE_COLLECTIVE);}
    ...
    got_rc += rc;
    rc = MPL_env2bool("MVP_REDUCE_SCATTER_BLOCK_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_REDUCE_SCATTER_BLOCK_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_SCATTER_BLOCK_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_SCATTER_BLOCK_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCAN_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SCAN_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_SCAN_DEVICE_COLLECTIVE", &(MPIR_CVAR_SCAN_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCAN_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SCAN_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCAN_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ISCAN_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ISCAN_DEVICE_COLLECTIVE", &(MPIR_CVAR_ISCAN_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ISCAN_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ISCAN_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCAN_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SCAN_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_SCAN_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_SCAN_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SCAN_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SCAN_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_EXSCAN_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_EXSCAN_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_EXSCAN_DEVICE_COLLECTIVE", &(MPIR_CVAR_EXSCAN_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_EXSCAN_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_EXSCAN_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IEXSCAN_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IEXSCAN_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IEXSCAN_DEVICE_COLLECTIVE", &(MPIR_CVAR_IEXSCAN_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IEXSCAN_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IEXSCAN_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_EXSCAN_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_EXSCAN_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_EXSCAN_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_EXSCAN_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_EXSCAN_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_EXSCAN_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLGATHER_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_NEIGHBOR_ALLGATHER_DEVICE_COLLECTIVE", &(MPIR_CVAR_NEIGHBOR_ALLGATHER_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLGATHER_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLGATHER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLGATHER_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_INEIGHBOR_ALLGATHER_DEVICE_COLLECTIVE", &(MPIR_CVAR_INEIGHBOR_ALLGATHER_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLGATHER_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLGATHER_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHER_INIT_DEVICE_COLLECTIVE);}
    ...
    got_rc += rc;
    rc = MPL_env2bool("MVP_NEIGHBOR_ALLGATHER_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_NEIGHBOR_ALLGATHER_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHER_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLGATHER_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLGATHERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_NEIGHBOR_ALLGATHERV_DEVICE_COLLECTIVE", &(MPIR_CVAR_NEIGHBOR_ALLGATHERV_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLGATHERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLGATHERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLGATHERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_INEIGHBOR_ALLGATHERV_DEVICE_COLLECTIVE", &(MPIR_CVAR_INEIGHBOR_ALLGATHERV_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLGATHERV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLGATHERV_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHERV_INIT_DEVICE_COLLECTIVE);}
    ...
    got_rc += rc;
    rc = MPL_env2bool("MVP_NEIGHBOR_ALLGATHERV_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_NEIGHBOR_ALLGATHERV_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLGATHERV_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLGATHERV_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALL_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLTOALL_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_NEIGHBOR_ALLTOALL_DEVICE_COLLECTIVE", &(MPIR_CVAR_NEIGHBOR_ALLTOALL_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALL_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLTOALL_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALL_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLTOALL_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_INEIGHBOR_ALLTOALL_DEVICE_COLLECTIVE", &(MPIR_CVAR_INEIGHBOR_ALLTOALL_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALL_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLTOALL_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALL_INIT_DEVICE_COLLECTIVE);}
    ...
    got_rc += rc;
    rc = MPL_env2bool("MVP_NEIGHBOR_ALLTOALL_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_NEIGHBOR_ALLTOALL_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALL_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLTOALL_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLTOALLV_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_NEIGHBOR_ALLTOALLV_DEVICE_COLLECTIVE", &(MPIR_CVAR_NEIGHBOR_ALLTOALLV_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLTOALLV_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALLV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLTOALLV_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_INEIGHBOR_ALLTOALLV_DEVICE_COLLECTIVE", &(MPIR_CVAR_INEIGHBOR_ALLTOALLV_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALLV_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLTOALLV_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLV_INIT_DEVICE_COLLECTIVE);}
    ...
    got_rc += rc;
    rc = MPL_env2bool("MVP_NEIGHBOR_ALLTOALLV_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_NEIGHBOR_ALLTOALLV_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLV_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLTOALLV_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLW_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEIGHBOR_ALLTOALLW_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_NEIGHBOR_ALLTOALLW_DEVICE_COLLECTIVE", &(MPIR_CVAR_NEIGHBOR_ALLTOALLW_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLW_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLTOALLW_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALLW_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INEIGHBOR_ALLTOALLW_DEVICE_COLLECTIVE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_INEIGHBOR_ALLTOALLW_DEVICE_COLLECTIVE", &(MPIR_CVAR_INEIGHBOR_ALLTOALLW_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INEIGHBOR_ALLTOALLW_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INEIGHBOR_ALLTOALLW_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLW_INIT_DEVICE_COLLECTIVE);}
    ...
    got_rc += rc;
    rc = MPL_env2bool("MVP_NEIGHBOR_ALLTOALLW_INIT_DEVICE_COLLECTIVE", &(MPIR_CVAR_NEIGHBOR_ALLTOALLW_INIT_DEVICE_COLLECTIVE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEIGHBOR_ALLTOALLW_INIT_DEVICE_COLLECTIVE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEIGHBOR_ALLTOALLW_INIT_DEVICE_COLLECTIVE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLL_HYBRID_MEMORY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_COLL_HYBRID_MEMORY");
    got_rc += rc;
    rc = MPL_env2bool("MVP_COLL_HYBRID_MEMORY", &(MPIR_CVAR_COLL_HYBRID_MEMORY));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLL_HYBRID_MEMORY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_COLL_HYBRID_MEMORY");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHER_VSMALL_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GATHER_VSMALL_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_GATHER_VSMALL_MSG_SIZE", &(MPIR_CVAR_GATHER_VSMALL_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GATHER_VSMALL_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GATHER_VSMALL_MSG_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_BRUCKS_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALL_BRUCKS_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_IALLTOALL_BRUCKS_KVAL", &(MPIR_CVAR_IALLTOALL_BRUCKS_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_BRUCKS_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALL_BRUCKS_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_BRUCKS_BUFFER_PER_NBR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALL_BRUCKS_BUFFER_PER_NBR");
    got_rc += rc;
    rc = MPL_env2bool("MVP_IALLTOALL_BRUCKS_BUFFER_PER_NBR", &(MPIR_CVAR_IALLTOALL_BRUCKS_BUFFER_PER_NBR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_BRUCKS_BUFFER_PER_NBR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALL_BRUCKS_BUFFER_PER_NBR");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_SCATTERED_OUTSTANDING_TASKS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALL_SCATTERED_OUTSTANDING_TASKS");
    got_rc += rc;
    rc = MPL_env2int("MVP_IALLTOALL_SCATTERED_OUTSTANDING_TASKS", &(MPIR_CVAR_IALLTOALL_SCATTERED_OUTSTANDING_TASKS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_SCATTERED_OUTSTANDING_TASKS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALL_SCATTERED_OUTSTANDING_TASKS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_SCATTERED_BATCH_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IALLTOALL_SCATTERED_BATCH_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_IALLTOALL_SCATTERED_BATCH_SIZE", &(MPIR_CVAR_IALLTOALL_SCATTERED_BATCH_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IALLTOALL_SCATTERED_BATCH_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IALLTOALL_SCATTERED_BATCH_SIZE");
    got_rc += rc;
    ...
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR, /* name */
        &MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
    ...
    MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR = defaultval.d;
    got_rc = 0;
    rc = MPL_env2int("MPICH_BCAST_INTER_KNOMIAL_FACTOR", &(MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_INTER_KNOMIAL_FACTOR");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_INTER_KNOMIAL_FACTOR", &(MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_INTER_KNOMIAL_FACTOR");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR", &(MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR = %d\n", MPIR_CVAR_BCAST_INTER_KNOMIAL_FACTOR);
    }

    defaultval.d = 4;
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR, /* name */
        &MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
    ...
    MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR = defaultval.d;
    got_rc = 0;
    rc = MPL_env2int("MPICH_BCAST_INTRA_KNOMIAL_FACTOR", &(MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_INTRA_KNOMIAL_FACTOR");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_INTRA_KNOMIAL_FACTOR", &(MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_INTRA_KNOMIAL_FACTOR");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR", &(MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR = %d\n", MPIR_CVAR_BCAST_INTRA_KNOMIAL_FACTOR);
    }

    defaultval.d = 8192;
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_BCAST_SEGMENT_SIZE, /* name */
        &MPIR_CVAR_BCAST_SEGMENT_SIZE, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
    ...
    MPIR_CVAR_BCAST_SEGMENT_SIZE = defaultval.d;
    got_rc = 0;
    rc = MPL_env2int("MPICH_BCAST_SEGMENT_SIZE", &(MPIR_CVAR_BCAST_SEGMENT_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_SEGMENT_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_SEGMENT_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_SEGMENT_SIZE", &(MPIR_CVAR_BCAST_SEGMENT_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_SEGMENT_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_SEGMENT_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_BCAST_SEGMENT_SIZE", &(MPIR_CVAR_BCAST_SEGMENT_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_SEGMENT_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_BCAST_SEGMENT_SIZE");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_BCAST_SEGMENT_SIZE = %d\n", MPIR_CVAR_BCAST_SEGMENT_SIZE);
    }

    defaultval.d = 4;
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR, /* name */
        &MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
    ...
    MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR = defaultval.d;
    got_rc = 0;
    rc = MPL_env2int("MPICH_REDUCE_INTER_KNOMIAL_FACTOR", &(MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_INTER_KNOMIAL_FACTOR");
    got_rc += rc;
    rc = MPL_env2int("MVP_REDUCE_INTER_KNOMIAL_FACTOR", &(MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_INTER_KNOMIAL_FACTOR");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR", &(MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR = %d\n", MPIR_CVAR_REDUCE_INTER_KNOMIAL_FACTOR);
    }

    defaultval.d = 4;
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR, /* name */
        &MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
    ...
    MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR = defaultval.d;
    got_rc = 0;
    rc = MPL_env2int("MPICH_REDUCE_INTRA_KNOMIAL_FACTOR", &(MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_INTRA_KNOMIAL_FACTOR");
    got_rc += rc;
    rc = MPL_env2int("MVP_REDUCE_INTRA_KNOMIAL_FACTOR", &(MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_INTRA_KNOMIAL_FACTOR");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR", &(MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR = %d\n", MPIR_CVAR_REDUCE_INTRA_KNOMIAL_FACTOR);
    }
...
"percoll - Use the per-collective CVARs to decide");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEVICE_COLLECTIVES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_DEVICE_COLLECTIVES");
    got_rc += rc;
    rc = MPL_env2str("MVP_DEVICE_COLLECTIVES", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEVICE_COLLECTIVES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_DEVICE_COLLECTIVES");
    got_rc += rc;
...
"silent  - silently fallback to the internally selected algorithm");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLLECTIVE_FALLBACK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_COLLECTIVE_FALLBACK");
    got_rc += rc;
    rc = MPL_env2str("MVP_COLLECTIVE_FALLBACK", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLLECTIVE_FALLBACK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_COLLECTIVE_FALLBACK");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLL_SELECTION_TUNING_JSON_FILE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_COLL_SELECTION_TUNING_JSON_FILE");
    got_rc += rc;
    rc = MPL_env2str("MVP_COLL_SELECTION_TUNING_JSON_FILE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLL_SELECTION_TUNING_JSON_FILE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_COLL_SELECTION_TUNING_JSON_FILE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_HIERARCHY_DUMP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_HIERARCHY_DUMP");
    got_rc += rc;
    rc = MPL_env2bool("MVP_HIERARCHY_DUMP", &(MPIR_CVAR_HIERARCHY_DUMP));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_HIERARCHY_DUMP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_HIERARCHY_DUMP");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COORDINATES_FILE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_COORDINATES_FILE");
    got_rc += rc;
    rc = MPL_env2str("MVP_COORDINATES_FILE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COORDINATES_FILE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_COORDINATES_FILE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLL_TREE_DUMP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_COLL_TREE_DUMP");
    got_rc += rc;
    rc = MPL_env2bool("MVP_COLL_TREE_DUMP", &(MPIR_CVAR_COLL_TREE_DUMP));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLL_TREE_DUMP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_COLL_TREE_DUMP");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COORDINATES_DUMP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_COORDINATES_DUMP");
    got_rc += rc;
    rc = MPL_env2bool("MVP_COORDINATES_DUMP", &(MPIR_CVAR_COORDINATES_DUMP));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COORDINATES_DUMP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_COORDINATES_DUMP");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PROGRESS_MAX_COLLS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_PROGRESS_MAX_COLLS");
    got_rc += rc;
    rc = MPL_env2int("MVP_PROGRESS_MAX_COLLS", &(MPIR_CVAR_PROGRESS_MAX_COLLS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PROGRESS_MAX_COLLS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_PROGRESS_MAX_COLLS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COMM_SPLIT_USE_QSORT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_COMM_SPLIT_USE_QSORT");
    got_rc += rc;
    rc = MPL_env2bool("MVP_COMM_SPLIT_USE_QSORT", &(MPIR_CVAR_COMM_SPLIT_USE_QSORT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COMM_SPLIT_USE_QSORT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_COMM_SPLIT_USE_QSORT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CTXID_EAGER_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CTXID_EAGER_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CTXID_EAGER_SIZE", &(MPIR_CVAR_CTXID_EAGER_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CTXID_EAGER_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CTXID_EAGER_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DATALOOP_FAST_SEEK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_DATALOOP_FAST_SEEK");
    got_rc += rc;
    rc = MPL_env2int("MVP_DATALOOP_FAST_SEEK", &(MPIR_CVAR_DATALOOP_FAST_SEEK));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DATALOOP_FAST_SEEK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_DATALOOP_FAST_SEEK");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_YAKSA_COMPLEX_SUPPORT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_YAKSA_COMPLEX_SUPPORT");
    got_rc += rc;
    rc = MPL_env2int("MVP_YAKSA_COMPLEX_SUPPORT", &(MPIR_CVAR_YAKSA_COMPLEX_SUPPORT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_YAKSA_COMPLEX_SUPPORT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_YAKSA_COMPLEX_SUPPORT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_DOUBLE_SUPPORT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GPU_DOUBLE_SUPPORT");
    got_rc += rc;
    rc = MPL_env2int("MVP_GPU_DOUBLE_SUPPORT", &(MPIR_CVAR_GPU_DOUBLE_SUPPORT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_DOUBLE_SUPPORT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GPU_DOUBLE_SUPPORT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_LONG_DOUBLE_SUPPORT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GPU_LONG_DOUBLE_SUPPORT");
    got_rc += rc;
    rc = MPL_env2int("MVP_GPU_LONG_DOUBLE_SUPPORT", &(MPIR_CVAR_GPU_LONG_DOUBLE_SUPPORT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_LONG_DOUBLE_SUPPORT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GPU_LONG_DOUBLE_SUPPORT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_YAKSA_REDUCTION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ENABLE_YAKSA_REDUCTION");
    got_rc += rc;
    rc = MPL_env2int("MVP_ENABLE_YAKSA_REDUCTION", &(MPIR_CVAR_ENABLE_YAKSA_REDUCTION));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_YAKSA_REDUCTION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ENABLE_YAKSA_REDUCTION");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_YAKSA_REDUCTION_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_YAKSA_REDUCTION_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_YAKSA_REDUCTION_THRESHOLD", &(MPIR_CVAR_YAKSA_REDUCTION_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_YAKSA_REDUCTION_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_YAKSA_REDUCTION_THRESHOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PROCTABLE_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_PROCTABLE_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_PROCTABLE_SIZE", &(MPIR_CVAR_PROCTABLE_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PROCTABLE_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_PROCTABLE_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PROCTABLE_PRINT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_PROCTABLE_PRINT");
    got_rc += rc;
    rc = MPL_env2bool("MVP_PROCTABLE_PRINT", &(MPIR_CVAR_PROCTABLE_PRINT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PROCTABLE_PRINT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_PROCTABLE_PRINT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PRINT_ERROR_STACK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_PRINT_ERROR_STACK");
    got_rc += rc;
    rc = MPL_env2bool("MVP_PRINT_ERROR_STACK", &(MPIR_CVAR_PRINT_ERROR_STACK));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PRINT_ERROR_STACK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_PRINT_ERROR_STACK");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CHOP_ERROR_STACK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CHOP_ERROR_STACK");
    got_rc += rc;
    rc = MPL_env2int("MVP_CHOP_ERROR_STACK", &(MPIR_CVAR_CHOP_ERROR_STACK));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CHOP_ERROR_STACK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CHOP_ERROR_STACK");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ASYNC_PROGRESS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ASYNC_PROGRESS");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ASYNC_PROGRESS", &(MPIR_CVAR_ASYNC_PROGRESS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ASYNC_PROGRESS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ASYNC_PROGRESS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PROGRESS_THREAD_AFFINITY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_PROGRESS_THREAD_AFFINITY");
    got_rc += rc;
    rc = MPL_env2str("MVP_PROGRESS_THREAD_AFFINITY", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PROGRESS_THREAD_AFFINITY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_PROGRESS_THREAD_AFFINITY");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SUPPRESS_ABORT_MESSAGE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SUPPRESS_ABORT_MESSAGE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_SUPPRESS_ABORT_MESSAGE", &(MPIR_CVAR_SUPPRESS_ABORT_MESSAGE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SUPPRESS_ABORT_MESSAGE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SUPPRESS_ABORT_MESSAGE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COREDUMP_ON_ABORT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_COREDUMP_ON_ABORT");
    got_rc += rc;
    rc = MPL_env2bool("MVP_COREDUMP_ON_ABORT", &(MPIR_CVAR_COREDUMP_ON_ABORT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COREDUMP_ON_ABORT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_COREDUMP_ON_ABORT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ERROR_CHECKING);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ERROR_CHECKING");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ERROR_CHECKING", &(MPIR_CVAR_ERROR_CHECKING));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ERROR_CHECKING);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ERROR_CHECKING");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MEMDUMP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_MEMDUMP");
    got_rc += rc;
    rc = MPL_env2bool("MVP_MEMDUMP", &(MPIR_CVAR_MEMDUMP));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MEMDUMP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_MEMDUMP");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEBUG_SUMMARY);}
    ...
    got_rc += rc;
    rc = MPL_env2int("MVP_MEM_CATEGORY_INFORMATION", &(MPIR_CVAR_DEBUG_SUMMARY));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEBUG_SUMMARY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_MEM_CATEGORY_INFORMATION");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_CAPABILITY_SETS_DEBUG", &(MPIR_CVAR_DEBUG_SUMMARY));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEBUG_SUMMARY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_CAPABILITY_SETS_DEBUG");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_UCX_CAPABILITY_DEBUG", &(MPIR_CVAR_DEBUG_SUMMARY));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEBUG_SUMMARY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_UCX_CAPABILITY_DEBUG");
    got_rc += rc;
    ...
    got_rc += rc;
    rc = MPL_env2int("MVP_DEBUG_SUMMARY", &(MPIR_CVAR_DEBUG_SUMMARY));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEBUG_SUMMARY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_DEBUG_SUMMARY");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEFAULT_THREAD_LEVEL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_DEFAULT_THREAD_LEVEL");
    got_rc += rc;
    rc = MPL_env2str("MVP_DEFAULT_THREAD_LEVEL", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEFAULT_THREAD_LEVEL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_DEFAULT_THREAD_LEVEL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEBUG_HOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_DEBUG_HOLD");
    got_rc += rc;
    rc = MPL_env2bool("MVP_DEBUG_HOLD", &(MPIR_CVAR_DEBUG_HOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEBUG_HOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_DEBUG_HOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_USE_IMMEDIATE_COMMAND_LIST);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GPU_USE_IMMEDIATE_COMMAND_LIST");
    got_rc += rc;
    rc = MPL_env2bool("MVP_GPU_USE_IMMEDIATE_COMMAND_LIST", &(MPIR_CVAR_GPU_USE_IMMEDIATE_COMMAND_LIST));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_USE_IMMEDIATE_COMMAND_LIST);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GPU_USE_IMMEDIATE_COMMAND_LIST");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_ROUND_ROBIN_COMMAND_QUEUES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GPU_ROUND_ROBIN_COMMAND_QUEUES");
    got_rc += rc;
    rc = MPL_env2bool("MVP_GPU_ROUND_ROBIN_COMMAND_QUEUES", &(MPIR_CVAR_GPU_ROUND_ROBIN_COMMAND_QUEUES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_ROUND_ROBIN_COMMAND_QUEUES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GPU_ROUND_ROBIN_COMMAND_QUEUES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NO_COLLECTIVE_FINALIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NO_COLLECTIVE_FINALIZE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_NO_COLLECTIVE_FINALIZE", &(MPIR_CVAR_NO_COLLECTIVE_FINALIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NO_COLLECTIVE_FINALIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NO_COLLECTIVE_FINALIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_FINALIZE_WAIT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_FINALIZE_WAIT");
    got_rc += rc;
    rc = MPL_env2bool("MVP_FINALIZE_WAIT", &(MPIR_CVAR_FINALIZE_WAIT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_FINALIZE_WAIT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_FINALIZE_WAIT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INIT_SKIP_PMI_BARRIER);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INIT_SKIP_PMI_BARRIER");
    got_rc += rc;
    rc = MPL_env2bool("MVP_INIT_SKIP_PMI_BARRIER", &(MPIR_CVAR_INIT_SKIP_PMI_BARRIER));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_INIT_SKIP_PMI_BARRIER);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INIT_SKIP_PMI_BARRIER");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_FAST_COPY_MAX_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GPU_FAST_COPY_MAX_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_GPU_FAST_COPY_MAX_SIZE", &(MPIR_CVAR_GPU_FAST_COPY_MAX_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_FAST_COPY_MAX_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GPU_FAST_COPY_MAX_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_FAST_COPY_MAX_SIZE_H2D);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GPU_FAST_COPY_MAX_SIZE_H2D");
    got_rc += rc;
    rc = MPL_env2int("MVP_GPU_FAST_COPY_MAX_SIZE_H2D", &(MPIR_CVAR_GPU_FAST_COPY_MAX_SIZE_H2D));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_FAST_COPY_MAX_SIZE_H2D);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GPU_FAST_COPY_MAX_SIZE_H2D");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_FAST_COPY_MAX_SIZE_D2H);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GPU_FAST_COPY_MAX_SIZE_D2H");
    got_rc += rc;
    rc = MPL_env2int("MVP_GPU_FAST_COPY_MAX_SIZE_D2H", &(MPIR_CVAR_GPU_FAST_COPY_MAX_SIZE_D2H));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_FAST_COPY_MAX_SIZE_D2H);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GPU_FAST_COPY_MAX_SIZE_D2H");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REQUEST_ERR_FATAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REQUEST_ERR_FATAL");
    got_rc += rc;
    rc = MPL_env2bool("MVP_REQUEST_ERR_FATAL", &(MPIR_CVAR_REQUEST_ERR_FATAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REQUEST_ERR_FATAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REQUEST_ERR_FATAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REQUEST_POLL_FREQ);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REQUEST_POLL_FREQ");
    got_rc += rc;
    rc = MPL_env2int("MVP_REQUEST_POLL_FREQ", &(MPIR_CVAR_REQUEST_POLL_FREQ));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REQUEST_POLL_FREQ);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REQUEST_POLL_FREQ");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REQUEST_BATCH_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REQUEST_BATCH_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_REQUEST_BATCH_SIZE", &(MPIR_CVAR_REQUEST_BATCH_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REQUEST_BATCH_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REQUEST_BATCH_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEBUG_PROGRESS_TIMEOUT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_DEBUG_PROGRESS_TIMEOUT");
    got_rc += rc;
    rc = MPL_env2int("MVP_DEBUG_PROGRESS_TIMEOUT", &(MPIR_CVAR_DEBUG_PROGRESS_TIMEOUT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DEBUG_PROGRESS_TIMEOUT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_DEBUG_PROGRESS_TIMEOUT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DIMS_VERBOSE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_DIMS_VERBOSE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_DIMS_VERBOSE", &(MPIR_CVAR_DIMS_VERBOSE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_DIMS_VERBOSE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_DIMS_VERBOSE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_QMPI_TOOL_LIST);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_QMPI_TOOL_LIST");
    got_rc += rc;
    rc = MPL_env2str("MVP_QMPI_TOOL_LIST", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_QMPI_TOOL_LIST);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_QMPI_TOOL_LIST");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NAMESERV_FILE_PUBDIR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NAMEPUB_DIR");
    got_rc += rc;
    rc = MPL_env2str("MVP_NAMEPUB_DIR", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NAMESERV_FILE_PUBDIR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NAMEPUB_DIR");
    got_rc += rc;
    ...
    got_rc += rc;
    rc = MPL_env2str("MVP_NAMESERV_FILE_PUBDIR", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NAMESERV_FILE_PUBDIR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NAMESERV_FILE_PUBDIR");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ABORT_ON_LEAKED_HANDLES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ABORT_ON_LEAKED_HANDLES");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ABORT_ON_LEAKED_HANDLES", &(MPIR_CVAR_ABORT_ON_LEAKED_HANDLES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ABORT_ON_LEAKED_HANDLES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ABORT_ON_LEAKED_HANDLES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NETLOC_NODE_FILE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NETLOC_NODE_FILE");
    got_rc += rc;
    rc = MPL_env2str("MVP_NETLOC_NODE_FILE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NETLOC_NODE_FILE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NETLOC_NODE_FILE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NOLOCAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NO_LOCAL");
    got_rc += rc;
    rc = MPL_env2bool("MVP_NO_LOCAL", &(MPIR_CVAR_NOLOCAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NOLOCAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NO_LOCAL");
    got_rc += rc;
    ...
    got_rc += rc;
    rc = MPL_env2bool("MVP_NOLOCAL", &(MPIR_CVAR_NOLOCAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NOLOCAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NOLOCAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ODD_EVEN_CLIQUES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_EVEN_ODD_CLIQUES");
    got_rc += rc;
    rc = MPL_env2bool("MVP_EVEN_ODD_CLIQUES", &(MPIR_CVAR_ODD_EVEN_CLIQUES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ODD_EVEN_CLIQUES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_EVEN_ODD_CLIQUES");
    got_rc += rc;
    ...
    got_rc += rc;
    rc = MPL_env2bool("MVP_ODD_EVEN_CLIQUES", &(MPIR_CVAR_ODD_EVEN_CLIQUES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ODD_EVEN_CLIQUES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ODD_EVEN_CLIQUES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NUM_CLIQUES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NUM_CLIQUES");
    got_rc += rc;
    rc = MPL_env2int("MVP_NUM_CLIQUES", &(MPIR_CVAR_NUM_CLIQUES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NUM_CLIQUES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NUM_CLIQUES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CLIQUES_BY_BLOCK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CLIQUES_BY_BLOCK");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CLIQUES_BY_BLOCK", &(MPIR_CVAR_CLIQUES_BY_BLOCK));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CLIQUES_BY_BLOCK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CLIQUES_BY_BLOCK");
    got_rc += rc;
...
"x        - PMIx");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PMI_VERSION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_PMI_VERSION");
    got_rc += rc;
    rc = MPL_env2str("MVP_PMI_VERSION", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PMI_VERSION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_PMI_VERSION");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLL_ALIAS_CHECK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_COLL_ALIAS_CHECK");
    got_rc += rc;
    rc = MPL_env2int("MVP_COLL_ALIAS_CHECK", &(MPIR_CVAR_COLL_ALIAS_CHECK));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLL_ALIAS_CHECK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_COLL_ALIAS_CHECK");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_GPU);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ENABLE_GPU");
    got_rc += rc;
    rc = MPL_env2int("MVP_ENABLE_GPU", &(MPIR_CVAR_ENABLE_GPU));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_GPU);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ENABLE_GPU");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_HAS_WAIT_KERNEL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GPU_HAS_WAIT_KERNEL");
    got_rc += rc;
    rc = MPL_env2int("MVP_GPU_HAS_WAIT_KERNEL", &(MPIR_CVAR_GPU_HAS_WAIT_KERNEL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GPU_HAS_WAIT_KERNEL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GPU_HAS_WAIT_KERNEL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_GPU_REGISTER);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ENABLE_GPU_REGISTER");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ENABLE_GPU_REGISTER", &(MPIR_CVAR_ENABLE_GPU_REGISTER));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_GPU_REGISTER);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ENABLE_GPU_REGISTER");
    got_rc += rc;
    ...
    defaultval.d = 32 * 1024 * 1024;
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_LMEM_POOL_SIZE, /* name */
        &MPIR_CVAR_LMEM_POOL_SIZE, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
    ...
    MPIR_CVAR_LMEM_POOL_SIZE = defaultval.d;
    got_rc = 0;
    rc = MPL_env2int("MPICH_LMEM_POOL_SIZE", &(MPIR_CVAR_LMEM_POOL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_LMEM_POOL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_LMEM_POOL_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_LMEM_POOL_SIZE", &(MPIR_CVAR_LMEM_POOL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_LMEM_POOL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_LMEM_POOL_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_LMEM_POOL_SIZE", &(MPIR_CVAR_LMEM_POOL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_LMEM_POOL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_LMEM_POOL_SIZE");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_LMEM_POOL_SIZE = %d\n", MPIR_CVAR_LMEM_POOL_SIZE);
    }
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_POLLS_BEFORE_YIELD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_POLLS_BEFORE_YIELD");
    got_rc += rc;
    rc = MPL_env2int("MVP_POLLS_BEFORE_YIELD", &(MPIR_CVAR_POLLS_BEFORE_YIELD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_POLLS_BEFORE_YIELD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_POLLS_BEFORE_YIELD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_INTERFACE_HOSTNAME);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_INTERFACE_HOSTNAME");
    got_rc += rc;
    rc = MPL_env2str("MVP_INTERFACE_HOSTNAME", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_INTERFACE_HOSTNAME);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_INTERFACE_HOSTNAME");
    got_rc += rc;
    ...
    got_rc += rc;
    rc = MPL_env2str("MVP_CH3_INTERFACE_HOSTNAME", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_INTERFACE_HOSTNAME);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_INTERFACE_HOSTNAME");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_PORT_RANGE);}
    ...
    got_rc += rc;
    rc = MPL_env2range("MVP_PORTRANGE", &(MPIR_CVAR_CH3_PORT_RANGE.low), &(MPIR_CVAR_CH3_PORT_RANGE.high));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_PORT_RANGE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_PORTRANGE");
    got_rc += rc;
    rc = MPL_env2range("MVP_PORT_RANGE", &(MPIR_CVAR_CH3_PORT_RANGE.low), &(MPIR_CVAR_CH3_PORT_RANGE.high));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_PORT_RANGE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_PORT_RANGE");
    got_rc += rc;
    ...
    got_rc += rc;
    rc = MPL_env2range("MVP_CH3_PORT_RANGE", &(MPIR_CVAR_CH3_PORT_RANGE.low), &(MPIR_CVAR_CH3_PORT_RANGE.high));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_PORT_RANGE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_PORT_RANGE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_TCP_NETWORK_IFACE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NETWORK_IFACE");
    got_rc += rc;
    rc = MPL_env2str("MVP_NETWORK_IFACE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_TCP_NETWORK_IFACE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NETWORK_IFACE");
    got_rc += rc;
    ...
    got_rc += rc;
    rc = MPL_env2str("MVP_NEMESIS_TCP_NETWORK_IFACE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_TCP_NETWORK_IFACE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEMESIS_TCP_NETWORK_IFACE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_TCP_HOST_LOOKUP_RETRIES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEMESIS_TCP_HOST_LOOKUP_RETRIES");
    got_rc += rc;
    rc = MPL_env2int("MVP_NEMESIS_TCP_HOST_LOOKUP_RETRIES", &(MPIR_CVAR_NEMESIS_TCP_HOST_LOOKUP_RETRIES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_TCP_HOST_LOOKUP_RETRIES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEMESIS_TCP_HOST_LOOKUP_RETRIES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_ENABLE_CKPOINT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEMESIS_ENABLE_CKPOINT");
    got_rc += rc;
    rc = MPL_env2bool("MVP_NEMESIS_ENABLE_CKPOINT", &(MPIR_CVAR_NEMESIS_ENABLE_CKPOINT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_ENABLE_CKPOINT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEMESIS_ENABLE_CKPOINT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_SHM_EAGER_MAX_SZ);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEMESIS_SHM_EAGER_MAX_SZ");
    got_rc += rc;
    rc = MPL_env2int("MVP_NEMESIS_SHM_EAGER_MAX_SZ", &(MPIR_CVAR_NEMESIS_SHM_EAGER_MAX_SZ));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_SHM_EAGER_MAX_SZ);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEMESIS_SHM_EAGER_MAX_SZ");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_SHM_READY_EAGER_MAX_SZ);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEMESIS_SHM_READY_EAGER_MAX_SZ");
    got_rc += rc;
    rc = MPL_env2int("MVP_NEMESIS_SHM_READY_EAGER_MAX_SZ", &(MPIR_CVAR_NEMESIS_SHM_READY_EAGER_MAX_SZ));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_SHM_READY_EAGER_MAX_SZ);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEMESIS_SHM_READY_EAGER_MAX_SZ");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_FT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ENABLE_FT");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ENABLE_FT", &(MPIR_CVAR_ENABLE_FT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_FT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ENABLE_FT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_NETMOD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NEMESIS_NETMOD");
    got_rc += rc;
    rc = MPL_env2str("MVP_NEMESIS_NETMOD", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NEMESIS_NETMOD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NEMESIS_NETMOD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_ENABLE_HCOLL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_ENABLE_HCOLL");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH3_ENABLE_HCOLL", &(MPIR_CVAR_CH3_ENABLE_HCOLL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_ENABLE_HCOLL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_ENABLE_HCOLL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_COMM_CONNECT_TIMEOUT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_COMM_CONNECT_TIMEOUT");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_COMM_CONNECT_TIMEOUT", &(MPIR_CVAR_CH3_COMM_CONNECT_TIMEOUT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_COMM_CONNECT_TIMEOUT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_COMM_CONNECT_TIMEOUT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_OP_PIGGYBACK_LOCK_DATA_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_RMA_OP_PIGGYBACK_LOCK_DATA_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_RMA_OP_PIGGYBACK_LOCK_DATA_SIZE", &(MPIR_CVAR_CH3_RMA_OP_PIGGYBACK_LOCK_DATA_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_OP_PIGGYBACK_LOCK_DATA_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_RMA_OP_PIGGYBACK_LOCK_DATA_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_ACTIVE_REQ_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_RMA_ACTIVE_REQ_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_RMA_ACTIVE_REQ_THRESHOLD", &(MPIR_CVAR_CH3_RMA_ACTIVE_REQ_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_ACTIVE_REQ_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_RMA_ACTIVE_REQ_THRESHOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_POKE_PROGRESS_REQ_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_RMA_POKE_PROGRESS_REQ_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_RMA_POKE_PROGRESS_REQ_THRESHOLD", &(MPIR_CVAR_CH3_RMA_POKE_PROGRESS_REQ_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_POKE_PROGRESS_REQ_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_RMA_POKE_PROGRESS_REQ_THRESHOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_SCALABLE_FENCE_PROCESS_NUM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_RMA_SCALABLE_FENCE_PROCESS_NUM");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_RMA_SCALABLE_FENCE_PROCESS_NUM", &(MPIR_CVAR_CH3_RMA_SCALABLE_FENCE_PROCESS_NUM));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_SCALABLE_FENCE_PROCESS_NUM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_RMA_SCALABLE_FENCE_PROCESS_NUM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_DELAY_ISSUING_FOR_PIGGYBACKING);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_RMA_DELAY_ISSUING_FOR_PIGGYBACKING");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_RMA_DELAY_ISSUING_FOR_PIGGYBACKING", &(MPIR_CVAR_CH3_RMA_DELAY_ISSUING_FOR_PIGGYBACKING));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_DELAY_ISSUING_FOR_PIGGYBACKING);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_RMA_DELAY_ISSUING_FOR_PIGGYBACKING");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_SLOTS_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_RMA_SLOTS_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_RMA_SLOTS_SIZE", &(MPIR_CVAR_CH3_RMA_SLOTS_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_SLOTS_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_RMA_SLOTS_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_TARGET_LOCK_DATA_BYTES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_RMA_TARGET_LOCK_DATA_BYTES");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_RMA_TARGET_LOCK_DATA_BYTES", &(MPIR_CVAR_CH3_RMA_TARGET_LOCK_DATA_BYTES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_TARGET_LOCK_DATA_BYTES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_RMA_TARGET_LOCK_DATA_BYTES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_EAGER_MAX_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_EAGER_MAX_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_EAGER_MAX_MSG_SIZE", &(MPIR_CVAR_CH3_EAGER_MAX_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_EAGER_MAX_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_EAGER_MAX_MSG_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_PG_VERBOSE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_PG_VERBOSE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH3_PG_VERBOSE", &(MPIR_CVAR_CH3_PG_VERBOSE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_PG_VERBOSE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_PG_VERBOSE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_OP_WIN_POOL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_RMA_OP_WIN_POOL_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_RMA_OP_WIN_POOL_SIZE", &(MPIR_CVAR_CH3_RMA_OP_WIN_POOL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_OP_WIN_POOL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_RMA_OP_WIN_POOL_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_OP_GLOBAL_POOL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_RMA_OP_GLOBAL_POOL_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_RMA_OP_GLOBAL_POOL_SIZE", &(MPIR_CVAR_CH3_RMA_OP_GLOBAL_POOL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_OP_GLOBAL_POOL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_RMA_OP_GLOBAL_POOL_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_TARGET_WIN_POOL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_RMA_TARGET_WIN_POOL_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_RMA_TARGET_WIN_POOL_SIZE", &(MPIR_CVAR_CH3_RMA_TARGET_WIN_POOL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_TARGET_WIN_POOL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_RMA_TARGET_WIN_POOL_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_TARGET_GLOBAL_POOL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH3_RMA_TARGET_GLOBAL_POOL_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_RMA_TARGET_GLOBAL_POOL_SIZE", &(MPIR_CVAR_CH3_RMA_TARGET_GLOBAL_POOL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_TARGET_GLOBAL_POOL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_RMA_TARGET_GLOBAL_POOL_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_TARGET_LOCK_ENTRY_WIN_POOL_SIZE);}
    ...
    got_rc += rc;
    rc = MPL_env2int("MVP_CH3_RMA_TARGET_LOCK_ENTRY_WIN_POOL_SIZE", &(MPIR_CVAR_CH3_RMA_TARGET_LOCK_ENTRY_WIN_POOL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH3_RMA_TARGET_LOCK_ENTRY_WIN_POOL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH3_RMA_TARGET_LOCK_ENTRY_WIN_POOL_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_OFI_USE_PROVIDER);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_OFI_USE_PROVIDER");
    got_rc += rc;
    rc = MPL_env2str("MVP_OFI_USE_PROVIDER", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_OFI_USE_PROVIDER);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_OFI_USE_PROVIDER");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SINGLE_HOST_ENABLED);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SINGLE_HOST_ENABLED");
    got_rc += rc;
    rc = MPL_env2bool("MVP_SINGLE_HOST_ENABLED", &(MPIR_CVAR_SINGLE_HOST_ENABLED));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SINGLE_HOST_ENABLED);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SINGLE_HOST_ENABLED");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_AM_LONG_FORCE_PIPELINE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_AM_LONG_FORCE_PIPELINE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH4_OFI_AM_LONG_FORCE_PIPELINE", &(MPIR_CVAR_CH4_OFI_AM_LONG_FORCE_PIPELINE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_AM_LONG_FORCE_PIPELINE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_AM_LONG_FORCE_PIPELINE");
    got_rc += rc;
...
"auto - Internal algorithm selection (can be overridden with MPIR_CVAR_CH4_OFI_COLL_SELECTION_TUNING_JSON_FILE)");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_OFI_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_OFI_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_BCAST_OFI_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_OFI_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_OFI_INTRA_ALGORITHM");
    got_rc += rc;
...
"yaksa - use Yaksa");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_RECEIVE_ENGINE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_GPU_RECEIVE_ENGINE_TYPE");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_OFI_GPU_RECEIVE_ENGINE_TYPE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_RECEIVE_ENGINE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_GPU_RECEIVE_ENGINE_TYPE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_OFI_SKIP_IPV6);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_OFI_SKIP_IPV6");
    got_rc += rc;
    rc = MPL_env2bool("MVP_OFI_SKIP_IPV6", &(MPIR_CVAR_OFI_SKIP_IPV6));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_OFI_SKIP_IPV6);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_OFI_SKIP_IPV6");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_DATA);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_DATA");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_DATA", &(MPIR_CVAR_CH4_OFI_ENABLE_DATA));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_DATA);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_DATA");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_AV_TABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_AV_TABLE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_AV_TABLE", &(MPIR_CVAR_CH4_OFI_ENABLE_AV_TABLE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_AV_TABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_AV_TABLE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_SCALABLE_ENDPOINTS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_SCALABLE_ENDPOINTS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_SCALABLE_ENDPOINTS", &(MPIR_CVAR_CH4_OFI_ENABLE_SCALABLE_ENDPOINTS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_SCALABLE_ENDPOINTS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_SCALABLE_ENDPOINTS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_SHARED_CONTEXTS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_SHARED_CONTEXTS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_SHARED_CONTEXTS", &(MPIR_CVAR_CH4_OFI_ENABLE_SHARED_CONTEXTS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_SHARED_CONTEXTS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_SHARED_CONTEXTS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MR_VIRT_ADDRESS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_MR_VIRT_ADDRESS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_MR_VIRT_ADDRESS", &(MPIR_CVAR_CH4_OFI_ENABLE_MR_VIRT_ADDRESS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MR_VIRT_ADDRESS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_MR_VIRT_ADDRESS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MR_ALLOCATED);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_MR_ALLOCATED");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_MR_ALLOCATED", &(MPIR_CVAR_CH4_OFI_ENABLE_MR_ALLOCATED));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MR_ALLOCATED);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_MR_ALLOCATED");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MR_REGISTER_NULL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_MR_REGISTER_NULL");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_MR_REGISTER_NULL", &(MPIR_CVAR_CH4_OFI_ENABLE_MR_REGISTER_NULL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MR_REGISTER_NULL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_MR_REGISTER_NULL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MR_PROV_KEY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_MR_PROV_KEY");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_MR_PROV_KEY", &(MPIR_CVAR_CH4_OFI_ENABLE_MR_PROV_KEY));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MR_PROV_KEY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_MR_PROV_KEY");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_TAGGED);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_TAGGED");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_TAGGED", &(MPIR_CVAR_CH4_OFI_ENABLE_TAGGED));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_TAGGED);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_TAGGED");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_AM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_AM");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_AM", &(MPIR_CVAR_CH4_OFI_ENABLE_AM));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_AM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_AM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_RMA);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_RMA");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_RMA", &(MPIR_CVAR_CH4_OFI_ENABLE_RMA));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_RMA);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_RMA");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_ATOMICS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_ATOMICS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_ATOMICS", &(MPIR_CVAR_CH4_OFI_ENABLE_ATOMICS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_ATOMICS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_ATOMICS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_FETCH_ATOMIC_IOVECS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_FETCH_ATOMIC_IOVECS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_FETCH_ATOMIC_IOVECS", &(MPIR_CVAR_CH4_OFI_FETCH_ATOMIC_IOVECS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_FETCH_ATOMIC_IOVECS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_FETCH_ATOMIC_IOVECS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_DATA_AUTO_PROGRESS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_DATA_AUTO_PROGRESS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_DATA_AUTO_PROGRESS", &(MPIR_CVAR_CH4_OFI_ENABLE_DATA_AUTO_PROGRESS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_DATA_AUTO_PROGRESS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_DATA_AUTO_PROGRESS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_CONTROL_AUTO_PROGRESS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_CONTROL_AUTO_PROGRESS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_CONTROL_AUTO_PROGRESS", &(MPIR_CVAR_CH4_OFI_ENABLE_CONTROL_AUTO_PROGRESS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_CONTROL_AUTO_PROGRESS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_CONTROL_AUTO_PROGRESS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_PT2PT_NOPACK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_PT2PT_NOPACK");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_PT2PT_NOPACK", &(MPIR_CVAR_CH4_OFI_ENABLE_PT2PT_NOPACK));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_PT2PT_NOPACK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_PT2PT_NOPACK");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_HMEM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_HMEM");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_HMEM", &(MPIR_CVAR_CH4_OFI_ENABLE_HMEM));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_HMEM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_HMEM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MR_HMEM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_MR_HMEM");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_MR_HMEM", &(MPIR_CVAR_CH4_OFI_ENABLE_MR_HMEM));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MR_HMEM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_MR_HMEM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_RDMA_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_GPU_RDMA_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_GPU_RDMA_THRESHOLD", &(MPIR_CVAR_CH4_OFI_GPU_RDMA_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_RDMA_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_GPU_RDMA_THRESHOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_CONTEXT_ID_BITS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_CONTEXT_ID_BITS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_CONTEXT_ID_BITS", &(MPIR_CVAR_CH4_OFI_CONTEXT_ID_BITS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_CONTEXT_ID_BITS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_CONTEXT_ID_BITS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_RANK_BITS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_RANK_BITS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_RANK_BITS", &(MPIR_CVAR_CH4_OFI_RANK_BITS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_RANK_BITS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_RANK_BITS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_TAG_BITS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_TAG_BITS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_TAG_BITS", &(MPIR_CVAR_CH4_OFI_TAG_BITS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_TAG_BITS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_TAG_BITS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MAJOR_VERSION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_MAJOR_VERSION");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_MAJOR_VERSION", &(MPIR_CVAR_CH4_OFI_MAJOR_VERSION));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MAJOR_VERSION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_MAJOR_VERSION");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MINOR_VERSION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_MINOR_VERSION");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_MINOR_VERSION", &(MPIR_CVAR_CH4_OFI_MINOR_VERSION));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MINOR_VERSION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_MINOR_VERSION");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MAX_RMA_SEP_CTX);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_MAX_RMA_SEP_CTX");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_MAX_RMA_SEP_CTX", &(MPIR_CVAR_CH4_OFI_MAX_RMA_SEP_CTX));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MAX_RMA_SEP_CTX);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_MAX_RMA_SEP_CTX");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MAX_EAGAIN_RETRY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_MAX_EAGAIN_RETRY");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_MAX_EAGAIN_RETRY", &(MPIR_CVAR_CH4_OFI_MAX_EAGAIN_RETRY));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MAX_EAGAIN_RETRY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_MAX_EAGAIN_RETRY");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_NUM_AM_BUFFERS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_NUM_AM_BUFFERS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_NUM_AM_BUFFERS", &(MPIR_CVAR_CH4_OFI_NUM_AM_BUFFERS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_NUM_AM_BUFFERS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_NUM_AM_BUFFERS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_NUM_OPTIMIZED_MEMORY_REGIONS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_NUM_OPTIMIZED_MEMORY_REGIONS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_NUM_OPTIMIZED_MEMORY_REGIONS", &(MPIR_CVAR_CH4_OFI_NUM_OPTIMIZED_MEMORY_REGIONS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_NUM_OPTIMIZED_MEMORY_REGIONS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_NUM_OPTIMIZED_MEMORY_REGIONS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_RMA_PROGRESS_INTERVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_RMA_PROGRESS_INTERVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_RMA_PROGRESS_INTERVAL", &(MPIR_CVAR_CH4_OFI_RMA_PROGRESS_INTERVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_RMA_PROGRESS_INTERVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_RMA_PROGRESS_INTERVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_RMA_IOVEC_MAX);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_RMA_IOVEC_MAX");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_RMA_IOVEC_MAX", &(MPIR_CVAR_CH4_OFI_RMA_IOVEC_MAX));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_RMA_IOVEC_MAX);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_RMA_IOVEC_MAX");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_EAGER_MAX_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_EAGER_MAX_MSG_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_EAGER_MAX_MSG_SIZE", &(MPIR_CVAR_CH4_OFI_EAGER_MAX_MSG_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_EAGER_MAX_MSG_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_EAGER_MAX_MSG_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MAX_NICS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_MAX_NICS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_MAX_NICS", &(MPIR_CVAR_CH4_OFI_MAX_NICS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MAX_NICS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_MAX_NICS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MULTI_NIC_STRIPING);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_MULTI_NIC_STRIPING");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_MULTI_NIC_STRIPING", &(MPIR_CVAR_CH4_OFI_ENABLE_MULTI_NIC_STRIPING));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MULTI_NIC_STRIPING);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_MULTI_NIC_STRIPING");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MULTI_NIC_STRIPING_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_MULTI_NIC_STRIPING_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_MULTI_NIC_STRIPING_THRESHOLD", &(MPIR_CVAR_CH4_OFI_MULTI_NIC_STRIPING_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MULTI_NIC_STRIPING_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_MULTI_NIC_STRIPING_THRESHOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MULTI_NIC_HASHING);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_MULTI_NIC_HASHING");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_MULTI_NIC_HASHING", &(MPIR_CVAR_CH4_OFI_ENABLE_MULTI_NIC_HASHING));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_MULTI_NIC_HASHING);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_MULTI_NIC_HASHING");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MULTIRECV_BUFFER_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_MULTIRECV_BUFFER_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_MULTIRECV_BUFFER_SIZE", &(MPIR_CVAR_CH4_OFI_MULTIRECV_BUFFER_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_MULTIRECV_BUFFER_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_MULTIRECV_BUFFER_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_OFI_USE_MIN_NICS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_OFI_USE_MIN_NICS");
    got_rc += rc;
    rc = MPL_env2bool("MVP_OFI_USE_MIN_NICS", &(MPIR_CVAR_OFI_USE_MIN_NICS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_OFI_USE_MIN_NICS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_OFI_USE_MIN_NICS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_TRIGGERED);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_TRIGGERED");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_ENABLE_TRIGGERED", &(MPIR_CVAR_CH4_OFI_ENABLE_TRIGGERED));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_TRIGGERED);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_TRIGGERED");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_GPU_PIPELINE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_GPU_PIPELINE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH4_OFI_ENABLE_GPU_PIPELINE", &(MPIR_CVAR_CH4_OFI_ENABLE_GPU_PIPELINE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_GPU_PIPELINE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_GPU_PIPELINE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_GPU_PIPELINE_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_GPU_PIPELINE_THRESHOLD", &(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_GPU_PIPELINE_THRESHOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_BUFFER_SZ);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_GPU_PIPELINE_BUFFER_SZ");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_GPU_PIPELINE_BUFFER_SZ", &(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_BUFFER_SZ));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_BUFFER_SZ);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_GPU_PIPELINE_BUFFER_SZ");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_NUM_BUFFERS_PER_CHUNK);}
    ...
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_GPU_PIPELINE_NUM_BUFFERS_PER_CHUNK", &(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_NUM_BUFFERS_PER_CHUNK));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_NUM_BUFFERS_PER_CHUNK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_GPU_PIPELINE_NUM_BUFFERS_PER_CHUNK");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_MAX_NUM_BUFFERS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_GPU_PIPELINE_MAX_NUM_BUFFERS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_GPU_PIPELINE_MAX_NUM_BUFFERS", &(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_MAX_NUM_BUFFERS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_MAX_NUM_BUFFERS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_GPU_PIPELINE_MAX_NUM_BUFFERS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_D2H_ENGINE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_GPU_PIPELINE_D2H_ENGINE_TYPE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_GPU_PIPELINE_D2H_ENGINE_TYPE", &(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_D2H_ENGINE_TYPE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_D2H_ENGINE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_GPU_PIPELINE_D2H_ENGINE_TYPE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_H2D_ENGINE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_GPU_PIPELINE_H2D_ENGINE_TYPE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_GPU_PIPELINE_H2D_ENGINE_TYPE", &(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_H2D_ENGINE_TYPE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_PIPELINE_H2D_ENGINE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_GPU_PIPELINE_H2D_ENGINE_TYPE");
    got_rc += rc;
    ...
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_MALLOC_ENABLE_MMAP, /* name */
        &MPIR_CVAR_MALLOC_ENABLE_MMAP, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_LOCAL,
        defaultval,
    ...
    MPIR_CVAR_MALLOC_ENABLE_MMAP = defaultval.d;
    got_rc = 0;
    rc = MPL_env2int("MPICH_MALLOC_ENABLE_MMAP", &(MPIR_CVAR_MALLOC_ENABLE_MMAP));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MALLOC_ENABLE_MMAP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_MALLOC_ENABLE_MMAP");
    got_rc += rc;
    rc = MPL_env2int("MVP_MALLOC_ENABLE_MMAP", &(MPIR_CVAR_MALLOC_ENABLE_MMAP));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MALLOC_ENABLE_MMAP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_MALLOC_ENABLE_MMAP");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_MALLOC_ENABLE_MMAP", &(MPIR_CVAR_MALLOC_ENABLE_MMAP));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MALLOC_ENABLE_MMAP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_MALLOC_ENABLE_MMAP");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_MALLOC_ENABLE_MMAP = %d\n", MPIR_CVAR_MALLOC_ENABLE_MMAP);
    }

    defaultval.d = 32 * 1024 * 1024;
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_MALLOC_HEAP_STEP, /* name */
        &MPIR_CVAR_MALLOC_HEAP_STEP, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_LOCAL,
        defaultval,
    ...
    MPIR_CVAR_MALLOC_HEAP_STEP = defaultval.d;
    got_rc = 0;
    rc = MPL_env2int("MPICH_MALLOC_HEAP_STEP", &(MPIR_CVAR_MALLOC_HEAP_STEP));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MALLOC_HEAP_STEP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_MALLOC_HEAP_STEP");
    got_rc += rc;
    rc = MPL_env2int("MVP_MALLOC_HEAP_STEP", &(MPIR_CVAR_MALLOC_HEAP_STEP));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MALLOC_HEAP_STEP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_MALLOC_HEAP_STEP");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_MALLOC_HEAP_STEP", &(MPIR_CVAR_MALLOC_HEAP_STEP));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_MALLOC_HEAP_STEP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_MALLOC_HEAP_STEP");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_MALLOC_HEAP_STEP = %d\n", MPIR_CVAR_MALLOC_HEAP_STEP);
    }
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_PREF_NIC);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_PREF_NIC");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_PREF_NIC", &(MPIR_CVAR_CH4_OFI_PREF_NIC));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_PREF_NIC);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_PREF_NIC");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_DISABLE_INJECT_WRITE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_DISABLE_INJECT_WRITE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH4_OFI_DISABLE_INJECT_WRITE", &(MPIR_CVAR_CH4_OFI_DISABLE_INJECT_WRITE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_DISABLE_INJECT_WRITE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_DISABLE_INJECT_WRITE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_INJECT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_ENABLE_INJECT");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH4_OFI_ENABLE_INJECT", &(MPIR_CVAR_CH4_OFI_ENABLE_INJECT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_ENABLE_INJECT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_ENABLE_INJECT");
    got_rc += rc;
...
"yaksa - use Yaksa");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_SEND_ENGINE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_GPU_SEND_ENGINE_TYPE");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_OFI_GPU_SEND_ENGINE_TYPE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_GPU_SEND_ENGINE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_GPU_SEND_ENGINE_TYPE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_EAGER_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_OFI_EAGER_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_OFI_EAGER_THRESHOLD", &(MPIR_CVAR_CH4_OFI_EAGER_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_OFI_EAGER_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_OFI_EAGER_THRESHOLD");
    got_rc += rc;
...
"based on the datatype");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_UCX_DT_RECV);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_UCX_DT_RECV");
    got_rc += rc;
    rc = MPL_env2bool("MVP_UCX_DT_RECV", &(MPIR_CVAR_UCX_DT_RECV));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_UCX_DT_RECV);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_UCX_DT_RECV");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_CMA_ENABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_CMA_ENABLE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_CMA_ENABLE", &(MPIR_CVAR_CH4_CMA_ENABLE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_CMA_ENABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_CMA_ENABLE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_CMA_P2P_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_CMA_P2P_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_IPC_CMA_P2P_THRESHOLD", &(MPIR_CVAR_CH4_IPC_CMA_P2P_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_CMA_P2P_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_CMA_P2P_THRESHOLD");
    got_rc += rc;
    ...
    defaultval.d = MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL_rget;
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL, /* name */
        &MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
...
"coop    - RNDV COOP Protocol");
    MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL = defaultval.d;
    tmp_str=NULL;
    got_rc = 0;
    rc = MPL_env2str("MPICH_CH4_IPC_RNDV_PROTOCOL", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_RNDV_PROTOCOL");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_IPC_RNDV_PROTOCOL", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_RNDV_PROTOCOL");
    got_rc += rc;
    rc = MPL_env2str("MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL = %s\n", tmp_str);
    }
    if (tmp_str != NULL) {
        if (0 == strcmp(tmp_str, "auto"))
            MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL = MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL_auto;
        else if (0 == strcmp(tmp_str, "rget"))
            MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL = MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL_rget;
        else if (0 == strcmp(tmp_str, "rput"))
            MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL = MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL_rput;
        else if (0 == strcmp(tmp_str, "coop"))
            MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL = MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL_coop;
        else {
            mpi_errno = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, __func__, __LINE__,MPI_ERR_OTHER, "**cvar_val", "**cvar_val %s %s", "MPIR_CVAR_CH4_IPC_RNDV_PROTOCOL", tmp_str);
            goto fn_fail;
        }
    }
    ...
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD, /* name */
        &MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
    ...
    MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD = defaultval.d;
    got_rc = 0;
    rc = MPL_env2int("MPICH_CH4_IPC_CMA_COOP_THRESHOLD", &(MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_CMA_COOP_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_IPC_CMA_COOP_THRESHOLD", &(MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_CMA_COOP_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD", &(MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD = %d\n", MPIR_CVAR_CH4_IPC_CMA_COOP_THRESHOLD);
    }
...
"disabled - disable caching completely");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_HANDLE_CACHE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_GPU_HANDLE_CACHE");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_IPC_GPU_HANDLE_CACHE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_HANDLE_CACHE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_GPU_HANDLE_CACHE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_MAX_CACHE_ENTRIES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_GPU_MAX_CACHE_ENTRIES");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_IPC_GPU_MAX_CACHE_ENTRIES", &(MPIR_CVAR_CH4_IPC_GPU_MAX_CACHE_ENTRIES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_MAX_CACHE_ENTRIES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_GPU_MAX_CACHE_ENTRIES");
    got_rc += rc;
...
"disabled - don't cache mapped IPC buffers");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_CACHE_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_GPU_CACHE_SIZE");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_IPC_GPU_CACHE_SIZE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_CACHE_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_GPU_CACHE_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_P2P_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_GPU_P2P_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_IPC_GPU_P2P_THRESHOLD", &(MPIR_CVAR_CH4_IPC_GPU_P2P_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_P2P_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_GPU_P2P_THRESHOLD");
    got_rc += rc;
...
"drmfd - force to use device fd-based shareable IPC handle");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_ZE_SHAREABLE_HANDLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_ZE_SHAREABLE_HANDLE");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_IPC_ZE_SHAREABLE_HANDLE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_ZE_SHAREABLE_HANDLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_ZE_SHAREABLE_HANDLE");
    got_rc += rc;
...
"copy_low_latency - use low-latency copy engine");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_ENGINE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_GPU_ENGINE_TYPE");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_IPC_GPU_ENGINE_TYPE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_ENGINE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_GPU_ENGINE_TYPE");
    got_rc += rc;
...
"write - use write protocol if remote device is visible");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_READ_WRITE_PROTOCOL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_GPU_READ_WRITE_PROTOCOL");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_IPC_GPU_READ_WRITE_PROTOCOL", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_READ_WRITE_PROTOCOL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_GPU_READ_WRITE_PROTOCOL");
    got_rc += rc;
...
"copy_low_latency - use low-latency copy engine");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_RMA_ENGINE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_GPU_RMA_ENGINE_TYPE");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_IPC_GPU_RMA_ENGINE_TYPE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_GPU_RMA_ENGINE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_GPU_RMA_ENGINE_TYPE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_MAP_REPEAT_ADDR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_MAP_REPEAT_ADDR");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH4_IPC_MAP_REPEAT_ADDR", &(MPIR_CVAR_CH4_IPC_MAP_REPEAT_ADDR));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_MAP_REPEAT_ADDR);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_MAP_REPEAT_ADDR");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_XPMEM_ENABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_XPMEM_ENABLE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_XPMEM_ENABLE", &(MPIR_CVAR_CH4_XPMEM_ENABLE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_XPMEM_ENABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_XPMEM_ENABLE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_XPMEM_P2P_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IPC_XPMEM_P2P_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_IPC_XPMEM_P2P_THRESHOLD", &(MPIR_CVAR_CH4_IPC_XPMEM_P2P_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IPC_XPMEM_P2P_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IPC_XPMEM_P2P_THRESHOLD");
    got_rc += rc;
...
"ipc_read - Uses read-based collective with ipc");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_BCAST_POSIX_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
...
"auto - Internal algorithm selection (can be overridden with MPIR_CVAR_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE)");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IBCAST_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IBCAST_POSIX_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IBCAST_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IBCAST_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
...
"auto - Internal algorithm selection (can be overridden with MPIR_CVAR_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE)");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_REDUCE_POSIX_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
...
"auto - Internal algorithm selection (can be overridden with MPIR_CVAR_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE)");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_IREDUCE_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_IREDUCE_POSIX_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_IREDUCE_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_IREDUCE_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
...
"auto - Internal algorithm selection (can be overridden with MPIR_CVAR_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE)");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLREDUCE_POSIX_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
...
"auto - Internal algorithm selection (can be overridden with MPIR_CVAR_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE)");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BARRIER_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_BARRIER_POSIX_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BARRIER_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
...
"ipc_read    - Uses read-based collective with ipc");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALL_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLTOALL_POSIX_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALL_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
...
"ipc_read    - Uses read-based collective with ipc");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLGATHER_POSIX_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
...
"ipc_read    - Uses read-based collective with ipc");
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHERV_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_ALLGATHERV_POSIX_INTRA_ALGORITHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_POSIX_INTRA_ALGORITHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHERV_POSIX_INTRA_ALGORITHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_POSIX_POLL_FREQUENCY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_POSIX_POLL_FREQUENCY");
    got_rc += rc;
    rc = MPL_env2int("MVP_POSIX_POLL_FREQUENCY", &(MPIR_CVAR_POSIX_POLL_FREQUENCY));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_POSIX_POLL_FREQUENCY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_POSIX_POLL_FREQUENCY");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_IPC_READ_MSG_SIZE_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_IPC_READ_MSG_SIZE_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_IPC_READ_MSG_SIZE_THRESHOLD", &(MPIR_CVAR_BCAST_IPC_READ_MSG_SIZE_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_IPC_READ_MSG_SIZE_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_IPC_READ_MSG_SIZE_THRESHOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_IPC_READ_MSG_SIZE_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALL_IPC_READ_MSG_SIZE_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLTOALL_IPC_READ_MSG_SIZE_THRESHOLD", &(MPIR_CVAR_ALLTOALL_IPC_READ_MSG_SIZE_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_IPC_READ_MSG_SIZE_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALL_IPC_READ_MSG_SIZE_THRESHOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_IPC_READ_MSG_SIZE_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_IPC_READ_MSG_SIZE_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLGATHER_IPC_READ_MSG_SIZE_THRESHOLD", &(MPIR_CVAR_ALLGATHER_IPC_READ_MSG_SIZE_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_IPC_READ_MSG_SIZE_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_IPC_READ_MSG_SIZE_THRESHOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_IPC_READ_MSG_SIZE_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHERV_IPC_READ_MSG_SIZE_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLGATHERV_IPC_READ_MSG_SIZE_THRESHOLD", &(MPIR_CVAR_ALLGATHERV_IPC_READ_MSG_SIZE_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHERV_IPC_READ_MSG_SIZE_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHERV_IPC_READ_MSG_SIZE_THRESHOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_POSIX_NUM_COLLS_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_POSIX_NUM_COLLS_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_POSIX_NUM_COLLS_THRESHOLD", &(MPIR_CVAR_POSIX_NUM_COLLS_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_POSIX_NUM_COLLS_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_POSIX_NUM_COLLS_THRESHOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_SHM_POSIX_EAGER);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_SHM_POSIX_EAGER");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_SHM_POSIX_EAGER", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_SHM_POSIX_EAGER);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_SHM_POSIX_EAGER");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE);}
    ...
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE_GPU);}
    ...
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE_GPU", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE_GPU);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_POSIX_COLL_SELECTION_TUNING_JSON_FILE_GPU");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_SHM_POSIX_TOPO_ENABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_SHM_POSIX_TOPO_ENABLE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH4_SHM_POSIX_TOPO_ENABLE", &(MPIR_CVAR_CH4_SHM_POSIX_TOPO_ENABLE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_SHM_POSIX_TOPO_ENABLE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_SHM_POSIX_TOPO_ENABLE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_SHM_POSIX_IQUEUE_NUM_CELLS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_SHM_POSIX_IQUEUE_NUM_CELLS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_SHM_POSIX_IQUEUE_NUM_CELLS", &(MPIR_CVAR_CH4_SHM_POSIX_IQUEUE_NUM_CELLS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_SHM_POSIX_IQUEUE_NUM_CELLS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_SHM_POSIX_IQUEUE_NUM_CELLS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_SHM_POSIX_IQUEUE_CELL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_SHM_POSIX_IQUEUE_CELL_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_SHM_POSIX_IQUEUE_CELL_SIZE", &(MPIR_CVAR_CH4_SHM_POSIX_IQUEUE_CELL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_SHM_POSIX_IQUEUE_CELL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_SHM_POSIX_IQUEUE_CELL_SIZE");
    got_rc += rc;
    ...
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS, /* name */
        &MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
    ...
    MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS = defaultval.d;
    got_rc = 0;
    rc = MPL_env2int("MPICH_CH4_MVP_SHM_POSIX_NUM_CELLS", &(MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_MVP_SHM_POSIX_NUM_CELLS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_MVP_SHM_POSIX_NUM_CELLS", &(MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_MVP_SHM_POSIX_NUM_CELLS");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS", &(MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS = %d\n", MPIR_CVAR_CH4_MVP_SHM_POSIX_NUM_CELLS);
    }

    defaultval.d = 16384;
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_INT,
        MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE, /* name */
        &MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE, /* address */
        1, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
        "CH4", /* category */
        "Size of each cell.");
    MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE = defaultval.d;
    got_rc = 0;
    rc = MPL_env2int("MPICH_CH4_MVP_SHM_POSIX_CELL_SIZE", &(MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_MVP_SHM_POSIX_CELL_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_MVP_SHM_POSIX_CELL_SIZE", &(MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_MVP_SHM_POSIX_CELL_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE", &(MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE = %d\n", MPIR_CVAR_CH4_MVP_SHM_POSIX_CELL_SIZE);
    }
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLL_SHM_LIMIT_PER_NODE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_COLL_SHM_LIMIT_PER_NODE");
    got_rc += rc;
    rc = MPL_env2int("MVP_COLL_SHM_LIMIT_PER_NODE", &(MPIR_CVAR_COLL_SHM_LIMIT_PER_NODE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLL_SHM_LIMIT_PER_NODE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_COLL_SHM_LIMIT_PER_NODE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRANODE_BUFFER_TOTAL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_INTRANODE_BUFFER_TOTAL_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_INTRANODE_BUFFER_TOTAL_SIZE", &(MPIR_CVAR_BCAST_INTRANODE_BUFFER_TOTAL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRANODE_BUFFER_TOTAL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_INTRANODE_BUFFER_TOTAL_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRANODE_NUM_CELLS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_INTRANODE_NUM_CELLS");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_INTRANODE_NUM_CELLS", &(MPIR_CVAR_BCAST_INTRANODE_NUM_CELLS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRANODE_NUM_CELLS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_INTRANODE_NUM_CELLS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_BUFFER_TOTAL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_INTRANODE_BUFFER_TOTAL_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_REDUCE_INTRANODE_BUFFER_TOTAL_SIZE", &(MPIR_CVAR_REDUCE_INTRANODE_BUFFER_TOTAL_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_BUFFER_TOTAL_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_INTRANODE_BUFFER_TOTAL_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_NUM_CELLS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_INTRANODE_NUM_CELLS");
    got_rc += rc;
    rc = MPL_env2int("MVP_REDUCE_INTRANODE_NUM_CELLS", &(MPIR_CVAR_REDUCE_INTRANODE_NUM_CELLS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_NUM_CELLS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_INTRANODE_NUM_CELLS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRANODE_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_INTRANODE_TREE_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_INTRANODE_TREE_KVAL", &(MPIR_CVAR_BCAST_INTRANODE_TREE_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRANODE_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_INTRANODE_TREE_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRANODE_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_INTRANODE_TREE_TYPE");
    got_rc += rc;
    rc = MPL_env2str("MVP_BCAST_INTRANODE_TREE_TYPE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_INTRANODE_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_INTRANODE_TREE_TYPE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_MSG_SIZE_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_INTRANODE_MSG_SIZE_THRESHOLD");
    got_rc += rc;
    rc = MPL_env2int("MVP_REDUCE_INTRANODE_MSG_SIZE_THRESHOLD", &(MPIR_CVAR_REDUCE_INTRANODE_MSG_SIZE_THRESHOLD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_MSG_SIZE_THRESHOLD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_INTRANODE_MSG_SIZE_THRESHOLD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_INTRANODE_TREE_KVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_REDUCE_INTRANODE_TREE_KVAL", &(MPIR_CVAR_REDUCE_INTRANODE_TREE_KVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_TREE_KVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_INTRANODE_TREE_KVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_TREE_KVAL_LARGE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_INTRANODE_TREE_KVAL_LARGE");
    got_rc += rc;
    rc = MPL_env2int("MVP_REDUCE_INTRANODE_TREE_KVAL_LARGE", &(MPIR_CVAR_REDUCE_INTRANODE_TREE_KVAL_LARGE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_TREE_KVAL_LARGE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_INTRANODE_TREE_KVAL_LARGE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_INTRANODE_TREE_TYPE");
    got_rc += rc;
    rc = MPL_env2str("MVP_REDUCE_INTRANODE_TREE_TYPE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_TREE_TYPE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_INTRANODE_TREE_TYPE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_TREE_TYPE_LARGE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_INTRANODE_TREE_TYPE_LARGE");
    got_rc += rc;
    rc = MPL_env2str("MVP_REDUCE_INTRANODE_TREE_TYPE_LARGE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_INTRANODE_TREE_TYPE_LARGE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_INTRANODE_TREE_TYPE_LARGE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_INTRANODE_TOPOLOGY_AWARE_TREES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ENABLE_INTRANODE_TOPOLOGY_AWARE_TREES");
    got_rc += rc;
    rc = MPL_env2int("MVP_ENABLE_INTRANODE_TOPOLOGY_AWARE_TREES", &(MPIR_CVAR_ENABLE_INTRANODE_TOPOLOGY_AWARE_TREES));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_INTRANODE_TOPOLOGY_AWARE_TREES);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ENABLE_INTRANODE_TOPOLOGY_AWARE_TREES");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_COMPOSITION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BARRIER_COMPOSITION");
    got_rc += rc;
    rc = MPL_env2int("MVP_BARRIER_COMPOSITION", &(MPIR_CVAR_BARRIER_COMPOSITION));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BARRIER_COMPOSITION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BARRIER_COMPOSITION");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_COMPOSITION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_BCAST_COMPOSITION");
    got_rc += rc;
    rc = MPL_env2int("MVP_BCAST_COMPOSITION", &(MPIR_CVAR_BCAST_COMPOSITION));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_BCAST_COMPOSITION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_BCAST_COMPOSITION");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_COMPOSITION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_COMPOSITION");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_COMPOSITION", &(MPIR_CVAR_ALLREDUCE_COMPOSITION));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_COMPOSITION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_COMPOSITION");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_COMPOSITION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_COMPOSITION");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLGATHER_COMPOSITION", &(MPIR_CVAR_ALLGATHER_COMPOSITION));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_COMPOSITION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_COMPOSITION");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_COMPOSITION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALL_COMPOSITION");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLTOALL_COMPOSITION", &(MPIR_CVAR_ALLTOALL_COMPOSITION));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_COMPOSITION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALL_COMPOSITION");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_COMPOSITION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_REDUCE_COMPOSITION");
    got_rc += rc;
    rc = MPL_env2int("MVP_REDUCE_COMPOSITION", &(MPIR_CVAR_REDUCE_COMPOSITION));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_REDUCE_COMPOSITION);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_REDUCE_COMPOSITION");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_SHM_PER_RANK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLTOALL_SHM_PER_RANK");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLTOALL_SHM_PER_RANK", &(MPIR_CVAR_ALLTOALL_SHM_PER_RANK));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLTOALL_SHM_PER_RANK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLTOALL_SHM_PER_RANK");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_SHM_PER_RANK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLGATHER_SHM_PER_RANK");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLGATHER_SHM_PER_RANK", &(MPIR_CVAR_ALLGATHER_SHM_PER_RANK));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLGATHER_SHM_PER_RANK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLGATHER_SHM_PER_RANK");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NUM_MULTI_LEADS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_NUM_MULTI_LEADS");
    got_rc += rc;
    rc = MPL_env2int("MVP_NUM_MULTI_LEADS", &(MPIR_CVAR_NUM_MULTI_LEADS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_NUM_MULTI_LEADS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_NUM_MULTI_LEADS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_SHM_PER_LEADER);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_SHM_PER_LEADER");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_SHM_PER_LEADER", &(MPIR_CVAR_ALLREDUCE_SHM_PER_LEADER));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_SHM_PER_LEADER);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_SHM_PER_LEADER");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_CACHE_PER_LEADER);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_CACHE_PER_LEADER");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_CACHE_PER_LEADER", &(MPIR_CVAR_ALLREDUCE_CACHE_PER_LEADER));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_CACHE_PER_LEADER);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_CACHE_PER_LEADER");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_LOCAL_COPY_OFFSETS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ALLREDUCE_LOCAL_COPY_OFFSETS");
    got_rc += rc;
    rc = MPL_env2int("MVP_ALLREDUCE_LOCAL_COPY_OFFSETS", &(MPIR_CVAR_ALLREDUCE_LOCAL_COPY_OFFSETS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ALLREDUCE_LOCAL_COPY_OFFSETS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ALLREDUCE_LOCAL_COPY_OFFSETS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_NETMOD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_NETMOD");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_NETMOD", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_NETMOD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_NETMOD");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_SHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_SHM");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_SHM", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_SHM);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_SHM");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_ROOTS_ONLY_PMI);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_ROOTS_ONLY_PMI");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH4_ROOTS_ONLY_PMI", &(MPIR_CVAR_CH4_ROOTS_ONLY_PMI));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_ROOTS_ONLY_PMI);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_ROOTS_ONLY_PMI");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_RUNTIME_CONF_DEBUG);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_RUNTIME_CONF_DEBUG");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH4_RUNTIME_CONF_DEBUG", &(MPIR_CVAR_CH4_RUNTIME_CONF_DEBUG));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_RUNTIME_CONF_DEBUG);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_RUNTIME_CONF_DEBUG");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_MT_MODEL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_MT_MODEL");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_MT_MODEL", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_MT_MODEL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_MT_MODEL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_NUM_VCIS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_NUM_VCIS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_NUM_VCIS", &(MPIR_CVAR_CH4_NUM_VCIS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_NUM_VCIS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_NUM_VCIS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_RESERVE_VCIS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_RESERVE_VCIS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_RESERVE_VCIS", &(MPIR_CVAR_CH4_RESERVE_VCIS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_RESERVE_VCIS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_RESERVE_VCIS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_COLL_SELECTION_TUNING_JSON_FILE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_COLL_SELECTION_TUNING_JSON_FILE");
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_COLL_SELECTION_TUNING_JSON_FILE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_COLL_SELECTION_TUNING_JSON_FILE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_COLL_SELECTION_TUNING_JSON_FILE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_COLL_SELECTION_TUNING_JSON_FILE_GPU);}
    ...
    got_rc += rc;
    rc = MPL_env2str("MVP_CH4_COLL_SELECTION_TUNING_JSON_FILE_GPU", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_COLL_SELECTION_TUNING_JSON_FILE_GPU);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_COLL_SELECTION_TUNING_JSON_FILE_GPU");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IOV_DENSITY_MIN);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_IOV_DENSITY_MIN");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_IOV_DENSITY_MIN", &(MPIR_CVAR_CH4_IOV_DENSITY_MIN));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_IOV_DENSITY_MIN);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_IOV_DENSITY_MIN");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_PACK_BUFFER_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_PACK_BUFFER_SIZE");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_PACK_BUFFER_SIZE", &(MPIR_CVAR_CH4_PACK_BUFFER_SIZE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_PACK_BUFFER_SIZE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_PACK_BUFFER_SIZE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_NUM_PACK_BUFFERS_PER_CHUNK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_NUM_PACK_BUFFERS_PER_CHUNK");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_NUM_PACK_BUFFERS_PER_CHUNK", &(MPIR_CVAR_CH4_NUM_PACK_BUFFERS_PER_CHUNK));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_NUM_PACK_BUFFERS_PER_CHUNK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_NUM_PACK_BUFFERS_PER_CHUNK");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_MAX_NUM_PACK_BUFFERS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_MAX_NUM_PACK_BUFFERS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_MAX_NUM_PACK_BUFFERS", &(MPIR_CVAR_CH4_MAX_NUM_PACK_BUFFERS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_MAX_NUM_PACK_BUFFERS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_MAX_NUM_PACK_BUFFERS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_GPU_COLL_SWAP_BUFFER_SZ);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_GPU_COLL_SWAP_BUFFER_SZ");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_GPU_COLL_SWAP_BUFFER_SZ", &(MPIR_CVAR_CH4_GPU_COLL_SWAP_BUFFER_SZ));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_GPU_COLL_SWAP_BUFFER_SZ);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_GPU_COLL_SWAP_BUFFER_SZ");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_GPU_COLL_NUM_BUFFERS_PER_CHUNK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_GPU_COLL_NUM_BUFFERS_PER_CHUNK");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_GPU_COLL_NUM_BUFFERS_PER_CHUNK", &(MPIR_CVAR_CH4_GPU_COLL_NUM_BUFFERS_PER_CHUNK));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_GPU_COLL_NUM_BUFFERS_PER_CHUNK);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_GPU_COLL_NUM_BUFFERS_PER_CHUNK");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_GPU_COLL_MAX_NUM_BUFFERS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_GPU_COLL_MAX_NUM_BUFFERS");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_GPU_COLL_MAX_NUM_BUFFERS", &(MPIR_CVAR_CH4_GPU_COLL_MAX_NUM_BUFFERS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_GPU_COLL_MAX_NUM_BUFFERS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_GPU_COLL_MAX_NUM_BUFFERS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_GLOBAL_PROGRESS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_GLOBAL_PROGRESS");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH4_GLOBAL_PROGRESS", &(MPIR_CVAR_CH4_GLOBAL_PROGRESS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_GLOBAL_PROGRESS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_GLOBAL_PROGRESS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_COMM_CONNECT_TIMEOUT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_COMM_CONNECT_TIMEOUT");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_COMM_CONNECT_TIMEOUT", &(MPIR_CVAR_CH4_COMM_CONNECT_TIMEOUT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_COMM_CONNECT_TIMEOUT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_COMM_CONNECT_TIMEOUT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_ENABLE_STREAM_WORKQ);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_ENABLE_STREAM_WORKQ");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH4_ENABLE_STREAM_WORKQ", &(MPIR_CVAR_CH4_ENABLE_STREAM_WORKQ));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_ENABLE_STREAM_WORKQ);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_ENABLE_STREAM_WORKQ");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_RMA_MEM_EFFICIENT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_RMA_MEM_EFFICIENT");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH4_RMA_MEM_EFFICIENT", &(MPIR_CVAR_CH4_RMA_MEM_EFFICIENT));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_RMA_MEM_EFFICIENT);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_RMA_MEM_EFFICIENT");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_RMA_ENABLE_DYNAMIC_AM_PROGRESS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_RMA_ENABLE_DYNAMIC_AM_PROGRESS");
    got_rc += rc;
    rc = MPL_env2bool("MVP_CH4_RMA_ENABLE_DYNAMIC_AM_PROGRESS", &(MPIR_CVAR_CH4_RMA_ENABLE_DYNAMIC_AM_PROGRESS));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_RMA_ENABLE_DYNAMIC_AM_PROGRESS);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_RMA_ENABLE_DYNAMIC_AM_PROGRESS");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_RMA_AM_PROGRESS_INTERVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_RMA_AM_PROGRESS_INTERVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_RMA_AM_PROGRESS_INTERVAL", &(MPIR_CVAR_CH4_RMA_AM_PROGRESS_INTERVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_RMA_AM_PROGRESS_INTERVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_RMA_AM_PROGRESS_INTERVAL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_RMA_AM_PROGRESS_LOW_FREQ_INTERVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_CH4_RMA_AM_PROGRESS_LOW_FREQ_INTERVAL");
    got_rc += rc;
    rc = MPL_env2int("MVP_CH4_RMA_AM_PROGRESS_LOW_FREQ_INTERVAL", &(MPIR_CVAR_CH4_RMA_AM_PROGRESS_LOW_FREQ_INTERVAL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_CH4_RMA_AM_PROGRESS_LOW_FREQ_INTERVAL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_CH4_RMA_AM_PROGRESS_LOW_FREQ_INTERVAL");
    got_rc += rc;
    ...
    MPIR_T_CVAR_REGISTER_STATIC(
        MPI_CHAR,
        MPIR_CVAR_PT2PT_JSON_TUNING_FILE, /* name */
        &MPIR_CVAR_PT2PT_JSON_TUNING_FILE, /* address */
        MPIR_CVAR_MAX_STRLEN, /* count */
        MPI_T_VERBOSITY_USER_BASIC,
        MPI_T_SCOPE_ALL_EQ,
        defaultval,
    ...
    tmp_str = defaultval.str;
    got_rc = 0;
    rc = MPL_env2str("MPICH_PT2PT_JSON_TUNING_FILE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PT2PT_JSON_TUNING_FILE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_PT2PT_JSON_TUNING_FILE");
    got_rc += rc;
    rc = MPL_env2str("MVP_PT2PT_JSON_TUNING_FILE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PT2PT_JSON_TUNING_FILE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_PT2PT_JSON_TUNING_FILE");
    got_rc += rc;
    rc = MPL_env2str("MPIR_CVAR_PT2PT_JSON_TUNING_FILE", &tmp_str);
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_PT2PT_JSON_TUNING_FILE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPIR_CVAR_PT2PT_JSON_TUNING_FILE");
    got_rc += rc;
    if (got_rc && debug) {
        printf("CVAR: MPIR_CVAR_PT2PT_JSON_TUNING_FILE = %s\n", tmp_str);
    }
    if (tmp_str != NULL) {
        MPIR_CVAR_PT2PT_JSON_TUNING_FILE = MPL_strdup(tmp_str);
        MPIR_CVAR_assert(MPIR_CVAR_PT2PT_JSON_TUNING_FILE);
        if (MPIR_CVAR_PT2PT_JSON_TUNING_FILE == NULL) {
            MPIR_CHKMEM_SETERR(mpi_errno, strlen(tmp_str), "dup of string for MPIR_CVAR_PT2PT_JSON_TUNING_FILE");
            goto fn_fail;
        }
    }
    else {
        MPIR_CVAR_PT2PT_JSON_TUNING_FILE = NULL;
    }
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GENQ_SHMEM_POOL_FREE_QUEUE_SENDER_SIDE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_GENQ_SHMEM_POOL_FREE_QUEUE_SENDER_SIDE");
    got_rc += rc;
    rc = MPL_env2bool("MVP_GENQ_SHMEM_POOL_FREE_QUEUE_SENDER_SIDE", &(MPIR_CVAR_GENQ_SHMEM_POOL_FREE_QUEUE_SENDER_SIDE));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_GENQ_SHMEM_POOL_FREE_QUEUE_SENDER_SIDE);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_GENQ_SHMEM_POOL_FREE_QUEUE_SENDER_SIDE");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_HCOLL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ENABLE_HCOLL");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ENABLE_HCOLL", &(MPIR_CVAR_ENABLE_HCOLL));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_HCOLL);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ENABLE_HCOLL");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLL_SCHED_DUMP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_COLL_SCHED_DUMP");
    got_rc += rc;
    rc = MPL_env2bool("MVP_COLL_SCHED_DUMP", &(MPIR_CVAR_COLL_SCHED_DUMP));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_COLL_SCHED_DUMP);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_COLL_SCHED_DUMP");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SHM_RANDOM_ADDR_RETRY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SHM_RANDOM_ADDR_RETRY");
    got_rc += rc;
    rc = MPL_env2int("MVP_SHM_RANDOM_ADDR_RETRY", &(MPIR_CVAR_SHM_RANDOM_ADDR_RETRY));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SHM_RANDOM_ADDR_RETRY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SHM_RANDOM_ADDR_RETRY");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SHM_SYMHEAP_RETRY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_SHM_SYMHEAP_RETRY");
    got_rc += rc;
    rc = MPL_env2int("MVP_SHM_SYMHEAP_RETRY", &(MPIR_CVAR_SHM_SYMHEAP_RETRY));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_SHM_SYMHEAP_RETRY);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_SHM_SYMHEAP_RETRY");
    got_rc += rc;
    ...
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_HEAVY_YIELD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MPICH_ENABLE_HEAVY_YIELD");
    got_rc += rc;
    rc = MPL_env2bool("MVP_ENABLE_HEAVY_YIELD", &(MPIR_CVAR_ENABLE_HEAVY_YIELD));
    if (1 == rc) {MPIR_CVAR_SET_USER_SET_FLAG(MPIR_CVAR_ENABLE_HEAVY_YIELD);}
    MPIR_ERR_CHKANDJUMP1((-1 == rc),mpi_errno,MPI_ERR_OTHER,"**envvarparse","**envvarparse %s","MVP_ENABLE_HEAVY_YIELD");
    got_rc += rc;
...
int MPIR_T_cvar_finalize(void)
{
    ...
    MPL_free((char *)MPIR_CVAR_PT2PT_JSON_TUNING_FILE);
    MPIR_CVAR_PT2PT_JSON_TUNING_FILE = NULL;
