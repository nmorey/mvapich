...
#define mpit_malloc(a, b, line, file)           \
MPL_trmalloc(a, b, line, file)
#define mpit_calloc(a, b, c, line, file)        \
MPL_trcalloc(a, b, c, line, file)
#define mpit_free(a, line, file)                \
MPL_trfree(a, line, file)
#define mpit_strdup(a, line, file)              \
MPL_trstrdup(a, line, file)
#define mpit_realloc(a, b, c, line, file)       \
MPL_trrealloc(a, b, c, line, file)
...
{
    MPIT_MEMORY_T * mptr = mpit_malloc(sizeof (MPIT_MEMORY_T), MPL_MEM_MPIT,
                            __LINE__, __FILE__);
    void * result;
...
void *MPIT_malloc(size_t size, MPL_memory_class class,
...
void *MPIT_calloc(size_t nelements, size_t elementSize,
                    MPL_memory_class class, int lineno,
                    char const *filename)
{
    void *ptr;
...
void *MPIT_realloc(void * ptr, size_t size, MPL_memory_class class,
                    int lineno, char const * filename)
{
    if(mv2_enable_pvar_mem)
    {
